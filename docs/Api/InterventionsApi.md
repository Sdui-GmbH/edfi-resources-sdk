# OpenAPI\Client\InterventionsApi
...
$apiInstance = new OpenAPI\Client\Api\InterventionsApi(
...
```php
deletesInterventions($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiInterventionDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiInterventionDelete[]**](../Model/TrackedChangesEdFiInterventionDelete.md)
...
```php
getInterventions($offset, $limit, $min_change_version, $max_change_version, $total_count, $intervention_identification_code, $education_organization_id, $delivery_method_descriptor, $intervention_class_descriptor, $begin_date, $end_date, $id, $max_dosage, $min_dosage, $namespace, $use_snapshot): \OpenAPI\Client\Model\EdFiIntervention[]
```
...
$begin_date = new \DateTime("2013-10-20T19:20:30+01:00"); // \DateTime | The start date for the intervention implementation.
$end_date = new \DateTime("2013-10-20T19:20:30+01:00"); // \DateTime | The end date for the intervention implementation.
...
try {
    $result = $apiInstance->getInterventions($offset, $limit, $min_change_version, $max_change_version, $total_count, $intervention_identification_code, $education_organization_id, $delivery_method_descriptor, $intervention_class_descriptor, $begin_date, $end_date, $id, $max_dosage, $min_dosage, $namespace, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\EdFiIntervention[]**](../Model/EdFiIntervention.md)
...
```php
getInterventionsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiIntervention
```
...
```php
keyChangesInterventions($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiInterventionKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiInterventionKeyChange[]**](../Model/TrackedChangesEdFiInterventionKeyChange.md)
...
$ed_fi_intervention = new \OpenAPI\Client\Model\EdFiIntervention(); // \OpenAPI\Client\Model\EdFiIntervention | The JSON representation of the \"intervention\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_intervention** | [**\OpenAPI\Client\Model\EdFiIntervention**](../Model/EdFiIntervention.md)| The JSON representation of the \&quot;intervention\&quot; resource to be created or updated. | |
