...
try {
    $result = $apiInstance->getProgramEvaluations($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $program_evaluation_period_descriptor, $program_evaluation_type_descriptor, $program_evaluation_title, $program_education_organization_id, $program_name, $program_type_descriptor, $evaluation_max_numeric_rating, $evaluation_min_numeric_rating, $id, $program_evaluation_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
```php
getProgramEvaluationsPartitions($number, $min_change_version, $max_change_version, $program_evaluation_period_descriptor, $program_evaluation_type_descriptor, $program_evaluation_title, $program_education_organization_id, $program_name, $program_type_descriptor, $evaluation_max_numeric_rating, $evaluation_min_numeric_rating, $id, $program_evaluation_description, $use_snapshot): \Resources\Model\GetAcademicWeeksPartitions200Response
```
...
try {
    $result = $apiInstance->getProgramEvaluationsPartitions($number, $min_change_version, $max_change_version, $program_evaluation_period_descriptor, $program_evaluation_type_descriptor, $program_evaluation_title, $program_education_organization_id, $program_name, $program_type_descriptor, $evaluation_max_numeric_rating, $evaluation_min_numeric_rating, $id, $program_evaluation_description, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ProgramEvaluationsApi->getProgramEvaluationsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
