# OpenAPI\Client\CommunityProvidersApi
...
$apiInstance = new OpenAPI\Client\Api\CommunityProvidersApi(
...
```php
deletesCommunityProviders($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiCommunityProviderDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiCommunityProviderDelete[]**](../Model/TrackedChangesEdFiCommunityProviderDelete.md)
...
[**\OpenAPI\Client\Model\EdFiCommunityProvider[]**](../Model/EdFiCommunityProvider.md)
...
```php
getCommunityProvidersById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiCommunityProvider
```
...
```php
keyChangesCommunityProviders($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiCommunityProviderKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiCommunityProviderKeyChange[]**](../Model/TrackedChangesEdFiCommunityProviderKeyChange.md)
...
$ed_fi_community_provider = new \OpenAPI\Client\Model\EdFiCommunityProvider(); // \OpenAPI\Client\Model\EdFiCommunityProvider | The JSON representation of the \"communityProvider\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_community_provider** | [**\OpenAPI\Client\Model\EdFiCommunityProvider**](../Model/EdFiCommunityProvider.md)| The JSON representation of the \&quot;communityProvider\&quot; resource to be created or updated. | |
