# OpenAPI\Client\StudentLanguageInstructionProgramAssociationsApi
...
$apiInstance = new OpenAPI\Client\Api\StudentLanguageInstructionProgramAssociationsApi(
...
```php
deletesStudentLanguageInstructionProgramAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStudentLanguageInstructionProgramAssociationDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStudentLanguageInstructionProgramAssociationDelete[]**](../Model/TrackedChangesEdFiStudentLanguageInstructionProgramAssociationDelete.md)
...
[**\OpenAPI\Client\Model\EdFiStudentLanguageInstructionProgramAssociation[]**](../Model/EdFiStudentLanguageInstructionProgramAssociation.md)
...
```php
getStudentLanguageInstructionProgramAssociationsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiStudentLanguageInstructionProgramAssociation
```
...
```php
keyChangesStudentLanguageInstructionProgramAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKeyChange[]**](../Model/TrackedChangesEdFiStudentLanguageInstructionProgramAssociationKeyChange.md)
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_student_language_instruction_program_association** | [**\OpenAPI\Client\Model\EdFiStudentLanguageInstructionProgramAssociation**](../Model/EdFiStudentLanguageInstructionProgramAssociation.md)| The JSON representation of the \&quot;studentLanguageInstructionProgramAssociation\&quot; resource to be created or updated. | |
