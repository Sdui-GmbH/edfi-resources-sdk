# OpenAPI\Client\StudentInterventionAssociationsApi
...
$apiInstance = new OpenAPI\Client\Api\StudentInterventionAssociationsApi(
...
```php
deletesStudentInterventionAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStudentInterventionAssociationDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStudentInterventionAssociationDelete[]**](../Model/TrackedChangesEdFiStudentInterventionAssociationDelete.md)
...
```php
getStudentInterventionAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $education_organization_id, $intervention_identification_code, $student_unique_id, $cohort_identifier, $cohort_education_organization_id, $diagnostic_statement, $dosage, $id, $use_snapshot): \OpenAPI\Client\Model\EdFiStudentInterventionAssociation[]
```
...
try {
    $result = $apiInstance->getStudentInterventionAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $education_organization_id, $intervention_identification_code, $student_unique_id, $cohort_identifier, $cohort_education_organization_id, $diagnostic_statement, $dosage, $id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\EdFiStudentInterventionAssociation[]**](../Model/EdFiStudentInterventionAssociation.md)
...
```php
getStudentInterventionAssociationsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiStudentInterventionAssociation
```
...
```php
keyChangesStudentInterventionAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStudentInterventionAssociationKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStudentInterventionAssociationKeyChange[]**](../Model/TrackedChangesEdFiStudentInterventionAssociationKeyChange.md)
...
$ed_fi_student_intervention_association = new \OpenAPI\Client\Model\EdFiStudentInterventionAssociation(); // \OpenAPI\Client\Model\EdFiStudentInterventionAssociation | The JSON representation of the \"studentInterventionAssociation\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_student_intervention_association** | [**\OpenAPI\Client\Model\EdFiStudentInterventionAssociation**](../Model/EdFiStudentInterventionAssociation.md)| The JSON representation of the \&quot;studentInterventionAssociation\&quot; resource to be created or updated. | |
