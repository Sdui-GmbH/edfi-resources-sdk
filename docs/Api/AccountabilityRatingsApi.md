# OpenAPI\Client\AccountabilityRatingsApi
...
$apiInstance = new OpenAPI\Client\Api\AccountabilityRatingsApi(
...
```php
deletesAccountabilityRatings($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiAccountabilityRatingDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiAccountabilityRatingDelete[]**](../Model/TrackedChangesEdFiAccountabilityRatingDelete.md)
...
```php
getAccountabilityRatings($offset, $limit, $min_change_version, $max_change_version, $total_count, $rating_title, $education_organization_id, $school_year, $id, $rating, $rating_date, $rating_organization, $rating_program, $use_snapshot): \OpenAPI\Client\Model\EdFiAccountabilityRating[]
```
...
try {
    $result = $apiInstance->getAccountabilityRatings($offset, $limit, $min_change_version, $max_change_version, $total_count, $rating_title, $education_organization_id, $school_year, $id, $rating, $rating_date, $rating_organization, $rating_program, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\EdFiAccountabilityRating[]**](../Model/EdFiAccountabilityRating.md)
...
```php
getAccountabilityRatingsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiAccountabilityRating
```
...
```php
keyChangesAccountabilityRatings($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiAccountabilityRatingKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiAccountabilityRatingKeyChange[]**](../Model/TrackedChangesEdFiAccountabilityRatingKeyChange.md)
...
$ed_fi_accountability_rating = new \OpenAPI\Client\Model\EdFiAccountabilityRating(); // \OpenAPI\Client\Model\EdFiAccountabilityRating | The JSON representation of the \"accountabilityRating\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_accountability_rating** | [**\OpenAPI\Client\Model\EdFiAccountabilityRating**](../Model/EdFiAccountabilityRating.md)| The JSON representation of the \&quot;accountabilityRating\&quot; resource to be created or updated. | |
