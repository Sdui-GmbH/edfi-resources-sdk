...
```php
getAccountabilityRatings($offset, $limit, $min_change_version, $max_change_version, $total_count, $rating_title, $education_organization_id, $school_year, $id, $rating, $rating_date, $rating_organization, $rating_program, $use_snapshot): \Resources\Model\EdFiAccountabilityRating[]
```
