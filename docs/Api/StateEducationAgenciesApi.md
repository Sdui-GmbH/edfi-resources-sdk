...
```php
getStateEducationAgencies($offset, $limit, $min_change_version, $max_change_version, $total_count, $state_education_agency_id, $use_snapshot): \Resources\Model\EdFiStateEducationAgency[]
```
