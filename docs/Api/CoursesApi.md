...
$minimum_available_credit_conversion = 3.4; // double | Conversion factor that when multiplied by the number of credits is equivalent to Carnegie units.
$minimum_available_credits = 3.4; // double | The value of credits or units of value awarded for the completion of a course.
