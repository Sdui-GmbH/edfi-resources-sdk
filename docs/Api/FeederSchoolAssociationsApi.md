...
$apiInstance = new Resources\Api\FeederSchoolAssociationsApi(
...
```php
deletesFeederSchoolAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Resources\Model\TrackedChangesEdFiFeederSchoolAssociationDelete[]
```
...
[**\Resources\Model\TrackedChangesEdFiFeederSchoolAssociationDelete[]**](../Model/TrackedChangesEdFiFeederSchoolAssociationDelete.md)
...
```php
getFeederSchoolAssociations($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $begin_date, $feeder_school_id, $school_id, $end_date, $feeder_relationship_description, $id, $use_snapshot): \Resources\Model\EdFiFeederSchoolAssociation[]
```
...
$max_change_version = 56; // int | Used in synchronization to set sequence maximum ChangeVersion
$total_count = false; // bool | Indicates if the total number of items available should be returned in the 'Total-Count' header of the response.  If set to false, 'Total-Count' header will not be provided. Must be false when using cursor paging (with pageToken).
$begin_date = new \DateTime("2013-10-20T19:20:30+01:00"); // \DateTime | The month, day, and year of the first day of the feeder school association.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.
...
$end_date = new \DateTime("2013-10-20T19:20:30+01:00"); // \DateTime | The month, day, and year of the last day of the feeder school association.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.
...
try {
    $result = $apiInstance->getFeederSchoolAssociations($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $begin_date, $feeder_school_id, $school_id, $end_date, $feeder_relationship_description, $id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
| **max_change_version** | **int**| Used in synchronization to set sequence maximum ChangeVersion | [optional] |
| **total_count** | **bool**| Indicates if the total number of items available should be returned in the &#39;Total-Count&#39; header of the response.  If set to false, &#39;Total-Count&#39; header will not be provided. Must be false when using cursor paging (with pageToken). | [optional] [default to false] |
| **begin_date** | **\DateTime**| The month, day, and year of the first day of the feeder school association.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines. | [optional] |
...
[**\Resources\Model\EdFiFeederSchoolAssociation[]**](../Model/EdFiFeederSchoolAssociation.md)
...
```php
getFeederSchoolAssociationsById($id, $if_none_match, $use_snapshot): \Resources\Model\EdFiFeederSchoolAssociation
```
...
```php
getFeederSchoolAssociationsPartitions($number, $min_change_version, $max_change_version, $begin_date, $feeder_school_id, $school_id, $end_date, $feeder_relationship_description, $id, $use_snapshot): \Resources\Model\GetAcademicWeeksPartitions200Response
```
...
try {
    $result = $apiInstance->getFeederSchoolAssociationsPartitions($number, $min_change_version, $max_change_version, $begin_date, $feeder_school_id, $school_id, $end_date, $feeder_relationship_description, $id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FeederSchoolAssociationsApi->getFeederSchoolAssociationsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesFeederSchoolAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Resources\Model\TrackedChangesEdFiFeederSchoolAssociationKeyChange[]
```
...
[**\Resources\Model\TrackedChangesEdFiFeederSchoolAssociationKeyChange[]**](../Model/TrackedChangesEdFiFeederSchoolAssociationKeyChange.md)
...
$ed_fi_feeder_school_association = new \Resources\Model\EdFiFeederSchoolAssociation(); // \Resources\Model\EdFiFeederSchoolAssociation | The JSON representation of the \"feederSchoolAssociation\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_feeder_school_association** | [**\Resources\Model\EdFiFeederSchoolAssociation**](../Model/EdFiFeederSchoolAssociation.md)| The JSON representation of the \&quot;feederSchoolAssociation\&quot; resource to be created or updated. | |
