...
try {
    $result = $apiInstance->getLocations($offset, $limit, $min_change_version, $max_change_version, $total_count, $classroom_identification_code, $school_id, $id, $maximum_number_of_seats, $optimal_number_of_seats, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
