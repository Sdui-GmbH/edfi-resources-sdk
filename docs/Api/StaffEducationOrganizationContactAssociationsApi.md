...
```php
getStaffEducationOrganizationContactAssociations($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $contact_title, $education_organization_id, $staff_unique_id, $contact_type_descriptor, $electronic_mail_address, $id, $use_snapshot): \Resources\Model\EdFiStaffEducationOrganizationContactAssociation[]
```
...
try {
    $result = $apiInstance->getStaffEducationOrganizationContactAssociations($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $contact_title, $education_organization_id, $staff_unique_id, $contact_type_descriptor, $electronic_mail_address, $id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
```php
getStaffEducationOrganizationContactAssociationsPartitions($number, $min_change_version, $max_change_version, $contact_title, $education_organization_id, $staff_unique_id, $contact_type_descriptor, $electronic_mail_address, $id, $use_snapshot): \Resources\Model\GetAcademicWeeksPartitions200Response
```
...
try {
    $result = $apiInstance->getStaffEducationOrganizationContactAssociationsPartitions($number, $min_change_version, $max_change_version, $contact_title, $education_organization_id, $staff_unique_id, $contact_type_descriptor, $electronic_mail_address, $id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling StaffEducationOrganizationContactAssociationsApi->getStaffEducationOrganizationContactAssociationsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
