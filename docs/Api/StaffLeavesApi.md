...
```php
getStaffLeaves($offset, $limit, $min_change_version, $max_change_version, $total_count, $staff_leave_event_category_descriptor, $begin_date, $staff_unique_id, $end_date, $id, $reason, $substitute_assigned, $use_snapshot): \Resources\Model\EdFiStaffLeave[]
```
