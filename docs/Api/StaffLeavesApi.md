...
$apiInstance = new OpenAPI\Client\Api\StaffLeavesApi(
...
```php
deletesStaffLeaves($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStaffLeaveDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStaffLeaveDelete[]**](../Model/TrackedChangesEdFiStaffLeaveDelete.md)
...
```php
getStaffLeaves($offset, $limit, $min_change_version, $max_change_version, $total_count, $staff_leave_event_category_descriptor, $begin_date, $staff_unique_id, $end_date, $id, $reason, $substitute_assigned, $use_snapshot): \OpenAPI\Client\Model\EdFiStaffLeave[]
```
...
$begin_date = new \DateTime("2013-10-20T19:20:30+01:00"); // \DateTime | The begin date of the staff leave.
$staff_unique_id = 'staff_unique_id_example'; // string | A unique alphanumeric code assigned to a staff.
$end_date = new \DateTime("2013-10-20T19:20:30+01:00"); // \DateTime | The end date of the staff leave.
...
try {
    $result = $apiInstance->getStaffLeaves($offset, $limit, $min_change_version, $max_change_version, $total_count, $staff_leave_event_category_descriptor, $begin_date, $staff_unique_id, $end_date, $id, $reason, $substitute_assigned, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\EdFiStaffLeave[]**](../Model/EdFiStaffLeave.md)
...
```php
getStaffLeavesById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiStaffLeave
```
...
```php
keyChangesStaffLeaves($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStaffLeaveKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStaffLeaveKeyChange[]**](../Model/TrackedChangesEdFiStaffLeaveKeyChange.md)
...
$ed_fi_staff_leave = new \OpenAPI\Client\Model\EdFiStaffLeave(); // \OpenAPI\Client\Model\EdFiStaffLeave | The JSON representation of the \"staffLeave\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_staff_leave** | [**\OpenAPI\Client\Model\EdFiStaffLeave**](../Model/EdFiStaffLeave.md)| The JSON representation of the \&quot;staffLeave\&quot; resource to be created or updated. | |
