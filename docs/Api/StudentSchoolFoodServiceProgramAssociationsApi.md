# OpenAPI\Client\StudentSchoolFoodServiceProgramAssociationsApi
...
$apiInstance = new OpenAPI\Client\Api\StudentSchoolFoodServiceProgramAssociationsApi(
...
```php
deletesStudentSchoolFoodServiceProgramAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationDelete[]**](../Model/TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationDelete.md)
...
[**\OpenAPI\Client\Model\EdFiStudentSchoolFoodServiceProgramAssociation[]**](../Model/EdFiStudentSchoolFoodServiceProgramAssociation.md)
...
```php
getStudentSchoolFoodServiceProgramAssociationsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiStudentSchoolFoodServiceProgramAssociation
```
...
```php
keyChangesStudentSchoolFoodServiceProgramAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKeyChange[]**](../Model/TrackedChangesEdFiStudentSchoolFoodServiceProgramAssociationKeyChange.md)
...
$ed_fi_student_school_food_service_program_association = new \OpenAPI\Client\Model\EdFiStudentSchoolFoodServiceProgramAssociation(); // \OpenAPI\Client\Model\EdFiStudentSchoolFoodServiceProgramAssociation | The JSON representation of the \"studentSchoolFoodServiceProgramAssociation\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_student_school_food_service_program_association** | [**\OpenAPI\Client\Model\EdFiStudentSchoolFoodServiceProgramAssociation**](../Model/EdFiStudentSchoolFoodServiceProgramAssociation.md)| The JSON representation of the \&quot;studentSchoolFoodServiceProgramAssociation\&quot; resource to be created or updated. | |
