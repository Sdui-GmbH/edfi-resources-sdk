...
```php
getSurveySectionAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $local_course_code, $school_id, $school_year, $section_identifier, $session_name, $namespace, $survey_identifier, $id, $use_snapshot): \Resources\Model\EdFiSurveySectionAssociation[]
```
