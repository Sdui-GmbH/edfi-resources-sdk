# OpenAPI\Client\SurveySectionAssociationsApi
...
$apiInstance = new OpenAPI\Client\Api\SurveySectionAssociationsApi(
...
```php
deletesSurveySectionAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiSurveySectionAssociationDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiSurveySectionAssociationDelete[]**](../Model/TrackedChangesEdFiSurveySectionAssociationDelete.md)
...
```php
getSurveySectionAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $local_course_code, $school_id, $school_year, $section_identifier, $session_name, $namespace, $survey_identifier, $id, $use_snapshot): \OpenAPI\Client\Model\EdFiSurveySectionAssociation[]
```
...
try {
    $result = $apiInstance->getSurveySectionAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $local_course_code, $school_id, $school_year, $section_identifier, $session_name, $namespace, $survey_identifier, $id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\EdFiSurveySectionAssociation[]**](../Model/EdFiSurveySectionAssociation.md)
...
```php
getSurveySectionAssociationsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiSurveySectionAssociation
```
...
```php
keyChangesSurveySectionAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiSurveySectionAssociationKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiSurveySectionAssociationKeyChange[]**](../Model/TrackedChangesEdFiSurveySectionAssociationKeyChange.md)
...
$ed_fi_survey_section_association = new \OpenAPI\Client\Model\EdFiSurveySectionAssociation(); // \OpenAPI\Client\Model\EdFiSurveySectionAssociation | The JSON representation of the \"surveySectionAssociation\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_survey_section_association** | [**\OpenAPI\Client\Model\EdFiSurveySectionAssociation**](../Model/EdFiSurveySectionAssociation.md)| The JSON representation of the \&quot;surveySectionAssociation\&quot; resource to be created or updated. | |
