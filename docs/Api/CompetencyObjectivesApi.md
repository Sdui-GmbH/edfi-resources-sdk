...
try {
    $result = $apiInstance->getCompetencyObjectives($offset, $limit, $min_change_version, $max_change_version, $total_count, $objective_grade_level_descriptor, $objective, $education_organization_id, $competency_objective_id, $description, $id, $success_criteria, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
