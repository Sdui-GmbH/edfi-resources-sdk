# OpenAPI\Client\InterventionStudiesApi
...
$apiInstance = new OpenAPI\Client\Api\InterventionStudiesApi(
...
```php
deletesInterventionStudies($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiInterventionStudyDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiInterventionStudyDelete[]**](../Model/TrackedChangesEdFiInterventionStudyDelete.md)
...
[**\OpenAPI\Client\Model\EdFiInterventionStudy[]**](../Model/EdFiInterventionStudy.md)
...
```php
getInterventionStudiesById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiInterventionStudy
```
...
```php
keyChangesInterventionStudies($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiInterventionStudyKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiInterventionStudyKeyChange[]**](../Model/TrackedChangesEdFiInterventionStudyKeyChange.md)
...
$ed_fi_intervention_study = new \OpenAPI\Client\Model\EdFiInterventionStudy(); // \OpenAPI\Client\Model\EdFiInterventionStudy | The JSON representation of the \"interventionStudy\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_intervention_study** | [**\OpenAPI\Client\Model\EdFiInterventionStudy**](../Model/EdFiInterventionStudy.md)| The JSON representation of the \&quot;interventionStudy\&quot; resource to be created or updated. | |
