...
```php
getCommunityOrganizations($offset, $limit, $min_change_version, $max_change_version, $total_count, $community_organization_id, $use_snapshot): \Resources\Model\EdFiCommunityOrganization[]
```
