# OpenAPI\Client\CommunityOrganizationsApi
...
$apiInstance = new OpenAPI\Client\Api\CommunityOrganizationsApi(
...
```php
deletesCommunityOrganizations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiCommunityOrganizationDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiCommunityOrganizationDelete[]**](../Model/TrackedChangesEdFiCommunityOrganizationDelete.md)
...
```php
getCommunityOrganizations($offset, $limit, $min_change_version, $max_change_version, $total_count, $community_organization_id, $use_snapshot): \OpenAPI\Client\Model\EdFiCommunityOrganization[]
```
...
try {
    $result = $apiInstance->getCommunityOrganizations($offset, $limit, $min_change_version, $max_change_version, $total_count, $community_organization_id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\EdFiCommunityOrganization[]**](../Model/EdFiCommunityOrganization.md)
...
```php
getCommunityOrganizationsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiCommunityOrganization
```
...
```php
keyChangesCommunityOrganizations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiCommunityOrganizationKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiCommunityOrganizationKeyChange[]**](../Model/TrackedChangesEdFiCommunityOrganizationKeyChange.md)
...
$ed_fi_community_organization = new \OpenAPI\Client\Model\EdFiCommunityOrganization(); // \OpenAPI\Client\Model\EdFiCommunityOrganization | The JSON representation of the \"communityOrganization\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_community_organization** | [**\OpenAPI\Client\Model\EdFiCommunityOrganization**](../Model/EdFiCommunityOrganization.md)| The JSON representation of the \&quot;communityOrganization\&quot; resource to be created or updated. | |
