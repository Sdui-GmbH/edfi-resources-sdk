...
| [**getPostSecondaryEventsPartitions()**](PostSecondaryEventsApi.md#getPostSecondaryEventsPartitions) | **GET** /ed-fi/postSecondaryEvents/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
$apiInstance = new Resources\Api\PostSecondaryEventsApi(
...
```php
deletesPostSecondaryEvents($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Resources\Model\TrackedChangesEdFiPostSecondaryEventDelete[]
```
...
[**\Resources\Model\TrackedChangesEdFiPostSecondaryEventDelete[]**](../Model/TrackedChangesEdFiPostSecondaryEventDelete.md)
...
```php
getPostSecondaryEvents($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $post_secondary_event_category_descriptor, $event_date, $student_unique_id, $post_secondary_institution_id, $id, $use_snapshot): \Resources\Model\EdFiPostSecondaryEvent[]
```
...
try {
    $result = $apiInstance->getPostSecondaryEvents($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $post_secondary_event_category_descriptor, $event_date, $student_unique_id, $post_secondary_institution_id, $id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\Resources\Model\EdFiPostSecondaryEvent[]**](../Model/EdFiPostSecondaryEvent.md)
...
```php
getPostSecondaryEventsById($id, $if_none_match, $use_snapshot): \Resources\Model\EdFiPostSecondaryEvent
```
...
## `getPostSecondaryEventsPartitions()`

```php
getPostSecondaryEventsPartitions($number, $min_change_version, $max_change_version, $post_secondary_event_category_descriptor, $event_date, $student_unique_id, $post_secondary_institution_id, $id, $use_snapshot): \Resources\Model\GetAcademicWeeksPartitions200Response
```
...
try {
    $result = $apiInstance->getPostSecondaryEventsPartitions($number, $min_change_version, $max_change_version, $post_secondary_event_category_descriptor, $event_date, $student_unique_id, $post_secondary_institution_id, $id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PostSecondaryEventsApi->getPostSecondaryEventsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesPostSecondaryEvents($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Resources\Model\TrackedChangesEdFiPostSecondaryEventKeyChange[]
```
...
[**\Resources\Model\TrackedChangesEdFiPostSecondaryEventKeyChange[]**](../Model/TrackedChangesEdFiPostSecondaryEventKeyChange.md)
...
$ed_fi_post_secondary_event = new \Resources\Model\EdFiPostSecondaryEvent(); // \Resources\Model\EdFiPostSecondaryEvent | The JSON representation of the \"postSecondaryEvent\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_post_secondary_event** | [**\Resources\Model\EdFiPostSecondaryEvent**](../Model/EdFiPostSecondaryEvent.md)| The JSON representation of the \&quot;postSecondaryEvent\&quot; resource to be created or updated. | |
