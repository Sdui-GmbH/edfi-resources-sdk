...
$apiInstance = new Resources\Api\SurveyQuestionsApi(
...
```php
deletesSurveyQuestions($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Resources\Model\TrackedChangesEdFiSurveyQuestionDelete[]
```
...
[**\Resources\Model\TrackedChangesEdFiSurveyQuestionDelete[]**](../Model/TrackedChangesEdFiSurveyQuestionDelete.md)
...
```php
getSurveyQuestions($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $question_code, $namespace, $survey_identifier, $survey_section_title, $question_form_descriptor, $id, $question_text, $use_snapshot): \Resources\Model\EdFiSurveyQuestion[]
```
...
try {
    $result = $apiInstance->getSurveyQuestions($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $question_code, $namespace, $survey_identifier, $survey_section_title, $question_form_descriptor, $id, $question_text, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\Resources\Model\EdFiSurveyQuestion[]**](../Model/EdFiSurveyQuestion.md)
...
```php
getSurveyQuestionsById($id, $if_none_match, $use_snapshot): \Resources\Model\EdFiSurveyQuestion
```
...
```php
getSurveyQuestionsPartitions($number, $min_change_version, $max_change_version, $question_code, $namespace, $survey_identifier, $survey_section_title, $question_form_descriptor, $id, $question_text, $use_snapshot): \Resources\Model\GetAcademicWeeksPartitions200Response
```
...
try {
    $result = $apiInstance->getSurveyQuestionsPartitions($number, $min_change_version, $max_change_version, $question_code, $namespace, $survey_identifier, $survey_section_title, $question_form_descriptor, $id, $question_text, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SurveyQuestionsApi->getSurveyQuestionsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesSurveyQuestions($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Resources\Model\TrackedChangesEdFiSurveyQuestionKeyChange[]
```
...
[**\Resources\Model\TrackedChangesEdFiSurveyQuestionKeyChange[]**](../Model/TrackedChangesEdFiSurveyQuestionKeyChange.md)
...
$ed_fi_survey_question = new \Resources\Model\EdFiSurveyQuestion(); // \Resources\Model\EdFiSurveyQuestion | The JSON representation of the \"surveyQuestion\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_survey_question** | [**\Resources\Model\EdFiSurveyQuestion**](../Model/EdFiSurveyQuestion.md)| The JSON representation of the \&quot;surveyQuestion\&quot; resource to be created or updated. | |
