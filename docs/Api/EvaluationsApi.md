...
$apiInstance = new OpenAPI\Client\Api\EvaluationsApi(
...
```php
deletesEvaluations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesTpdmEvaluationDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesTpdmEvaluationDelete[]**](../Model/TrackedChangesTpdmEvaluationDelete.md)
...
$max_rating = 3.4; // double | The maximum summary numerical rating or score for the evaluation.
$min_rating = 3.4; // double | The minimum summary numerical rating or score for the evaluation. If omitted, assumed to be 0.0.
$use_snapshot = false; // bool | Indicates if the configured Snapshot should be used.

try {
    $result = $apiInstance->getEvaluations($offset, $limit, $min_change_version, $max_change_version, $total_count, $evaluation_title, $education_organization_id, $evaluation_period_descriptor, $performance_evaluation_title, $performance_evaluation_type_descriptor, $school_year, $term_descriptor, $evaluation_type_descriptor, $evaluation_description, $id, $inter_rater_reliability_score, $max_rating, $min_rating, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\TpdmEvaluation[]**](../Model/TpdmEvaluation.md)
...
```php
getEvaluationsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\TpdmEvaluation
```
...
```php
keyChangesEvaluations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesTpdmEvaluationKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesTpdmEvaluationKeyChange[]**](../Model/TrackedChangesTpdmEvaluationKeyChange.md)
...
$tpdm_evaluation = new \OpenAPI\Client\Model\TpdmEvaluation(); // \OpenAPI\Client\Model\TpdmEvaluation | The JSON representation of the \"evaluation\" resource to be created or updated.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **tpdm_evaluation** | [**\OpenAPI\Client\Model\TpdmEvaluation**](../Model/TpdmEvaluation.md)| The JSON representation of the \&quot;evaluation\&quot; resource to be created or updated. |
