...
$apiInstance = new Resources\Api\GraduationPlansApi(
...
```php
deletesGraduationPlans($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Resources\Model\TrackedChangesEdFiGraduationPlanDelete[]
```
...
[**\Resources\Model\TrackedChangesEdFiGraduationPlanDelete[]**](../Model/TrackedChangesEdFiGraduationPlanDelete.md)
...
```php
getGraduationPlans($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $graduation_plan_type_descriptor, $education_organization_id, $graduation_school_year, $total_required_credit_type_descriptor, $id, $individual_plan, $total_required_credit_conversion, $total_required_credits, $use_snapshot): \Resources\Model\EdFiGraduationPlan[]
```
...
try {
    $result = $apiInstance->getGraduationPlans($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $graduation_plan_type_descriptor, $education_organization_id, $graduation_school_year, $total_required_credit_type_descriptor, $id, $individual_plan, $total_required_credit_conversion, $total_required_credits, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\Resources\Model\EdFiGraduationPlan[]**](../Model/EdFiGraduationPlan.md)
...
```php
getGraduationPlansById($id, $if_none_match, $use_snapshot): \Resources\Model\EdFiGraduationPlan
```
...
```php
getGraduationPlansPartitions($number, $min_change_version, $max_change_version, $graduation_plan_type_descriptor, $education_organization_id, $graduation_school_year, $total_required_credit_type_descriptor, $id, $individual_plan, $total_required_credit_conversion, $total_required_credits, $use_snapshot): \Resources\Model\GetAcademicWeeksPartitions200Response
```
...
try {
    $result = $apiInstance->getGraduationPlansPartitions($number, $min_change_version, $max_change_version, $graduation_plan_type_descriptor, $education_organization_id, $graduation_school_year, $total_required_credit_type_descriptor, $id, $individual_plan, $total_required_credit_conversion, $total_required_credits, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling GraduationPlansApi->getGraduationPlansPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesGraduationPlans($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Resources\Model\TrackedChangesEdFiGraduationPlanKeyChange[]
```
...
[**\Resources\Model\TrackedChangesEdFiGraduationPlanKeyChange[]**](../Model/TrackedChangesEdFiGraduationPlanKeyChange.md)
...
$ed_fi_graduation_plan = new \Resources\Model\EdFiGraduationPlan(); // \Resources\Model\EdFiGraduationPlan | The JSON representation of the \"graduationPlan\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_graduation_plan** | [**\Resources\Model\EdFiGraduationPlan**](../Model/EdFiGraduationPlan.md)| The JSON representation of the \&quot;graduationPlan\&quot; resource to be created or updated. | |
