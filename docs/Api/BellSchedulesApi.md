...
try {
    $apiInstance->deleteBellScheduleById($id, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling BellSchedulesApi->deleteBellScheduleById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->deletesBellSchedules($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BellSchedulesApi->deletesBellSchedules: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getBellSchedules($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $bell_schedule_name, $school_id, $alternate_day_name, $end_time, $id, $start_time, $total_instructional_time, $use_snapshot): \Resources\Model\EdFiBellSchedule[]
```
...
$max_change_version = 56; // int | Used in synchronization to set sequence maximum ChangeVersion
$total_count = false; // bool | Indicates if the total number of items available should be returned in the 'Total-Count' header of the response.  If set to false, 'Total-Count' header will not be provided. Must be false when using cursor paging (with pageToken).
$bell_schedule_name = 'bell_schedule_name_example'; // string | Name or title of the bell schedule.
...
$alternate_day_name = 'alternate_day_name_example'; // string | An alternate name for the day (e.g., Red, Blue).
$end_time = 'end_time_example'; // string | An indication of the time of day the bell schedule ends.
$id = 'id_example'; // string | 
$start_time = 'start_time_example'; // string | An indication of the time of day the bell schedule begins.
$total_instructional_time = 56; // int | The total instructional time in minutes per day for the bell schedule.
$use_snapshot = false; // bool | Indicates if the configured Snapshot should be used.

try {
    $result = $apiInstance->getBellSchedules($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $bell_schedule_name, $school_id, $alternate_day_name, $end_time, $id, $start_time, $total_instructional_time, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BellSchedulesApi->getBellSchedules: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->getBellSchedulesById($id, $if_none_match, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BellSchedulesApi->getBellSchedulesById: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getBellSchedulesPartitions($number, $min_change_version, $max_change_version, $bell_schedule_name, $school_id, $alternate_day_name, $end_time, $id, $start_time, $total_instructional_time, $use_snapshot): \Resources\Model\GetAcademicWeeksPartitions200Response
```
...
try {
    $result = $apiInstance->getBellSchedulesPartitions($number, $min_change_version, $max_change_version, $bell_schedule_name, $school_id, $alternate_day_name, $end_time, $id, $start_time, $total_instructional_time, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BellSchedulesApi->getBellSchedulesPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->keyChangesBellSchedules($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BellSchedulesApi->keyChangesBellSchedules: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
postBellSchedule($ed_fi_bell_schedule)
```
...
try {
    ...
    echo 'Exception when calling BellSchedulesApi->postBellSchedule: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
putBellSchedule($id, $ed_fi_bell_schedule, $if_match)
```
...
try {
    $apiInstance->putBellSchedule($id, $ed_fi_bell_schedule, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling BellSchedulesApi->putBellSchedule: ', $e->getMessage(), PHP_EOL;
}
```
