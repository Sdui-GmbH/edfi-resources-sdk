...
```php
getStudentTransportations($offset, $limit, $min_change_version, $max_change_version, $total_count, $transportation_education_organization_id, $student_unique_id, $transportation_public_expense_eligibility_type_descriptor, $transportation_type_descriptor, $id, $special_accomodation_requirements, $use_snapshot): \Resources\Model\EdFiStudentTransportation[]
```
...
try {
    $result = $apiInstance->getStudentTransportations($offset, $limit, $min_change_version, $max_change_version, $total_count, $transportation_education_organization_id, $student_unique_id, $transportation_public_expense_eligibility_type_descriptor, $transportation_type_descriptor, $id, $special_accomodation_requirements, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
