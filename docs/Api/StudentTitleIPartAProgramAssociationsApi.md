# OpenAPI\Client\StudentTitleIPartAProgramAssociationsApi
...
$apiInstance = new OpenAPI\Client\Api\StudentTitleIPartAProgramAssociationsApi(
...
```php
deletesStudentTitleIPartAProgramAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStudentTitleIPartAProgramAssociationDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStudentTitleIPartAProgramAssociationDelete[]**](../Model/TrackedChangesEdFiStudentTitleIPartAProgramAssociationDelete.md)
...
[**\OpenAPI\Client\Model\EdFiStudentTitleIPartAProgramAssociation[]**](../Model/EdFiStudentTitleIPartAProgramAssociation.md)
...
```php
getStudentTitleIPartAProgramAssociationsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiStudentTitleIPartAProgramAssociation
```
...
```php
keyChangesStudentTitleIPartAProgramAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStudentTitleIPartAProgramAssociationKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStudentTitleIPartAProgramAssociationKeyChange[]**](../Model/TrackedChangesEdFiStudentTitleIPartAProgramAssociationKeyChange.md)
...
$ed_fi_student_title_i_part_a_program_association = new \OpenAPI\Client\Model\EdFiStudentTitleIPartAProgramAssociation(); // \OpenAPI\Client\Model\EdFiStudentTitleIPartAProgramAssociation | The JSON representation of the \"studentTitleIPartAProgramAssociation\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_student_title_i_part_a_program_association** | [**\OpenAPI\Client\Model\EdFiStudentTitleIPartAProgramAssociation**](../Model/EdFiStudentTitleIPartAProgramAssociation.md)| The JSON representation of the \&quot;studentTitleIPartAProgramAssociation\&quot; resource to be created or updated. | |
