# Resources\StaffProgramAssociationsApi
...
$apiInstance = new Resources\Api\StaffProgramAssociationsApi(
...
```php
deletesStaffProgramAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Resources\Model\TrackedChangesEdFiStaffProgramAssociationDelete[]
```
...
[**\Resources\Model\TrackedChangesEdFiStaffProgramAssociationDelete[]**](../Model/TrackedChangesEdFiStaffProgramAssociationDelete.md)
...
```php
getStaffProgramAssociations($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $begin_date, $program_education_organization_id, $program_name, $program_type_descriptor, $staff_unique_id, $end_date, $id, $student_record_access, $use_snapshot): \Resources\Model\EdFiStaffProgramAssociation[]
```
...
$max_change_version = 56; // int | Used in synchronization to set sequence maximum ChangeVersion
$total_count = false; // bool | Indicates if the total number of items available should be returned in the 'Total-Count' header of the response.  If set to false, 'Total-Count' header will not be provided. Must be false when using cursor paging (with pageToken).
$begin_date = new \DateTime("2013-10-20T19:20:30+01:00"); // \DateTime | Start date for the association of staff to this program.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.
...
$end_date = new \DateTime("2013-10-20T19:20:30+01:00"); // \DateTime | End date for the association of staff to this program.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines.
...
try {
    $result = $apiInstance->getStaffProgramAssociations($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $begin_date, $program_education_organization_id, $program_name, $program_type_descriptor, $staff_unique_id, $end_date, $id, $student_record_access, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\Resources\Model\EdFiStaffProgramAssociation[]**](../Model/EdFiStaffProgramAssociation.md)
...
```php
getStaffProgramAssociationsById($id, $if_none_match, $use_snapshot): \Resources\Model\EdFiStaffProgramAssociation
```
...
```php
getStaffProgramAssociationsPartitions($number, $min_change_version, $max_change_version, $begin_date, $program_education_organization_id, $program_name, $program_type_descriptor, $staff_unique_id, $end_date, $id, $student_record_access, $use_snapshot): \Resources\Model\GetAcademicWeeksPartitions200Response
```
...
try {
    $result = $apiInstance->getStaffProgramAssociationsPartitions($number, $min_change_version, $max_change_version, $begin_date, $program_education_organization_id, $program_name, $program_type_descriptor, $staff_unique_id, $end_date, $id, $student_record_access, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling StaffProgramAssociationsApi->getStaffProgramAssociationsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesStaffProgramAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Resources\Model\TrackedChangesEdFiStaffProgramAssociationKeyChange[]
```
...
[**\Resources\Model\TrackedChangesEdFiStaffProgramAssociationKeyChange[]**](../Model/TrackedChangesEdFiStaffProgramAssociationKeyChange.md)
...
$ed_fi_staff_program_association = new \Resources\Model\EdFiStaffProgramAssociation(); // \Resources\Model\EdFiStaffProgramAssociation | The JSON representation of the \"staffProgramAssociation\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_staff_program_association** | [**\Resources\Model\EdFiStaffProgramAssociation**](../Model/EdFiStaffProgramAssociation.md)| The JSON representation of the \&quot;staffProgramAssociation\&quot; resource to be created or updated. | |
