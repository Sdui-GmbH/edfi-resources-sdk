...
```php
getStaffProgramAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $begin_date, $program_education_organization_id, $program_name, $program_type_descriptor, $staff_unique_id, $end_date, $id, $student_record_access, $use_snapshot): \Resources\Model\EdFiStaffProgramAssociation[]
```
