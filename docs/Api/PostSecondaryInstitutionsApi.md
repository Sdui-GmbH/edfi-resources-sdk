# OpenAPI\Client\PostSecondaryInstitutionsApi
...
$apiInstance = new OpenAPI\Client\Api\PostSecondaryInstitutionsApi(
...
```php
deletesPostSecondaryInstitutions($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiPostSecondaryInstitutionDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiPostSecondaryInstitutionDelete[]**](../Model/TrackedChangesEdFiPostSecondaryInstitutionDelete.md)
...
```php
getPostSecondaryInstitutions($offset, $limit, $min_change_version, $max_change_version, $total_count, $post_secondary_institution_id, $administrative_funding_control_descriptor, $post_secondary_institution_level_descriptor, $use_snapshot): \OpenAPI\Client\Model\EdFiPostSecondaryInstitution[]
```
...
[**\OpenAPI\Client\Model\EdFiPostSecondaryInstitution[]**](../Model/EdFiPostSecondaryInstitution.md)
...
```php
getPostSecondaryInstitutionsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiPostSecondaryInstitution
```
...
```php
keyChangesPostSecondaryInstitutions($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiPostSecondaryInstitutionKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiPostSecondaryInstitutionKeyChange[]**](../Model/TrackedChangesEdFiPostSecondaryInstitutionKeyChange.md)
...
$ed_fi_post_secondary_institution = new \OpenAPI\Client\Model\EdFiPostSecondaryInstitution(); // \OpenAPI\Client\Model\EdFiPostSecondaryInstitution | The JSON representation of the \"postSecondaryInstitution\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_post_secondary_institution** | [**\OpenAPI\Client\Model\EdFiPostSecondaryInstitution**](../Model/EdFiPostSecondaryInstitution.md)| The JSON representation of the \&quot;postSecondaryInstitution\&quot; resource to be created or updated. | |
