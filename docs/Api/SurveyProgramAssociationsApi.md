# Resources\SurveyProgramAssociationsApi
...
| [**getSurveyProgramAssociationsPartitions()**](SurveyProgramAssociationsApi.md#getSurveyProgramAssociationsPartitions) | **GET** /ed-fi/surveyProgramAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
$apiInstance = new Resources\Api\SurveyProgramAssociationsApi(
...
```php
deletesSurveyProgramAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Resources\Model\TrackedChangesEdFiSurveyProgramAssociationDelete[]
```
...
[**\Resources\Model\TrackedChangesEdFiSurveyProgramAssociationDelete[]**](../Model/TrackedChangesEdFiSurveyProgramAssociationDelete.md)
...
```php
getSurveyProgramAssociations($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $education_organization_id, $program_name, $program_type_descriptor, $namespace, $survey_identifier, $id, $use_snapshot): \Resources\Model\EdFiSurveyProgramAssociation[]
```
...
try {
    $result = $apiInstance->getSurveyProgramAssociations($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $education_organization_id, $program_name, $program_type_descriptor, $namespace, $survey_identifier, $id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
[**\Resources\Model\EdFiSurveyProgramAssociation[]**](../Model/EdFiSurveyProgramAssociation.md)
...
```php
getSurveyProgramAssociationsById($id, $if_none_match, $use_snapshot): \Resources\Model\EdFiSurveyProgramAssociation
```
...
## `getSurveyProgramAssociationsPartitions()`

```php
getSurveyProgramAssociationsPartitions($number, $min_change_version, $max_change_version, $education_organization_id, $program_name, $program_type_descriptor, $namespace, $survey_identifier, $id, $use_snapshot): \Resources\Model\GetAcademicWeeksPartitions200Response
```
...
try {
    $result = $apiInstance->getSurveyProgramAssociationsPartitions($number, $min_change_version, $max_change_version, $education_organization_id, $program_name, $program_type_descriptor, $namespace, $survey_identifier, $id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SurveyProgramAssociationsApi->getSurveyProgramAssociationsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
keyChangesSurveyProgramAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \Resources\Model\TrackedChangesEdFiSurveyProgramAssociationKeyChange[]
```
...
[**\Resources\Model\TrackedChangesEdFiSurveyProgramAssociationKeyChange[]**](../Model/TrackedChangesEdFiSurveyProgramAssociationKeyChange.md)
...
$ed_fi_survey_program_association = new \Resources\Model\EdFiSurveyProgramAssociation(); // \Resources\Model\EdFiSurveyProgramAssociation | The JSON representation of the \"surveyProgramAssociation\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_survey_program_association** | [**\Resources\Model\EdFiSurveyProgramAssociation**](../Model/EdFiSurveyProgramAssociation.md)| The JSON representation of the \&quot;surveyProgramAssociation\&quot; resource to be created or updated. | |
