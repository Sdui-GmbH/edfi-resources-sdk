...
```php
deleteLocalActualById($id, $if_match)
```
...
try {
    $apiInstance->deleteLocalActualById($id, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling LocalActualsApi->deleteLocalActualById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->deletesLocalActuals($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LocalActualsApi->deletesLocalActuals: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->getLocalActualsById($id, $if_none_match, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LocalActualsApi->getLocalActualsById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $result = $apiInstance->keyChangesLocalActuals($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LocalActualsApi->keyChangesLocalActuals: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
postLocalActual($ed_fi_local_actual)
```
...
try {
    ...
    echo 'Exception when calling LocalActualsApi->postLocalActual: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
putLocalActual($id, $ed_fi_local_actual, $if_match)
```
...
try {
    $apiInstance->putLocalActual($id, $ed_fi_local_actual, $if_match);
} catch (Exception $e) {
    echo 'Exception when calling LocalActualsApi->putLocalActual: ', $e->getMessage(), PHP_EOL;
}
```
