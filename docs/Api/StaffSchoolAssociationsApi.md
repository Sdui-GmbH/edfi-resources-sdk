...
| [**getStaffSchoolAssociationsPartitions()**](StaffSchoolAssociationsApi.md#getStaffSchoolAssociationsPartitions) | **GET** /ed-fi/staffSchoolAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing. |
...
```php
getStaffSchoolAssociations($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $program_assignment_descriptor, $school_id, $staff_unique_id, $calendar_code, $school_year, $id, $use_snapshot): \Resources\Model\EdFiStaffSchoolAssociation[]
```
...
try {
    $result = $apiInstance->getStaffSchoolAssociations($offset, $limit, $page_token, $page_size, $min_change_version, $max_change_version, $total_count, $program_assignment_descriptor, $school_id, $staff_unique_id, $calendar_code, $school_year, $id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
...
```php
getStaffSchoolAssociationsPartitions($number, $min_change_version, $max_change_version, $program_assignment_descriptor, $school_id, $staff_unique_id, $calendar_code, $school_year, $id, $use_snapshot): \Resources\Model\GetAcademicWeeksPartitions200Response
```
...
try {
    $result = $apiInstance->getStaffSchoolAssociationsPartitions($number, $min_change_version, $max_change_version, $program_assignment_descriptor, $school_id, $staff_unique_id, $calendar_code, $school_year, $id, $use_snapshot);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling StaffSchoolAssociationsApi->getStaffSchoolAssociationsPartitions: ', $e->getMessage(), PHP_EOL;
}
```
