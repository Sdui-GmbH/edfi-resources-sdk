# OpenAPI\Client\StaffSchoolAssociationsApi
...
$apiInstance = new OpenAPI\Client\Api\StaffSchoolAssociationsApi(
...
```php
deletesStaffSchoolAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStaffSchoolAssociationDelete[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStaffSchoolAssociationDelete[]**](../Model/TrackedChangesEdFiStaffSchoolAssociationDelete.md)
...
```php
getStaffSchoolAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $program_assignment_descriptor, $school_id, $staff_unique_id, $calendar_code, $school_year, $id, $use_snapshot): \OpenAPI\Client\Model\EdFiStaffSchoolAssociation[]
```
...
[**\OpenAPI\Client\Model\EdFiStaffSchoolAssociation[]**](../Model/EdFiStaffSchoolAssociation.md)
...
```php
getStaffSchoolAssociationsById($id, $if_none_match, $use_snapshot): \OpenAPI\Client\Model\EdFiStaffSchoolAssociation
```
...
```php
keyChangesStaffSchoolAssociations($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot): \OpenAPI\Client\Model\TrackedChangesEdFiStaffSchoolAssociationKeyChange[]
```
...
[**\OpenAPI\Client\Model\TrackedChangesEdFiStaffSchoolAssociationKeyChange[]**](../Model/TrackedChangesEdFiStaffSchoolAssociationKeyChange.md)
...
$ed_fi_staff_school_association = new \OpenAPI\Client\Model\EdFiStaffSchoolAssociation(); // \OpenAPI\Client\Model\EdFiStaffSchoolAssociation | The JSON representation of the \"staffSchoolAssociation\" resource to be created or updated.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ed_fi_staff_school_association** | [**\OpenAPI\Client\Model\EdFiStaffSchoolAssociation**](../Model/EdFiStaffSchoolAssociation.md)| The JSON representation of the \&quot;staffSchoolAssociation\&quot; resource to be created or updated. | |
