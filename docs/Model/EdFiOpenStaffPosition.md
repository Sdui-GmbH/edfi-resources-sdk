...
**academic_subjects** | [**\OpenAPI\Client\Model\EdFiOpenStaffPositionAcademicSubject[]**](EdFiOpenStaffPositionAcademicSubject.md) | An unordered collection of openStaffPositionAcademicSubjects. The teaching field required for the open staff position. | [optional]
...
**instructional_grade_levels** | [**\OpenAPI\Client\Model\EdFiOpenStaffPositionInstructionalGradeLevel[]**](EdFiOpenStaffPositionInstructionalGradeLevel.md) | An unordered collection of openStaffPositionInstructionalGradeLevels. The set of grade levels for which the position&#39;s assignment is responsible. | [optional]
