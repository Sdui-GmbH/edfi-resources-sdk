...
**periods** | [**\OpenAPI\Client\Model\EdFiStaffAddressPeriod[]**](EdFiStaffAddressPeriod.md) | An unordered collection of staffAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address. | [optional]
