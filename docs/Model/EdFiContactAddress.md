...
**periods** | [**\OpenAPI\Client\Model\EdFiContactAddressPeriod[]**](EdFiContactAddressPeriod.md) | An unordered collection of contactAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address. | [optional]
