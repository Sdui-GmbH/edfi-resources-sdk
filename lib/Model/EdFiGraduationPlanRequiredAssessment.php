 ...
 */
class EdFiGraduationPlanRequiredAssessment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_graduationPlanRequiredAssessment';
    ...
    protected static $setters = [
        ...
        'scores' => 'setScores',
        'performance_level' => 'setPerformanceLevel'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('performance_level', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['performance_level'];
    }
     ...
     * @return self
     */
    public function setPerformanceLevel($performance_level)
    {
        if (is_null($performance_level)) {
            throw new \InvalidArgumentException('non-nullable performance_level cannot be null');
        }
        $this->container['performance_level'] = $performance_level;
