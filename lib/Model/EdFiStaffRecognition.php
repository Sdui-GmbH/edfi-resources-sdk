...
/**
 * EdFiStaffRecognition Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStaffRecognition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_staffRecognition';
    ...
    {
        $this->container['recognition_type_descriptor'] = $data['recognition_type_descriptor'] ?? null;
        ...
        $this->container['recognition_award_date'] = $data['recognition_award_date'] ?? null;
        $this->container['recognition_award_expires_date'] = $data['recognition_award_expires_date'] ?? null;
        $this->container['recognition_description'] = $data['recognition_description'] ?? null;
    }
    ...
    public function setRecognitionTypeDescriptor($recognition_type_descriptor)
    {
        if ((mb_strlen($recognition_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $recognition_type_descriptor when calling EdFiStaffRecognition., must be smaller than or equal to 306.');
        }
    ...
    public function setAchievementCategoryDescriptor($achievement_category_descriptor)
    {
        if (!is_null($achievement_category_descriptor) && (mb_strlen($achievement_category_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $achievement_category_descriptor when calling EdFiStaffRecognition., must be smaller than or equal to 306.');
        }
    ...
    public function setAchievementCategorySystem($achievement_category_system)
    {
        if (!is_null($achievement_category_system) && (mb_strlen($achievement_category_system) > 60)) {
            throw new \InvalidArgumentException('invalid length for $achievement_category_system when calling EdFiStaffRecognition., must be smaller than or equal to 60.');
        }
        if (!is_null($achievement_category_system) && (mb_strlen($achievement_category_system) < 1)) {
            throw new \InvalidArgumentException('invalid length for $achievement_category_system when calling EdFiStaffRecognition., must be bigger than or equal to 1.');
        }
    ...
    public function setAchievementTitle($achievement_title)
    {
        if (!is_null($achievement_title) && (mb_strlen($achievement_title) > 60)) {
            throw new \InvalidArgumentException('invalid length for $achievement_title when calling EdFiStaffRecognition., must be smaller than or equal to 60.');
        }
        if (!is_null($achievement_title) && (mb_strlen($achievement_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $achievement_title when calling EdFiStaffRecognition., must be bigger than or equal to 1.');
        }
    ...
    public function setCriteria($criteria)
    {
        if (!is_null($criteria) && (mb_strlen($criteria) > 150)) {
            throw new \InvalidArgumentException('invalid length for $criteria when calling EdFiStaffRecognition., must be smaller than or equal to 150.');
        }
        if (!is_null($criteria) && (mb_strlen($criteria) < 1)) {
            throw new \InvalidArgumentException('invalid length for $criteria when calling EdFiStaffRecognition., must be bigger than or equal to 1.');
        }
    ...
    public function setCriteriaUrl($criteria_url)
    {
        if (!is_null($criteria_url) && (mb_strlen($criteria_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $criteria_url when calling EdFiStaffRecognition., must be smaller than or equal to 255.');
        }
        if (!is_null($criteria_url) && (mb_strlen($criteria_url) < 5)) {
            throw new \InvalidArgumentException('invalid length for $criteria_url when calling EdFiStaffRecognition., must be bigger than or equal to 5.');
        }
    ...
    public function setEvidenceStatement($evidence_statement)
    {
        if (!is_null($evidence_statement) && (mb_strlen($evidence_statement) > 150)) {
            throw new \InvalidArgumentException('invalid length for $evidence_statement when calling EdFiStaffRecognition., must be smaller than or equal to 150.');
        }
        if (!is_null($evidence_statement) && (mb_strlen($evidence_statement) < 1)) {
            throw new \InvalidArgumentException('invalid length for $evidence_statement when calling EdFiStaffRecognition., must be bigger than or equal to 1.');
        }
    ...
    public function setImageUrl($image_url)
    {
        if (!is_null($image_url) && (mb_strlen($image_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling EdFiStaffRecognition., must be smaller than or equal to 255.');
        }
        if (!is_null($image_url) && (mb_strlen($image_url) < 5)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling EdFiStaffRecognition., must be bigger than or equal to 5.');
        }
    ...
    public function setIssuerName($issuer_name)
    {
        if (!is_null($issuer_name) && (mb_strlen($issuer_name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $issuer_name when calling EdFiStaffRecognition., must be smaller than or equal to 150.');
        }
        if (!is_null($issuer_name) && (mb_strlen($issuer_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $issuer_name when calling EdFiStaffRecognition., must be bigger than or equal to 1.');
        }
    ...
    public function setIssuerOriginUrl($issuer_origin_url)
    {
        if (!is_null($issuer_origin_url) && (mb_strlen($issuer_origin_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $issuer_origin_url when calling EdFiStaffRecognition., must be smaller than or equal to 255.');
        }
        if (!is_null($issuer_origin_url) && (mb_strlen($issuer_origin_url) < 5)) {
            throw new \InvalidArgumentException('invalid length for $issuer_origin_url when calling EdFiStaffRecognition., must be bigger than or equal to 5.');
        }
    ...
    public function setRecognitionDescription($recognition_description)
    {
        if (!is_null($recognition_description) && (mb_strlen($recognition_description) > 80)) {
            throw new \InvalidArgumentException('invalid length for $recognition_description when calling EdFiStaffRecognition., must be smaller than or equal to 80.');
        }
        if (!is_null($recognition_description) && (mb_strlen($recognition_description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $recognition_description when calling EdFiStaffRecognition., must be bigger than or equal to 1.');
        }
