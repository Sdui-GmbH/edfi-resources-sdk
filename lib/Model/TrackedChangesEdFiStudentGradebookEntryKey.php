...
/**
 * TrackedChangesEdFiStudentGradebookEntryKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStudentGradebookEntryKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_studentGradebookEntryKey';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['gradebook_entry_identifier']) && (mb_strlen($this->container['gradebook_entry_identifier']) > 60)) {
     ...
     *
     * @param string|null $gradebook_entry_identifier A unique number or alphanumeric code assigned to a gradebook entry by the source system.
     *
     * @return self
     */
    public function setGradebookEntryIdentifier($gradebook_entry_identifier)
    {
        ...
        if ((mb_strlen($gradebook_entry_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $gradebook_entry_identifier when calling TrackedChangesEdFiStudentGradebookEntryKey., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($gradebook_entry_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $gradebook_entry_identifier when calling TrackedChangesEdFiStudentGradebookEntryKey., must be bigger than or equal to 1.');
        }
     ...
     * Sets namespace
     *
     * @param string|null $namespace Namespace URI for the source of the gradebook entry.
     *
     * @return self
     */
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiStudentGradebookEntryKey., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($namespace) < 5)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiStudentGradebookEntryKey., must be bigger than or equal to 5.');
        }
    ...
    public function setStudentUniqueId($student_unique_id)
    {
        ...
        if ((mb_strlen($student_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentGradebookEntryKey., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($student_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentGradebookEntryKey., must be bigger than or equal to 1.');
        }
