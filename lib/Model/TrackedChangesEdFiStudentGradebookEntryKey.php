...
class TrackedChangesEdFiStudentGradebookEntryKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        if (!is_null($gradebook_entry_identifier) && (mb_strlen($gradebook_entry_identifier) > 60)) {
        ...
        if (!is_null($gradebook_entry_identifier) && (mb_strlen($gradebook_entry_identifier) < 1)) {
