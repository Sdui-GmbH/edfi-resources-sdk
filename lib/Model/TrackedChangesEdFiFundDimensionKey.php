...
/**
 * TrackedChangesEdFiFundDimensionKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiFundDimensionKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_fundDimensionKey';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code The code representation of the account fund dimension.
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 16)) {
            throw new \InvalidArgumentException('invalid length for $code when calling TrackedChangesEdFiFundDimensionKey., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling TrackedChangesEdFiFundDimensionKey., must be bigger than or equal to 1.');
        }
     ...
     * Sets fiscal_year
     *
     * @param int|null $fiscal_year The fiscal year for which the account fund dimension is valid.
     *
     * @return self
     */
    public function setFiscalYear($fiscal_year)
    {
        ...
        if (($fiscal_year > 2040)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling TrackedChangesEdFiFundDimensionKey., must be smaller than or equal to 2040.');
        }
        if (($fiscal_year < 2020)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling TrackedChangesEdFiFundDimensionKey., must be bigger than or equal to 2020.');
        }
