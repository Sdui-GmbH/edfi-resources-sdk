    ...
    */
    ...
    public function setDiagnosticStatement($diagnostic_statement)
    {
        ...
        if (!is_null($diagnostic_statement) && (mb_strlen($diagnostic_statement) < 1)) {
            throw new \InvalidArgumentException('invalid length for $diagnostic_statement when calling EdFiStudentCompetencyObjective., must be bigger than or equal to 1.');
        }
