 ...
 */
class EdFiStudentSpecialEducationProgramAssociationDisability implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentSpecialEducationProgramAssociationDisability';
    ...
    public function setDisabilityDescriptor($disability_descriptor)
    {
        if ((mb_strlen($disability_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $disability_descriptor when calling EdFiStudentSpecialEducationProgramAssociationDisability., must be smaller than or equal to 306.');
        }
    ...
    public function setDisabilityDeterminationSourceTypeDescriptor($disability_determination_source_type_descriptor)
    {
        if (!is_null($disability_determination_source_type_descriptor) && (mb_strlen($disability_determination_source_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $disability_determination_source_type_descriptor when calling EdFiStudentSpecialEducationProgramAssociationDisability., must be smaller than or equal to 306.');
        }
