...
/**
 * TrackedChangesEdFiStudentAssessmentRegistrationKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStudentAssessmentRegistrationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_studentAssessmentRegistrationKey';
    ...
    */
    ...
    public function setAdministrationIdentifier($administration_identifier)
    {
        ...
        if ((mb_strlen($administration_identifier) > 255)) {
            throw new \InvalidArgumentException('invalid length for $administration_identifier when calling TrackedChangesEdFiStudentAssessmentRegistrationKey., must be smaller than or equal to 255.');
        }
    ...
    public function setAssessmentIdentifier($assessment_identifier)
    {
        ...
        if ((mb_strlen($assessment_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $assessment_identifier when calling TrackedChangesEdFiStudentAssessmentRegistrationKey., must be smaller than or equal to 60.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiStudentAssessmentRegistrationKey., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($namespace) < 5)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiStudentAssessmentRegistrationKey., must be bigger than or equal to 5.');
        }
    ...
    public function setStudentUniqueId($student_unique_id)
    {
        ...
        if ((mb_strlen($student_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentAssessmentRegistrationKey., must be smaller than or equal to 32.');
        }
