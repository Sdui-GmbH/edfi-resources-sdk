...
class EdFiChartOfAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['balance_sheet_dimension_reference'] = $data['balance_sheet_dimension_reference'] ?? null;
        $this->container['education_organization_reference'] = $data['education_organization_reference'] ?? null;
        $this->container['function_dimension_reference'] = $data['function_dimension_reference'] ?? null;
        $this->container['fund_dimension_reference'] = $data['fund_dimension_reference'] ?? null;
        $this->container['object_dimension_reference'] = $data['object_dimension_reference'] ?? null;
        $this->container['operational_unit_dimension_reference'] = $data['operational_unit_dimension_reference'] ?? null;
        $this->container['program_dimension_reference'] = $data['program_dimension_reference'] ?? null;
        $this->container['project_dimension_reference'] = $data['project_dimension_reference'] ?? null;
        $this->container['source_dimension_reference'] = $data['source_dimension_reference'] ?? null;
        $this->container['account_name'] = $data['account_name'] ?? null;
        $this->container['account_type_descriptor'] = $data['account_type_descriptor'] ?? null;
        $this->container['reporting_tags'] = $data['reporting_tags'] ?? null;
