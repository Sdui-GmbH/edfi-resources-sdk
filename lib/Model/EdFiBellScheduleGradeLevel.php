...
/**
 * EdFiBellScheduleGradeLevel Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiBellScheduleGradeLevel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_bellScheduleGradeLevel';
    ...
    */
     ...
     *
     * @param string $grade_level_descriptor The grade levels the particular bell schedule applies to.
     *
     * @return self
     */
    public function setGradeLevelDescriptor($grade_level_descriptor)
    {
        ...
        if ((mb_strlen($grade_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grade_level_descriptor when calling EdFiBellScheduleGradeLevel., must be smaller than or equal to 306.');
        }
