...
/**
 * TrackedChangesTpdmCandidateKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesTpdmCandidateKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_tpdm_candidateKey';
    ...
    */
    ...
    public function setCandidateIdentifier($candidate_identifier)
    {
        ...
        if ((mb_strlen($candidate_identifier) > 32)) {
            throw new \InvalidArgumentException('invalid length for $candidate_identifier when calling TrackedChangesTpdmCandidateKey., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($candidate_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $candidate_identifier when calling TrackedChangesTpdmCandidateKey., must be bigger than or equal to 1.');
        }
