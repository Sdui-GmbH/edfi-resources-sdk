...
/**
 * TrackedChangesEdFiProgramEvaluationObjectiveKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiProgramEvaluationObjectiveKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_programEvaluationObjectiveKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['program_evaluation_objective_title']) && (mb_strlen($this->container['program_evaluation_objective_title']) > 50)) {
     ...
     *
     * @param string|null $program_evaluation_objective_title The name or title of the program evaluation objective.
     *
     * @return self
     */
    public function setProgramEvaluationObjectiveTitle($program_evaluation_objective_title)
    {
        if (!is_null($program_evaluation_objective_title) && (mb_strlen($program_evaluation_objective_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $program_evaluation_objective_title when calling TrackedChangesEdFiProgramEvaluationObjectiveKey., must be smaller than or equal to 50.');
        }
    ...
    public function setProgramEvaluationPeriodDescriptor($program_evaluation_period_descriptor)
    {
        if (!is_null($program_evaluation_period_descriptor) && (mb_strlen($program_evaluation_period_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_evaluation_period_descriptor when calling TrackedChangesEdFiProgramEvaluationObjectiveKey., must be smaller than or equal to 306.');
        }
    ...
    public function setProgramEvaluationTitle($program_evaluation_title)
    {
        if (!is_null($program_evaluation_title) && (mb_strlen($program_evaluation_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $program_evaluation_title when calling TrackedChangesEdFiProgramEvaluationObjectiveKey., must be smaller than or equal to 50.');
        }
    ...
    public function setProgramEvaluationTypeDescriptor($program_evaluation_type_descriptor)
    {
        if (!is_null($program_evaluation_type_descriptor) && (mb_strlen($program_evaluation_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_evaluation_type_descriptor when calling TrackedChangesEdFiProgramEvaluationObjectiveKey., must be smaller than or equal to 306.');
        }
    ...
    public function setProgramName($program_name)
    {
        if (!is_null($program_name) && (mb_strlen($program_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $program_name when calling TrackedChangesEdFiProgramEvaluationObjectiveKey., must be smaller than or equal to 60.');
        }
        if (!is_null($program_name) && (mb_strlen($program_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $program_name when calling TrackedChangesEdFiProgramEvaluationObjectiveKey., must be bigger than or equal to 1.');
        }
    ...
    public function setProgramTypeDescriptor($program_type_descriptor)
    {
        if (!is_null($program_type_descriptor) && (mb_strlen($program_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_type_descriptor when calling TrackedChangesEdFiProgramEvaluationObjectiveKey., must be smaller than or equal to 306.');
        }
