...
/**
 * TrackedChangesEdFiStaffEducationOrganizationAssignmentAssociationKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStaffEducationOrganizationAssignmentAssociationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_staffEducationOrganizationAssignmentAssociationKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['staff_classification_descriptor']) && (mb_strlen($this->container['staff_classification_descriptor']) > 306)) {
     ...
     *
     * @param string|null $staff_classification_descriptor The titles of employment, official status, or rank of education staff.
     *
     * @return self
     */
    public function setStaffClassificationDescriptor($staff_classification_descriptor)
    {
        if (!is_null($staff_classification_descriptor) && (mb_strlen($staff_classification_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $staff_classification_descriptor when calling TrackedChangesEdFiStaffEducationOrganizationAssignmentAssociationKey., must be smaller than or equal to 306.');
        }
