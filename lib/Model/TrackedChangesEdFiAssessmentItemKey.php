...
/**
 * TrackedChangesEdFiAssessmentItemKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiAssessmentItemKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_assessmentItemKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['identification_code']) && (mb_strlen($this->container['identification_code']) > 60)) {
     ...
     *
     * @param string|null $identification_code A unique number or alphanumeric code assigned to a space, room, site, building, individual, organization, program, or institution by a school, school system, state, or other agency or entity.
     *
     * @return self
     */
    public function setIdentificationCode($identification_code)
    {
        if (!is_null($identification_code) && (mb_strlen($identification_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $identification_code when calling TrackedChangesEdFiAssessmentItemKey., must be smaller than or equal to 60.');
        }
        if (!is_null($identification_code) && (mb_strlen($identification_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identification_code when calling TrackedChangesEdFiAssessmentItemKey., must be bigger than or equal to 1.');
        }
    ...
    public function setAssessmentIdentifier($assessment_identifier)
    {
        if (!is_null($assessment_identifier) && (mb_strlen($assessment_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $assessment_identifier when calling TrackedChangesEdFiAssessmentItemKey., must be smaller than or equal to 60.');
        }
        if (!is_null($assessment_identifier) && (mb_strlen($assessment_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $assessment_identifier when calling TrackedChangesEdFiAssessmentItemKey., must be bigger than or equal to 1.');
        }
    ...
    public function setNamespace($namespace)
    {
        if (!is_null($namespace) && (mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiAssessmentItemKey., must be smaller than or equal to 255.');
        }
        if (!is_null($namespace) && (mb_strlen($namespace) < 5)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiAssessmentItemKey., must be bigger than or equal to 5.');
        }
