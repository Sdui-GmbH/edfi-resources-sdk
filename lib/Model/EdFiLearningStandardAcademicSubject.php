...
/**
 * EdFiLearningStandardAcademicSubject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiLearningStandardAcademicSubject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_learningStandardAcademicSubject';
    ...
    */
    ...
    public function setAcademicSubjectDescriptor($academic_subject_descriptor)
    {
        ...
        if ((mb_strlen($academic_subject_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $academic_subject_descriptor when calling EdFiLearningStandardAcademicSubject., must be smaller than or equal to 306.');
        }
