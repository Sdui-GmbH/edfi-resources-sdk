...
/**
 * TrackedChangesEdFiStudentInterventionAttendanceEventKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStudentInterventionAttendanceEventKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_studentInterventionAttendanceEventKey';
    ...
    public function setAttendanceEventCategoryDescriptor($attendance_event_category_descriptor)
    {
        if (!is_null($attendance_event_category_descriptor) && (mb_strlen($attendance_event_category_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $attendance_event_category_descriptor when calling TrackedChangesEdFiStudentInterventionAttendanceEventKey., must be smaller than or equal to 306.');
        }
