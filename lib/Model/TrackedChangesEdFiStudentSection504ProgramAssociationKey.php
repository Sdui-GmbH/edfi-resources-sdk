...
/**
 * TrackedChangesEdFiStudentSection504ProgramAssociationKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStudentSection504ProgramAssociationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_studentSection504ProgramAssociationKey';
    ...
    */
    ...
    public function setProgramName($program_name)
    {
        ...
        if ((mb_strlen($program_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $program_name when calling TrackedChangesEdFiStudentSection504ProgramAssociationKey., must be smaller than or equal to 60.');
        }
    ...
    public function setProgramTypeDescriptor($program_type_descriptor)
    {
        ...
        if ((mb_strlen($program_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_type_descriptor when calling TrackedChangesEdFiStudentSection504ProgramAssociationKey., must be smaller than or equal to 306.');
        }
    ...
    public function setStudentUniqueId($student_unique_id)
    {
        ...
        if ((mb_strlen($student_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentSection504ProgramAssociationKey., must be smaller than or equal to 32.');
        }
