...
/**
 * TrackedChangesEdFiStudentSectionAttendanceEventKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStudentSectionAttendanceEventKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_studentSectionAttendanceEventKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['attendance_event_category_descriptor']) && (mb_strlen($this->container['attendance_event_category_descriptor']) > 306)) {
     ...
     *
     * @param string|null $attendance_event_category_descriptor A code describing the attendance event, for example:         Present         Unexcused absence         Excused absence         Tardy.
     *
     * @return self
     */
    public function setAttendanceEventCategoryDescriptor($attendance_event_category_descriptor)
    {
        if (!is_null($attendance_event_category_descriptor) && (mb_strlen($attendance_event_category_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $attendance_event_category_descriptor when calling TrackedChangesEdFiStudentSectionAttendanceEventKey., must be smaller than or equal to 306.');
        }
     ...
     * Sets event_date
     *
     * @param \DateTime|null $event_date Date for this attendance event.
     *
     * @return self
     */
    ...
    public function setLocalCourseCode($local_course_code)
    {
        if (!is_null($local_course_code) && (mb_strlen($local_course_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $local_course_code when calling TrackedChangesEdFiStudentSectionAttendanceEventKey., must be smaller than or equal to 60.');
        }
        if (!is_null($local_course_code) && (mb_strlen($local_course_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $local_course_code when calling TrackedChangesEdFiStudentSectionAttendanceEventKey., must be bigger than or equal to 1.');
        }
    ...
    public function setSectionIdentifier($section_identifier)
    {
        if (!is_null($section_identifier) && (mb_strlen($section_identifier) > 255)) {
            throw new \InvalidArgumentException('invalid length for $section_identifier when calling TrackedChangesEdFiStudentSectionAttendanceEventKey., must be smaller than or equal to 255.');
        }
        if (!is_null($section_identifier) && (mb_strlen($section_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $section_identifier when calling TrackedChangesEdFiStudentSectionAttendanceEventKey., must be bigger than or equal to 1.');
        }
    ...
    public function setSessionName($session_name)
    {
        if (!is_null($session_name) && (mb_strlen($session_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $session_name when calling TrackedChangesEdFiStudentSectionAttendanceEventKey., must be smaller than or equal to 60.');
        }
        if (!is_null($session_name) && (mb_strlen($session_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $session_name when calling TrackedChangesEdFiStudentSectionAttendanceEventKey., must be bigger than or equal to 1.');
        }
    ...
    public function setStudentUniqueId($student_unique_id)
    {
        if (!is_null($student_unique_id) && (mb_strlen($student_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentSectionAttendanceEventKey., must be smaller than or equal to 32.');
        }
        if (!is_null($student_unique_id) && (mb_strlen($student_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentSectionAttendanceEventKey., must be bigger than or equal to 1.');
        }
