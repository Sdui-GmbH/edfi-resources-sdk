...
/**
 * EdFiFunctionDimension Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiFunctionDimension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_functionDimension';
    ...
    protected static $openAPITypes = [
        ...
        'fiscal_year' => 'int',
        'code_name' => 'string',
        'reporting_tags' => '\OpenAPI\Client\Model\EdFiFunctionDimensionReportingTag[]',
        '_etag' => 'string',
    ...
    */
     ...
     * Sets code
     *
     * @param string $code The code representation of the account function dimension.
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 16)) {
            throw new \InvalidArgumentException('invalid length for $code when calling EdFiFunctionDimension., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling EdFiFunctionDimension., must be bigger than or equal to 1.');
        }
     ...
     * Sets fiscal_year
     *
     * @param int $fiscal_year The fiscal year for which the account function dimension is valid.
     *
     * @return self
     */
    public function setFiscalYear($fiscal_year)
    {
        ...
        if (($fiscal_year > 2040)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling EdFiFunctionDimension., must be smaller than or equal to 2040.');
        }
        if (($fiscal_year < 2020)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling EdFiFunctionDimension., must be bigger than or equal to 2020.');
        }
     ...
     * Sets code_name
     *
     * @param string|null $code_name A description of the account function dimension.
     *
     * @return self
     */
    public function setCodeName($code_name)
    {
        ...
        if (!is_null($code_name) && (mb_strlen($code_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $code_name when calling EdFiFunctionDimension., must be smaller than or equal to 100.');
        }
        if (!is_null($code_name) && (mb_strlen($code_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code_name when calling EdFiFunctionDimension., must be bigger than or equal to 1.');
        }
     ...
     * Gets reporting_tags
     *
     * @return \OpenAPI\Client\Model\EdFiFunctionDimensionReportingTag[]|null
     */
     ...
     * Sets reporting_tags
     *
     * @param \OpenAPI\Client\Model\EdFiFunctionDimensionReportingTag[]|null $reporting_tags An unordered collection of functionDimensionReportingTags. Optional tag for accountability reporting.
     *
     * @return self
     */
