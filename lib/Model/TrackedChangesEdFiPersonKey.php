...
/**
 * TrackedChangesEdFiPersonKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiPersonKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_personKey';
    ...
    public function setSourceSystemDescriptor($source_system_descriptor)
    {
        if (!is_null($source_system_descriptor) && (mb_strlen($source_system_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $source_system_descriptor when calling TrackedChangesEdFiPersonKey., must be smaller than or equal to 306.');
        }
    ...
    public function setPersonId($person_id)
    {
        if (!is_null($person_id) && (mb_strlen($person_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $person_id when calling TrackedChangesEdFiPersonKey., must be smaller than or equal to 32.');
        }
        if (!is_null($person_id) && (mb_strlen($person_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $person_id when calling TrackedChangesEdFiPersonKey., must be bigger than or equal to 1.');
        }
