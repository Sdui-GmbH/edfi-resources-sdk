...
/**
 * TrackedChangesEdFiInterventionStudyKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiInterventionStudyKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_interventionStudyKey';
    ...
    {
        $this->container['intervention_study_identification_code'] = $data['intervention_study_identification_code'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['intervention_study_identification_code']) && (mb_strlen($this->container['intervention_study_identification_code']) > 60)) {
        ...
        if (!is_null($this->container['intervention_study_identification_code']) && (mb_strlen($this->container['intervention_study_identification_code']) < 1)) {
     ...
     *
     * @param string|null $intervention_study_identification_code A unique number or alphanumeric code assigned to an intervention study.
     *
     * @return self
     */
    public function setInterventionStudyIdentificationCode($intervention_study_identification_code)
    {
        if (!is_null($intervention_study_identification_code) && (mb_strlen($intervention_study_identification_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $intervention_study_identification_code when calling TrackedChangesEdFiInterventionStudyKey., must be smaller than or equal to 60.');
        }
        if (!is_null($intervention_study_identification_code) && (mb_strlen($intervention_study_identification_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $intervention_study_identification_code when calling TrackedChangesEdFiInterventionStudyKey., must be bigger than or equal to 1.');
        }
