...
class EdFiStudentNeglectedOrDelinquentProgramAssociationNeglectedOrDelinquentProgramService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'neglected_or_delinquent_program_service_descriptor' => false,
    ...
    {
        $this->setIfExists('neglected_or_delinquent_program_service_descriptor', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($neglected_or_delinquent_program_service_descriptor)) {
            throw new \InvalidArgumentException('non-nullable neglected_or_delinquent_program_service_descriptor cannot be null');
        }
