...
/**
 * TrackedChangesEdFiStaffEducationOrganizationContactAssociationKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStaffEducationOrganizationContactAssociationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_staffEducationOrganizationContactAssociationKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['contact_title']) && (mb_strlen($this->container['contact_title']) > 75)) {
     ...
     * Sets contact_title
     *
     * @param string|null $contact_title The title of the contact in the context of the education organization.
     *
     * @return self
     */
    public function setContactTitle($contact_title)
    {
        if (!is_null($contact_title) && (mb_strlen($contact_title) > 75)) {
        ...
        if (!is_null($contact_title) && (mb_strlen($contact_title) < 1)) {
