...
/**
 * TpdmEvaluationObjectiveReference Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TpdmEvaluationObjectiveReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_evaluationObjectiveReference';
    ...
    public function setEvaluationObjectiveTitle($evaluation_objective_title)
    {
        if ((mb_strlen($evaluation_objective_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_objective_title when calling TpdmEvaluationObjectiveReference., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($evaluation_objective_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_objective_title when calling TpdmEvaluationObjectiveReference., must be bigger than or equal to 1.');
        }
    ...
    public function setEvaluationPeriodDescriptor($evaluation_period_descriptor)
    {
        if ((mb_strlen($evaluation_period_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_period_descriptor when calling TpdmEvaluationObjectiveReference., must be smaller than or equal to 306.');
        }
    ...
    public function setEvaluationTitle($evaluation_title)
    {
        if ((mb_strlen($evaluation_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_title when calling TpdmEvaluationObjectiveReference., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($evaluation_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_title when calling TpdmEvaluationObjectiveReference., must be bigger than or equal to 1.');
        }
    ...
    public function setPerformanceEvaluationTitle($performance_evaluation_title)
    {
        if ((mb_strlen($performance_evaluation_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_title when calling TpdmEvaluationObjectiveReference., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($performance_evaluation_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_title when calling TpdmEvaluationObjectiveReference., must be bigger than or equal to 1.');
        }
    ...
    public function setPerformanceEvaluationTypeDescriptor($performance_evaluation_type_descriptor)
    {
        if ((mb_strlen($performance_evaluation_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_type_descriptor when calling TpdmEvaluationObjectiveReference., must be smaller than or equal to 306.');
        }
    ...
    public function setTermDescriptor($term_descriptor)
    {
        if ((mb_strlen($term_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $term_descriptor when calling TpdmEvaluationObjectiveReference., must be smaller than or equal to 306.');
        }
