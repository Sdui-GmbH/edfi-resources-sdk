...
/**
 * TrackedChangesEdFiStaffAbsenceEventKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStaffAbsenceEventKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_staffAbsenceEventKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['absence_event_category_descriptor']) && (mb_strlen($this->container['absence_event_category_descriptor']) > 306)) {
     ...
     *
     * @param string|null $absence_event_category_descriptor The code describing the type of absence.
     *
     * @return self
     */
    public function setAbsenceEventCategoryDescriptor($absence_event_category_descriptor)
    {
        if (!is_null($absence_event_category_descriptor) && (mb_strlen($absence_event_category_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $absence_event_category_descriptor when calling TrackedChangesEdFiStaffAbsenceEventKey., must be smaller than or equal to 306.');
        }
     ...
     * Sets event_date
     *
     * @param \DateTime|null $event_date Date for this leave event.
     *
     * @return self
     */
    ...
    public function setStaffUniqueId($staff_unique_id)
    {
        if (!is_null($staff_unique_id) && (mb_strlen($staff_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $staff_unique_id when calling TrackedChangesEdFiStaffAbsenceEventKey., must be smaller than or equal to 32.');
        }
        if (!is_null($staff_unique_id) && (mb_strlen($staff_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $staff_unique_id when calling TrackedChangesEdFiStaffAbsenceEventKey., must be bigger than or equal to 1.');
        }
