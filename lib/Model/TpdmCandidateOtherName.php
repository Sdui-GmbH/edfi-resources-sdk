...
/**
 * TpdmCandidateOtherName Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TpdmCandidateOtherName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_candidateOtherName';
    ...
    */
    ...
    public function setOtherNameTypeDescriptor($other_name_type_descriptor)
    {
        ...
        if ((mb_strlen($other_name_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $other_name_type_descriptor when calling TpdmCandidateOtherName., must be smaller than or equal to 306.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 75)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling TpdmCandidateOtherName., must be smaller than or equal to 75.');
        }
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling TpdmCandidateOtherName., must be bigger than or equal to 1.');
        }
    ...
    public function setGenerationCodeSuffix($generation_code_suffix)
    {
        ...
        if (!is_null($generation_code_suffix) && (mb_strlen($generation_code_suffix) > 10)) {
            throw new \InvalidArgumentException('invalid length for $generation_code_suffix when calling TpdmCandidateOtherName., must be smaller than or equal to 10.');
        }
        if (!is_null($generation_code_suffix) && (mb_strlen($generation_code_suffix) < 1)) {
            throw new \InvalidArgumentException('invalid length for $generation_code_suffix when calling TpdmCandidateOtherName., must be bigger than or equal to 1.');
        }
    ...
    public function setLastSurname($last_surname)
    {
        ...
        if ((mb_strlen($last_surname) > 75)) {
            throw new \InvalidArgumentException('invalid length for $last_surname when calling TpdmCandidateOtherName., must be smaller than or equal to 75.');
        }
        if ((mb_strlen($last_surname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_surname when calling TpdmCandidateOtherName., must be bigger than or equal to 1.');
        }
    ...
    public function setMiddleName($middle_name)
    {
        ...
        if (!is_null($middle_name) && (mb_strlen($middle_name) > 75)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling TpdmCandidateOtherName., must be smaller than or equal to 75.');
        }
        if (!is_null($middle_name) && (mb_strlen($middle_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling TpdmCandidateOtherName., must be bigger than or equal to 1.');
        }
    ...
    public function setPersonalTitlePrefix($personal_title_prefix)
    {
        ...
        if (!is_null($personal_title_prefix) && (mb_strlen($personal_title_prefix) > 30)) {
            throw new \InvalidArgumentException('invalid length for $personal_title_prefix when calling TpdmCandidateOtherName., must be smaller than or equal to 30.');
        }
        if (!is_null($personal_title_prefix) && (mb_strlen($personal_title_prefix) < 1)) {
            throw new \InvalidArgumentException('invalid length for $personal_title_prefix when calling TpdmCandidateOtherName., must be bigger than or equal to 1.');
        }
