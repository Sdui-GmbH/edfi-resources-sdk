...
/**
 * EdFiInterventionPopulationServed Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiInterventionPopulationServed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_interventionPopulationServed';
    ...
    */
     ...
     *
     * @param string $population_served_descriptor A subset of students that are the focus of the intervention.
     *
     * @return self
     */
    public function setPopulationServedDescriptor($population_served_descriptor)
    {
        ...
        if ((mb_strlen($population_served_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $population_served_descriptor when calling EdFiInterventionPopulationServed., must be smaller than or equal to 306.');
        }
