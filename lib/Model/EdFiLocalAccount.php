...
class EdFiLocalAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['chart_of_account_reference'] = $data['chart_of_account_reference'] ?? null;
    ...
    public function setAccountIdentifier($account_identifier)
    {
        ...
        if ((mb_strlen($account_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_identifier when calling EdFiLocalAccount., must be bigger than or equal to 1.');
        }
