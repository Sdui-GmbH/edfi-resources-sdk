...
/**
 * EdFiSurveyReference Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiSurveyReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_surveyReference';
    ...
    */
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiSurveyReference., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($namespace) < 5)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiSurveyReference., must be bigger than or equal to 5.');
        }
    ...
    public function setSurveyIdentifier($survey_identifier)
    {
        ...
        if ((mb_strlen($survey_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $survey_identifier when calling EdFiSurveyReference., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($survey_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $survey_identifier when calling EdFiSurveyReference., must be bigger than or equal to 1.');
        }
