 ...
 */
class EdFiSourceDimension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_sourceDimension';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code The code representation of the account source dimension.
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 16)) {
            throw new \InvalidArgumentException('invalid length for $code when calling EdFiSourceDimension., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling EdFiSourceDimension., must be bigger than or equal to 1.');
        }
    ...
    public function setFiscalYear($fiscal_year)
    {
        ...
        if (($fiscal_year > 2040)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling EdFiSourceDimension., must be smaller than or equal to 2040.');
        }
        if (($fiscal_year < 2020)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling EdFiSourceDimension., must be bigger than or equal to 2020.');
        }
     ...
     * Sets code_name
     *
     * @param string|null $code_name A description of the account source dimension.
     *
     * @return self
     */
    public function setCodeName($code_name)
    {
        ...
        if (!is_null($code_name) && (mb_strlen($code_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $code_name when calling EdFiSourceDimension., must be smaller than or equal to 100.');
        }
        if (!is_null($code_name) && (mb_strlen($code_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code_name when calling EdFiSourceDimension., must be bigger than or equal to 1.');
        }
