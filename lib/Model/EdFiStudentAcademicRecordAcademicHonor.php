...
class EdFiStudentAcademicRecordAcademicHonor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['academic_honor_category_descriptor'] = $data['academic_honor_category_descriptor'] ?? null;
        $this->container['honor_description'] = $data['honor_description'] ?? null;
        ...
        $this->container['honor_award_date'] = $data['honor_award_date'] ?? null;
        $this->container['honor_award_expires_date'] = $data['honor_award_expires_date'] ?? null;
