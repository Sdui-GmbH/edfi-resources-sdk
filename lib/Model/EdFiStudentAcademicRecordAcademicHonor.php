...
/**
 * EdFiStudentAcademicRecordAcademicHonor Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStudentAcademicRecordAcademicHonor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentAcademicRecordAcademicHonor';
    ...
    protected static $openAPITypes = [
        'academic_honor_category_descriptor' => 'string',
    ...
    protected static $openAPIFormats = [
        'academic_honor_category_descriptor' => null,
        'honor_description' => null,
    ...
    protected static array $openAPINullables = [
        'academic_honor_category_descriptor' => false,
        'honor_description' => false,
        ...
        'honor_award_date' => true,
        'honor_award_expires_date' => true,
        'image_url' => true,
        'issuer_name' => true,
    ...
    protected static $setters = [
        'academic_honor_category_descriptor' => 'setAcademicHonorCategoryDescriptor',
    ...
    protected static $getters = [
        'academic_honor_category_descriptor' => 'getAcademicHonorCategoryDescriptor',
    ...
    {
        $this->setIfExists('academic_honor_category_descriptor', $data ?? [], null);
        $this->setIfExists('honor_description', $data ?? [], null);
        ...
        $this->setIfExists('honor_award_date', $data ?? [], null);
        $this->setIfExists('honor_award_expires_date', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['academic_honor_category_descriptor'] === null) {
            $invalidProperties[] = "'academic_honor_category_descriptor' can't be null";
        }
        if ((mb_strlen($this->container['academic_honor_category_descriptor']) > 306)) {
            $invalidProperties[] = "invalid value for 'academic_honor_category_descriptor', the character length must be smaller than or equal to 306.";
        }

        if ($this->container['honor_description'] === null) {
            $invalidProperties[] = "'honor_description' can't be null";
        }
        if ((mb_strlen($this->container['honor_description']) > 80)) {
    ...
    /**
     * Gets academic_honor_category_descriptor
     *
     * @return string
     */
    public function getAcademicHonorCategoryDescriptor()
    {
        return $this->container['academic_honor_category_descriptor'];
    }

    /**
     * Sets academic_honor_category_descriptor
     *
     * @param string $academic_honor_category_descriptor A designation of the type of academic distinctions earned by or awarded to the individual.
     *
     * @return self
     */
    public function setAcademicHonorCategoryDescriptor($academic_honor_category_descriptor)
    {
        if (is_null($academic_honor_category_descriptor)) {
            throw new \InvalidArgumentException('non-nullable academic_honor_category_descriptor cannot be null');
        }
        if ((mb_strlen($academic_honor_category_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $academic_honor_category_descriptor when calling EdFiStudentAcademicRecordAcademicHonor., must be smaller than or equal to 306.');
        }

        $this->container['academic_honor_category_descriptor'] = $academic_honor_category_descriptor;
    ...
    {
        return $this->container['honor_description'];
    }
    ...
    {
        if (is_null($honor_description)) {
            throw new \InvalidArgumentException('non-nullable honor_description cannot be null');
        }
    ...
    public function setAchievementCategoryDescriptor($achievement_category_descriptor)
    {
        ...
        if (!is_null($achievement_category_descriptor) && (mb_strlen($achievement_category_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $achievement_category_descriptor when calling EdFiStudentAcademicRecordAcademicHonor., must be smaller than or equal to 306.');
        }
    ...
    public function setCriteriaUrl($criteria_url)
    {
        ...
        if (!is_null($criteria_url) && (mb_strlen($criteria_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $criteria_url when calling EdFiStudentAcademicRecordAcademicHonor., must be smaller than or equal to 255.');
        }
        if (!is_null($criteria_url) && (mb_strlen($criteria_url) < 5)) {
            throw new \InvalidArgumentException('invalid length for $criteria_url when calling EdFiStudentAcademicRecordAcademicHonor., must be bigger than or equal to 5.');
        }
    ...
    {
        return $this->container['honor_award_date'];
    }
    ...
    {
        if (is_null($honor_award_date)) {
            array_push($this->openAPINullablesSetToNull, 'honor_award_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('honor_award_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['honor_award_date'] = $honor_award_date;
    ...
    {
        return $this->container['honor_award_expires_date'];
    }
    ...
    {
        if (is_null($honor_award_expires_date)) {
            array_push($this->openAPINullablesSetToNull, 'honor_award_expires_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('honor_award_expires_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['honor_award_expires_date'] = $honor_award_expires_date;
    ...
    public function setImageUrl($image_url)
    {
        ...
        if (!is_null($image_url) && (mb_strlen($image_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling EdFiStudentAcademicRecordAcademicHonor., must be smaller than or equal to 255.');
        }
        if (!is_null($image_url) && (mb_strlen($image_url) < 5)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling EdFiStudentAcademicRecordAcademicHonor., must be bigger than or equal to 5.');
        }
    ...
    public function setIssuerOriginUrl($issuer_origin_url)
    {
        ...
        if (!is_null($issuer_origin_url) && (mb_strlen($issuer_origin_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $issuer_origin_url when calling EdFiStudentAcademicRecordAcademicHonor., must be smaller than or equal to 255.');
        }
        if (!is_null($issuer_origin_url) && (mb_strlen($issuer_origin_url) < 5)) {
            throw new \InvalidArgumentException('invalid length for $issuer_origin_url when calling EdFiStudentAcademicRecordAcademicHonor., must be bigger than or equal to 5.');
        }
