...
/**
 * TrackedChangesEdFiEducationContentKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiEducationContentKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_educationContentKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['content_identifier']) && (mb_strlen($this->container['content_identifier']) > 225)) {
     ...
     *
     * @param string|null $content_identifier A unique identifier for the education content.
     *
     * @return self
     */
    public function setContentIdentifier($content_identifier)
    {
        if (!is_null($content_identifier) && (mb_strlen($content_identifier) > 225)) {
        ...
        if (!is_null($content_identifier) && (mb_strlen($content_identifier) < 1)) {
