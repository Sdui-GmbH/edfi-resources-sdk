...
/**
 * EdFiCourseIdentificationCode Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiCourseIdentificationCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_courseIdentificationCode';
    ...
    */
    ...
    public function setCourseIdentificationSystemDescriptor($course_identification_system_descriptor)
    {
        ...
        if ((mb_strlen($course_identification_system_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $course_identification_system_descriptor when calling EdFiCourseIdentificationCode., must be smaller than or equal to 306.');
        }
    ...
    public function setAssigningOrganizationIdentificationCode($assigning_organization_identification_code)
    {
        ...
        if (!is_null($assigning_organization_identification_code) && (mb_strlen($assigning_organization_identification_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $assigning_organization_identification_code when calling EdFiCourseIdentificationCode., must be smaller than or equal to 60.');
        }
        if (!is_null($assigning_organization_identification_code) && (mb_strlen($assigning_organization_identification_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $assigning_organization_identification_code when calling EdFiCourseIdentificationCode., must be bigger than or equal to 1.');
        }
    ...
    public function setCourseCatalogUrl($course_catalog_url)
    {
        ...
        if (!is_null($course_catalog_url) && (mb_strlen($course_catalog_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $course_catalog_url when calling EdFiCourseIdentificationCode., must be smaller than or equal to 255.');
        }
        if (!is_null($course_catalog_url) && (mb_strlen($course_catalog_url) < 5)) {
            throw new \InvalidArgumentException('invalid length for $course_catalog_url when calling EdFiCourseIdentificationCode., must be bigger than or equal to 5.');
        }
    ...
    public function setIdentificationCode($identification_code)
    {
        ...
        if ((mb_strlen($identification_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $identification_code when calling EdFiCourseIdentificationCode., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($identification_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identification_code when calling EdFiCourseIdentificationCode., must be bigger than or equal to 1.');
        }
