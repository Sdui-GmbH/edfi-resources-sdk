...
/**
 * TrackedChangesEdFiStudentInterventionAssociationKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStudentInterventionAssociationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_studentInterventionAssociationKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['intervention_identification_code']) && (mb_strlen($this->container['intervention_identification_code']) > 60)) {
     ...
     *
     * @param string|null $intervention_identification_code A unique number or alphanumeric code assigned to an intervention.
     *
     * @return self
     */
    public function setInterventionIdentificationCode($intervention_identification_code)
    {
        if (!is_null($intervention_identification_code) && (mb_strlen($intervention_identification_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $intervention_identification_code when calling TrackedChangesEdFiStudentInterventionAssociationKey., must be smaller than or equal to 60.');
        }
        if (!is_null($intervention_identification_code) && (mb_strlen($intervention_identification_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $intervention_identification_code when calling TrackedChangesEdFiStudentInterventionAssociationKey., must be bigger than or equal to 1.');
        }
    ...
    public function setStudentUniqueId($student_unique_id)
    {
        if (!is_null($student_unique_id) && (mb_strlen($student_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentInterventionAssociationKey., must be smaller than or equal to 32.');
        }
        if (!is_null($student_unique_id) && (mb_strlen($student_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentInterventionAssociationKey., must be bigger than or equal to 1.');
        }
