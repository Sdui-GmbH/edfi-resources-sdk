...
/**
 * TrackedChangesTpdmSurveySectionResponsePersonTargetAssociationKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesTpdmSurveySectionResponsePersonTargetAssociationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_tpdm_surveySectionResponsePersonTargetAssociationKey';
    ...
    */
    ...
    public function setSourceSystemDescriptor($source_system_descriptor)
    {
        ...
        if ((mb_strlen($source_system_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $source_system_descriptor when calling TrackedChangesTpdmSurveySectionResponsePersonTargetAssociationKey., must be smaller than or equal to 306.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesTpdmSurveySectionResponsePersonTargetAssociationKey., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($namespace) < 5)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesTpdmSurveySectionResponsePersonTargetAssociationKey., must be bigger than or equal to 5.');
        }
