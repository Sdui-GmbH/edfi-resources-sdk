...
/**
 * EdFiObjectDimension Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiObjectDimension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_objectDimension';
    ...
    protected static $openAPITypes = [
        ...
        'fiscal_year' => 'int',
        'code_name' => 'string',
        'reporting_tags' => '\OpenAPI\Client\Model\EdFiObjectDimensionReportingTag[]',
        '_etag' => 'string',
    ...
    */
     ...
     * Sets code
     *
     * @param string $code The code representation of the account object dimension.
     *
     * @return self
     */
     ...
     * Sets fiscal_year
     *
     * @param int $fiscal_year The fiscal year for which the account object dimension is valid.
     *
     * @return self
     */
    public function setFiscalYear($fiscal_year)
    {
        ...
        if (($fiscal_year > 2040)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling EdFiObjectDimension., must be smaller than or equal to 2040.');
        }
        if (($fiscal_year < 2020)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling EdFiObjectDimension., must be bigger than or equal to 2020.');
        }
     ...
     * Sets code_name
     *
     * @param string|null $code_name A description of the account object dimension.
     *
     * @return self
     */
     ...
     * Gets reporting_tags
     *
     * @return \OpenAPI\Client\Model\EdFiObjectDimensionReportingTag[]|null
     */
     ...
     * Sets reporting_tags
     *
     * @param \OpenAPI\Client\Model\EdFiObjectDimensionReportingTag[]|null $reporting_tags An unordered collection of objectDimensionReportingTags. Optional tag for accountability reporting.
     *
     * @return self
     */
