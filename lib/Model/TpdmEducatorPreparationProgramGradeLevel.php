...
/**
 * TpdmEducatorPreparationProgramGradeLevel Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TpdmEducatorPreparationProgramGradeLevel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_educatorPreparationProgramGradeLevel';
    ...
    */
     ...
     *
     * @param string $grade_level_descriptor The grade levels served at the EPP Program.
     *
     * @return self
     */
    public function setGradeLevelDescriptor($grade_level_descriptor)
    {
        ...
        if ((mb_strlen($grade_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grade_level_descriptor when calling TpdmEducatorPreparationProgramGradeLevel., must be smaller than or equal to 306.');
        }
