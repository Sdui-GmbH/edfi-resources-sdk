...
/**
 * EdFiGraduationPlanCreditsBySubject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiGraduationPlanCreditsBySubject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_graduationPlanCreditsBySubject';
    ...
    protected static array $openAPINullables = [
        'academic_subject_descriptor' => false,
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['academic_subject_descriptor'] === null) {
            $invalidProperties[] = "'academic_subject_descriptor' can't be null";
        }
        if ((mb_strlen($this->container['academic_subject_descriptor']) > 306)) {
     ...
     *
     * @param string $academic_subject_descriptor The intended major subject area of the graduation requirement.
     *
     * @return self
     */
    public function setAcademicSubjectDescriptor($academic_subject_descriptor)
    {
        if (is_null($academic_subject_descriptor)) {
            throw new \InvalidArgumentException('non-nullable academic_subject_descriptor cannot be null');
        }
        if ((mb_strlen($academic_subject_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $academic_subject_descriptor when calling EdFiGraduationPlanCreditsBySubject., must be smaller than or equal to 306.');
        }
    ...
    public function setCreditTypeDescriptor($credit_type_descriptor)
    {
        ...
        if (!is_null($credit_type_descriptor) && (mb_strlen($credit_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $credit_type_descriptor when calling EdFiGraduationPlanCreditsBySubject., must be smaller than or equal to 306.');
        }
