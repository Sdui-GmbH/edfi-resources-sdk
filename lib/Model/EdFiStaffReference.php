...
/**
 * EdFiStaffReference Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStaffReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_staffReference';
    ...
    */
    ...
    public function setStaffUniqueId($staff_unique_id)
    {
        ...
        if ((mb_strlen($staff_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $staff_unique_id when calling EdFiStaffReference., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($staff_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $staff_unique_id when calling EdFiStaffReference., must be bigger than or equal to 1.');
        }
