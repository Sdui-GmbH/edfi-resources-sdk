 ...
 */
class TpdmCredentialStudentAcademicRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_credentialStudentAcademicRecord';
