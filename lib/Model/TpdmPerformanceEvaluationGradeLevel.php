...
/**
 * TpdmPerformanceEvaluationGradeLevel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TpdmPerformanceEvaluationGradeLevel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_performanceEvaluationGradeLevel';
    ...
    */
     ...
     *
     * @param string $grade_level_descriptor The grade levels involved with the performance evaluation.
     *
     * @return self
     */
    public function setGradeLevelDescriptor($grade_level_descriptor)
    {
        ...
        if ((mb_strlen($grade_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grade_level_descriptor when calling TpdmPerformanceEvaluationGradeLevel., must be smaller than or equal to 306.');
        }
