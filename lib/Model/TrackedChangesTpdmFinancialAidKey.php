...
/**
 * TrackedChangesTpdmFinancialAidKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesTpdmFinancialAidKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_tpdm_financialAidKey';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['aid_type_descriptor']) && (mb_strlen($this->container['aid_type_descriptor']) > 306)) {
     ...
     *
     * @param string|null $aid_type_descriptor The classification of financial aid awarded to a person for the academic term/year.
     *
     * @return self
     */
    public function setAidTypeDescriptor($aid_type_descriptor)
    {
        ...
        if ((mb_strlen($aid_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $aid_type_descriptor when calling TrackedChangesTpdmFinancialAidKey., must be smaller than or equal to 306.');
        }
    ...
    public function setStudentUniqueId($student_unique_id)
    {
        ...
        if ((mb_strlen($student_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesTpdmFinancialAidKey., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($student_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesTpdmFinancialAidKey., must be bigger than or equal to 1.');
        }
