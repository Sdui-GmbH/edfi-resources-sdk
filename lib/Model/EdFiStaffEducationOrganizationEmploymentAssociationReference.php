...
/**
 * EdFiStaffEducationOrganizationEmploymentAssociationReference Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStaffEducationOrganizationEmploymentAssociationReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_staffEducationOrganizationEmploymentAssociationReference';
    ...
    */
    ...
    public function setEmploymentStatusDescriptor($employment_status_descriptor)
    {
        ...
        if ((mb_strlen($employment_status_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $employment_status_descriptor when calling EdFiStaffEducationOrganizationEmploymentAssociationReference., must be smaller than or equal to 306.');
        }
