...
/**
 * TrackedChangesEdFiStudentProgramAttendanceEventKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStudentProgramAttendanceEventKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_studentProgramAttendanceEventKey';
    ...
    */
    ...
    public function setAttendanceEventCategoryDescriptor($attendance_event_category_descriptor)
    {
        ...
        if ((mb_strlen($attendance_event_category_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $attendance_event_category_descriptor when calling TrackedChangesEdFiStudentProgramAttendanceEventKey., must be smaller than or equal to 306.');
        }
    ...
    public function setProgramTypeDescriptor($program_type_descriptor)
    {
        ...
        if ((mb_strlen($program_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_type_descriptor when calling TrackedChangesEdFiStudentProgramAttendanceEventKey., must be smaller than or equal to 306.');
        }
