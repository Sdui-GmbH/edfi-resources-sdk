...
/**
 * EdFiEducationOrganizationInternationalAddress Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiEducationOrganizationInternationalAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_educationOrganizationInternationalAddress';
    ...
    public function setAddressTypeDescriptor($address_type_descriptor)
    {
        if ((mb_strlen($address_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $address_type_descriptor when calling EdFiEducationOrganizationInternationalAddress., must be smaller than or equal to 306.');
        }
    ...
    public function setCountryDescriptor($country_descriptor)
    {
        if ((mb_strlen($country_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $country_descriptor when calling EdFiEducationOrganizationInternationalAddress., must be smaller than or equal to 306.');
        }
