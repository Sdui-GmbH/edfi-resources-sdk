...
class TrackedChangesTpdmEvaluationElementRatingKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPersonId($person_id)
    {
        ...
        if (!is_null($person_id) && (mb_strlen($person_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $person_id when calling TrackedChangesTpdmEvaluationElementRatingKey., must be bigger than or equal to 1.');
        }
