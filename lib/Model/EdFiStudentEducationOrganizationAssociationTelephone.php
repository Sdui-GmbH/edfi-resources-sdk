...
class EdFiStudentEducationOrganizationAssociationTelephone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setTelephoneNumber($telephone_number)
    {
        ...
        if ((mb_strlen($telephone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $telephone_number when calling EdFiStudentEducationOrganizationAssociationTelephone., must be bigger than or equal to 1.');
        }
