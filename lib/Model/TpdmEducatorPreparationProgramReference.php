...
/**
 * TpdmEducatorPreparationProgramReference Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TpdmEducatorPreparationProgramReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_educatorPreparationProgramReference';
    ...
    */
    ...
    public function setProgramName($program_name)
    {
        ...
        if ((mb_strlen($program_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $program_name when calling TpdmEducatorPreparationProgramReference., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($program_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $program_name when calling TpdmEducatorPreparationProgramReference., must be bigger than or equal to 1.');
        }
    ...
    public function setProgramTypeDescriptor($program_type_descriptor)
    {
        ...
        if ((mb_strlen($program_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_type_descriptor when calling TpdmEducatorPreparationProgramReference., must be smaller than or equal to 306.');
        }
