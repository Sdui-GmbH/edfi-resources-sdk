...
/**
 * EdFiStaffSchoolAssociationGradeLevel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStaffSchoolAssociationGradeLevel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_staffSchoolAssociationGradeLevel';
    ...
    */
     ...
     *
     * @param string $grade_level_descriptor The grade levels the individual is eligible to teach.
     *
     * @return self
     */
    public function setGradeLevelDescriptor($grade_level_descriptor)
    {
        ...
        if ((mb_strlen($grade_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grade_level_descriptor when calling EdFiStaffSchoolAssociationGradeLevel., must be smaller than or equal to 306.');
        }
