 ...
 */
class EdFiStudentSchoolFoodServiceProgramAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentSchoolFoodServiceProgramAssociation';
    ...
    protected static $openAPIFormats = [
        ...
        'school_food_service_program_services' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'direct_certification' => true,
        'end_date' => true,
        'program_participation_statuses' => false,
        'reason_exited_descriptor' => true,
        'school_food_service_program_services' => false,
    ...
    protected static $setters = [
        ...
        'direct_certification' => 'setDirectCertification',
        'end_date' => 'setEndDate',
        'program_participation_statuses' => 'setProgramParticipationStatuses',
        'reason_exited_descriptor' => 'setReasonExitedDescriptor',
        'school_food_service_program_services' => 'setSchoolFoodServiceProgramServices',
    ...
    protected static $getters = [
        ...
        'direct_certification' => 'getDirectCertification',
        'end_date' => 'getEndDate',
        'program_participation_statuses' => 'getProgramParticipationStatuses',
        'reason_exited_descriptor' => 'getReasonExitedDescriptor',
        'school_food_service_program_services' => 'getSchoolFoodServiceProgramServices',
    ...
    */
    ...
    /**
     * Gets direct_certification
     *
     * @return bool|null
     */
    public function getDirectCertification()
    {
        return $this->container['direct_certification'];
    }

    /**
     * Sets direct_certification
     *
     * @param bool|null $direct_certification Indicates that the student's National School Lunch Program (NSLP) eligibility has been determined through direct certification.
     *
     * @return self
     */
    public function setDirectCertification($direct_certification)
    {
        if (is_null($direct_certification)) {
            array_push($this->openAPINullablesSetToNull, 'direct_certification');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('direct_certification', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['direct_certification'] = $direct_certification;
    ...
    public function setReasonExitedDescriptor($reason_exited_descriptor)
    {
        ...
        if (!is_null($reason_exited_descriptor) && (mb_strlen($reason_exited_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $reason_exited_descriptor when calling EdFiStudentSchoolFoodServiceProgramAssociation., must be smaller than or equal to 306.');
        }
    ...
    {
        return $this->container['school_food_service_program_services'];
    }
     ...
     * @return self
     */
    public function setSchoolFoodServiceProgramServices($school_food_service_program_services)
    {
        if (is_null($school_food_service_program_services)) {
            throw new \InvalidArgumentException('non-nullable school_food_service_program_services cannot be null');
        }
        $this->container['school_food_service_program_services'] = $school_food_service_program_services;
