...
/**
 * TpdmEvaluationObjectiveRatingReference Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TpdmEvaluationObjectiveRatingReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_evaluationObjectiveRatingReference';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['evaluation_objective_title'] = $data['evaluation_objective_title'] ?? null;
        $this->container['evaluation_period_descriptor'] = $data['evaluation_period_descriptor'] ?? null;
        $this->container['evaluation_title'] = $data['evaluation_title'] ?? null;
        $this->container['performance_evaluation_title'] = $data['performance_evaluation_title'] ?? null;
        $this->container['performance_evaluation_type_descriptor'] = $data['performance_evaluation_type_descriptor'] ?? null;
        $this->container['person_id'] = $data['person_id'] ?? null;
        $this->container['school_year'] = $data['school_year'] ?? null;
        $this->container['source_system_descriptor'] = $data['source_system_descriptor'] ?? null;
    ...
    public function setEvaluationObjectiveTitle($evaluation_objective_title)
    {
        if ((mb_strlen($evaluation_objective_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_objective_title when calling TpdmEvaluationObjectiveRatingReference., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($evaluation_objective_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_objective_title when calling TpdmEvaluationObjectiveRatingReference., must be bigger than or equal to 1.');
        }
    ...
    public function setEvaluationPeriodDescriptor($evaluation_period_descriptor)
    {
        if ((mb_strlen($evaluation_period_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_period_descriptor when calling TpdmEvaluationObjectiveRatingReference., must be smaller than or equal to 306.');
        }
    ...
    public function setEvaluationTitle($evaluation_title)
    {
        if ((mb_strlen($evaluation_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_title when calling TpdmEvaluationObjectiveRatingReference., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($evaluation_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_title when calling TpdmEvaluationObjectiveRatingReference., must be bigger than or equal to 1.');
        }
    ...
    public function setPerformanceEvaluationTitle($performance_evaluation_title)
    {
        if ((mb_strlen($performance_evaluation_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_title when calling TpdmEvaluationObjectiveRatingReference., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($performance_evaluation_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_title when calling TpdmEvaluationObjectiveRatingReference., must be bigger than or equal to 1.');
        }
    ...
    public function setPerformanceEvaluationTypeDescriptor($performance_evaluation_type_descriptor)
    {
        if ((mb_strlen($performance_evaluation_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_type_descriptor when calling TpdmEvaluationObjectiveRatingReference., must be smaller than or equal to 306.');
        }
    ...
    public function setPersonId($person_id)
    {
        if ((mb_strlen($person_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $person_id when calling TpdmEvaluationObjectiveRatingReference., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($person_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $person_id when calling TpdmEvaluationObjectiveRatingReference., must be bigger than or equal to 1.');
        }
    ...
    public function setSourceSystemDescriptor($source_system_descriptor)
    {
        if ((mb_strlen($source_system_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $source_system_descriptor when calling TpdmEvaluationObjectiveRatingReference., must be smaller than or equal to 306.');
        }
    ...
    public function setTermDescriptor($term_descriptor)
    {
        if ((mb_strlen($term_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $term_descriptor when calling TpdmEvaluationObjectiveRatingReference., must be smaller than or equal to 306.');
        }
