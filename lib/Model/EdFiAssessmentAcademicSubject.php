...
/**
 * EdFiAssessmentAcademicSubject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiAssessmentAcademicSubject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_assessmentAcademicSubject';
    ...
    */
    ...
    public function setAcademicSubjectDescriptor($academic_subject_descriptor)
    {
        ...
        if ((mb_strlen($academic_subject_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $academic_subject_descriptor when calling EdFiAssessmentAcademicSubject., must be smaller than or equal to 306.');
        }
