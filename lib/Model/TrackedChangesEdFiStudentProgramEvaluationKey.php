...
/**
 * TrackedChangesEdFiStudentProgramEvaluationKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStudentProgramEvaluationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_studentProgramEvaluationKey';
     ...
     *
     * @param \DateTime|null $evaluation_date The month, day, and year on which the evaluation was conducted.
     *
     * @return self
     */
    ...
    public function setProgramEvaluationPeriodDescriptor($program_evaluation_period_descriptor)
    {
        if (!is_null($program_evaluation_period_descriptor) && (mb_strlen($program_evaluation_period_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_evaluation_period_descriptor when calling TrackedChangesEdFiStudentProgramEvaluationKey., must be smaller than or equal to 306.');
        }
    ...
    public function setProgramEvaluationTitle($program_evaluation_title)
    {
        if (!is_null($program_evaluation_title) && (mb_strlen($program_evaluation_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $program_evaluation_title when calling TrackedChangesEdFiStudentProgramEvaluationKey., must be smaller than or equal to 50.');
        }
    ...
    public function setProgramEvaluationTypeDescriptor($program_evaluation_type_descriptor)
    {
        if (!is_null($program_evaluation_type_descriptor) && (mb_strlen($program_evaluation_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_evaluation_type_descriptor when calling TrackedChangesEdFiStudentProgramEvaluationKey., must be smaller than or equal to 306.');
        }
    ...
    public function setProgramName($program_name)
    {
        if (!is_null($program_name) && (mb_strlen($program_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $program_name when calling TrackedChangesEdFiStudentProgramEvaluationKey., must be smaller than or equal to 60.');
        }
        if (!is_null($program_name) && (mb_strlen($program_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $program_name when calling TrackedChangesEdFiStudentProgramEvaluationKey., must be bigger than or equal to 1.');
        }
    ...
    public function setProgramTypeDescriptor($program_type_descriptor)
    {
        if (!is_null($program_type_descriptor) && (mb_strlen($program_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_type_descriptor when calling TrackedChangesEdFiStudentProgramEvaluationKey., must be smaller than or equal to 306.');
        }
    ...
    public function setStudentUniqueId($student_unique_id)
    {
        if (!is_null($student_unique_id) && (mb_strlen($student_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentProgramEvaluationKey., must be smaller than or equal to 32.');
        }
        if (!is_null($student_unique_id) && (mb_strlen($student_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentProgramEvaluationKey., must be bigger than or equal to 1.');
        }
