...
/**
 * TrackedChangesTpdmRubricDimensionKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesTpdmRubricDimensionKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_tpdm_rubricDimensionKey';
     ...
     * Sets rubric_rating
     *
     * @param int|null $rubric_rating The rating achieved for the rubric dimension.
     *
     * @return self
     */
    ...
    {
        if (!is_null($evaluation_element_title) && (mb_strlen($evaluation_element_title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_element_title when calling TrackedChangesTpdmRubricDimensionKey., must be smaller than or equal to 255.');
        }
        if (!is_null($evaluation_element_title) && (mb_strlen($evaluation_element_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_element_title when calling TrackedChangesTpdmRubricDimensionKey., must be bigger than or equal to 1.');
        }
    ...
    {
        if (!is_null($evaluation_objective_title) && (mb_strlen($evaluation_objective_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_objective_title when calling TrackedChangesTpdmRubricDimensionKey., must be smaller than or equal to 50.');
        }
        if (!is_null($evaluation_objective_title) && (mb_strlen($evaluation_objective_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_objective_title when calling TrackedChangesTpdmRubricDimensionKey., must be bigger than or equal to 1.');
        }
    ...
    {
        if (!is_null($evaluation_period_descriptor) && (mb_strlen($evaluation_period_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_period_descriptor when calling TrackedChangesTpdmRubricDimensionKey., must be smaller than or equal to 306.');
        }
    ...
    {
        if (!is_null($evaluation_title) && (mb_strlen($evaluation_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_title when calling TrackedChangesTpdmRubricDimensionKey., must be smaller than or equal to 50.');
        }
        if (!is_null($evaluation_title) && (mb_strlen($evaluation_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_title when calling TrackedChangesTpdmRubricDimensionKey., must be bigger than or equal to 1.');
        }
    ...
    {
        if (!is_null($performance_evaluation_title) && (mb_strlen($performance_evaluation_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_title when calling TrackedChangesTpdmRubricDimensionKey., must be smaller than or equal to 50.');
        }
        if (!is_null($performance_evaluation_title) && (mb_strlen($performance_evaluation_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_title when calling TrackedChangesTpdmRubricDimensionKey., must be bigger than or equal to 1.');
        }
    ...
    {
        if (!is_null($performance_evaluation_type_descriptor) && (mb_strlen($performance_evaluation_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_type_descriptor when calling TrackedChangesTpdmRubricDimensionKey., must be smaller than or equal to 306.');
        }
    ...
    public function setTermDescriptor($term_descriptor)
    {
        if (!is_null($term_descriptor) && (mb_strlen($term_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $term_descriptor when calling TrackedChangesTpdmRubricDimensionKey., must be smaller than or equal to 306.');
        }
