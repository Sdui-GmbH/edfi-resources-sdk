...
/**
 * TrackedChangesEdFiDisciplineActionKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiDisciplineActionKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_disciplineActionKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['discipline_action_identifier']) && (mb_strlen($this->container['discipline_action_identifier']) > 36)) {
     ...
     *
     * @param string|null $discipline_action_identifier Identifier assigned by the education organization to the discipline action.
     *
     * @return self
     */
    public function setDisciplineActionIdentifier($discipline_action_identifier)
    {
        if (!is_null($discipline_action_identifier) && (mb_strlen($discipline_action_identifier) > 36)) {
        ...
        if (!is_null($discipline_action_identifier) && (mb_strlen($discipline_action_identifier) < 1)) {
     ...
     *
     * @param \DateTime|null $discipline_date The date of the discipline action.
     *
     * @return self
     */
