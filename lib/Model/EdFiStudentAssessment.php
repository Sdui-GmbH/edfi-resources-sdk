...
class EdFiStudentAssessment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reported_school_reference'] = $data['reported_school_reference'] ?? null;
        ...
        $this->container['administration_date'] = $data['administration_date'] ?? null;
        $this->container['administration_end_date'] = $data['administration_end_date'] ?? null;
        $this->container['administration_environment_descriptor'] = $data['administration_environment_descriptor'] ?? null;
        $this->container['administration_language_descriptor'] = $data['administration_language_descriptor'] ?? null;
        $this->container['assessed_minutes'] = $data['assessed_minutes'] ?? null;
        $this->container['event_circumstance_descriptor'] = $data['event_circumstance_descriptor'] ?? null;
        ...
        $this->container['platform_type_descriptor'] = $data['platform_type_descriptor'] ?? null;
        $this->container['reason_not_tested_descriptor'] = $data['reason_not_tested_descriptor'] ?? null;
        $this->container['reported_school_identifier'] = $data['reported_school_identifier'] ?? null;
        $this->container['retest_indicator_descriptor'] = $data['retest_indicator_descriptor'] ?? null;
        $this->container['score_results'] = $data['score_results'] ?? null;
        $this->container['serial_number'] = $data['serial_number'] ?? null;
        $this->container['student_objective_assessments'] = $data['student_objective_assessments'] ?? null;
        $this->container['when_assessed_grade_level_descriptor'] = $data['when_assessed_grade_level_descriptor'] ?? null;
