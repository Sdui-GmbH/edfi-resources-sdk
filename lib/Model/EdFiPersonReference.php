 ...
 */
class EdFiPersonReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_personReference';
    ...
    public function setPersonId($person_id)
    {
        if ((mb_strlen($person_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $person_id when calling EdFiPersonReference., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($person_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $person_id when calling EdFiPersonReference., must be bigger than or equal to 1.');
        }
    ...
    public function setSourceSystemDescriptor($source_system_descriptor)
    {
        if ((mb_strlen($source_system_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $source_system_descriptor when calling EdFiPersonReference., must be smaller than or equal to 306.');
        }
