...
/**
 * EdFiContactTelephone Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiContactTelephone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_contactTelephone';
    ...
    public function setTelephoneNumberTypeDescriptor($telephone_number_type_descriptor)
    {
        if ((mb_strlen($telephone_number_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $telephone_number_type_descriptor when calling EdFiContactTelephone., must be smaller than or equal to 306.');
        }
    ...
    public function setTelephoneNumber($telephone_number)
    {
        if ((mb_strlen($telephone_number) > 24)) {
            throw new \InvalidArgumentException('invalid length for $telephone_number when calling EdFiContactTelephone., must be smaller than or equal to 24.');
        }
        if ((mb_strlen($telephone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $telephone_number when calling EdFiContactTelephone., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderOfPriority($order_of_priority)
    {
        ...
        if (!is_null($order_of_priority) && ($order_of_priority < 1)) {
            throw new \InvalidArgumentException('invalid value for $order_of_priority when calling EdFiContactTelephone., must be bigger than or equal to 1.');
        }
