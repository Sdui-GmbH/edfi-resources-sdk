 ...
 */
class EdFiStudentProgramAttendanceEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentProgramAttendanceEvent';
    ...
    protected static $openAPIFormats = [
        ...
        'program_attendance_duration' => 'int32',
        '_etag' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'event_duration' => true,
        'program_attendance_duration' => true,
        '_etag' => false,
    ...
    protected static $setters = [
        ...
        'program_attendance_duration' => 'setProgramAttendanceDuration',
        '_etag' => 'setEtag',
    ...
    protected static $getters = [
        ...
        'program_attendance_duration' => 'getProgramAttendanceDuration',
        '_etag' => 'getEtag',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('program_attendance_duration', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['program_attendance_duration']) && ($this->container['program_attendance_duration'] > 1440)) {
            $invalidProperties[] = "invalid value for 'program_attendance_duration', must be smaller than or equal to 1440.";
        }

        if (!is_null($this->container['program_attendance_duration']) && ($this->container['program_attendance_duration'] < 0)) {
            $invalidProperties[] = "invalid value for 'program_attendance_duration', must be bigger than or equal to 0.";
        }
    ...
    public function setAttendanceEventCategoryDescriptor($attendance_event_category_descriptor)
    {
        ...
        if ((mb_strlen($attendance_event_category_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $attendance_event_category_descriptor when calling EdFiStudentProgramAttendanceEvent., must be smaller than or equal to 306.');
        }
    ...
    public function setEducationalEnvironmentDescriptor($educational_environment_descriptor)
    {
        ...
        if (!is_null($educational_environment_descriptor) && (mb_strlen($educational_environment_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $educational_environment_descriptor when calling EdFiStudentProgramAttendanceEvent., must be smaller than or equal to 306.');
        }
    ...
    public function setEventDuration($event_duration)
    {
        ...
        if (!is_null($event_duration) && ($event_duration > 1.0)) {
            throw new \InvalidArgumentException('invalid value for $event_duration when calling EdFiStudentProgramAttendanceEvent., must be smaller than or equal to 1.0.');
        }
        if (!is_null($event_duration) && ($event_duration < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $event_duration when calling EdFiStudentProgramAttendanceEvent., must be bigger than or equal to 0.0.');
        }
    ...
    /**
     * Gets program_attendance_duration
     *
     * @return int|null
     */
    public function getProgramAttendanceDuration()
    {
        return $this->container['program_attendance_duration'];
    }

    /**
     * Sets program_attendance_duration
     *
     * @param int|null $program_attendance_duration The duration in minutes of the program attendance event.
     *
     * @return self
     */
    public function setProgramAttendanceDuration($program_attendance_duration)
    {
        if (is_null($program_attendance_duration)) {
            array_push($this->openAPINullablesSetToNull, 'program_attendance_duration');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('program_attendance_duration', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($program_attendance_duration) && ($program_attendance_duration > 1440)) {
            throw new \InvalidArgumentException('invalid value for $program_attendance_duration when calling EdFiStudentProgramAttendanceEvent., must be smaller than or equal to 1440.');
        }
        if (!is_null($program_attendance_duration) && ($program_attendance_duration < 0)) {
            throw new \InvalidArgumentException('invalid value for $program_attendance_duration when calling EdFiStudentProgramAttendanceEvent., must be bigger than or equal to 0.');
        }

        $this->container['program_attendance_duration'] = $program_attendance_duration;
