...
class EdFiStudentMigrantEducationProgramAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['continuation_of_services_reason_descriptor'] = $data['continuation_of_services_reason_descriptor'] ?? null;
        $this->container['eligibility_expiration_date'] = $data['eligibility_expiration_date'] ?? null;
        $this->container['end_date'] = $data['end_date'] ?? null;
        $this->container['last_qualifying_move'] = $data['last_qualifying_move'] ?? null;
        $this->container['migrant_education_program_services'] = $data['migrant_education_program_services'] ?? null;
        $this->container['priority_for_services'] = $data['priority_for_services'] ?? null;
        $this->container['program_participation_statuses'] = $data['program_participation_statuses'] ?? null;
        $this->container['qualifying_arrival_date'] = $data['qualifying_arrival_date'] ?? null;
        ...
        $this->container['state_residency_date'] = $data['state_residency_date'] ?? null;
        $this->container['us_initial_entry'] = $data['us_initial_entry'] ?? null;
        $this->container['us_initial_school_entry'] = $data['us_initial_school_entry'] ?? null;
        $this->container['us_most_recent_entry'] = $data['us_most_recent_entry'] ?? null;
