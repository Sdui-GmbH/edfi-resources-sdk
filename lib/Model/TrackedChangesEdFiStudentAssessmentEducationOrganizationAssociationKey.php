...
class TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'education_organization_association_type_descriptor' => false,
    ...
    {
        $this->setIfExists('education_organization_association_type_descriptor', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($education_organization_association_type_descriptor)) {
            throw new \InvalidArgumentException('non-nullable education_organization_association_type_descriptor cannot be null');
        }
        if ((mb_strlen($education_organization_association_type_descriptor) > 306)) {
