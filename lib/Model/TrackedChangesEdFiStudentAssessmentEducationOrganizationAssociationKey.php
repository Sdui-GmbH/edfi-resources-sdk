...
/**
 * TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_studentAssessmentEducationOrganizationAssociationKey';
    ...
    protected static $openAPIFormats = [
        'education_organization_association_type_descriptor' => null,
    ...
    protected static $attributeMap = [
        'education_organization_association_type_descriptor' => 'educationOrganizationAssociationTypeDescriptor',
    ...
    protected static $setters = [
        'education_organization_association_type_descriptor' => 'setEducationOrganizationAssociationTypeDescriptor',
    ...
    protected static $getters = [
        'education_organization_association_type_descriptor' => 'getEducationOrganizationAssociationTypeDescriptor',
    ...
    {
        $this->container['education_organization_association_type_descriptor'] = $data['education_organization_association_type_descriptor'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['education_organization_association_type_descriptor']) && (mb_strlen($this->container['education_organization_association_type_descriptor']) > 306)) {
            $invalidProperties[] = "invalid value for 'education_organization_association_type_descriptor', the character length must be smaller than or equal to 306.";
        }
    ...
    /**
     * Gets education_organization_association_type_descriptor
     *
     * @return string|null
     */
    public function getEducationOrganizationAssociationTypeDescriptor()
    {
        return $this->container['education_organization_association_type_descriptor'];
    }

    /**
     * Sets education_organization_association_type_descriptor
     *
     * @param string|null $education_organization_association_type_descriptor The type of association being represented.
     *
     * @return self
     */
    public function setEducationOrganizationAssociationTypeDescriptor($education_organization_association_type_descriptor)
    {
        if (!is_null($education_organization_association_type_descriptor) && (mb_strlen($education_organization_association_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $education_organization_association_type_descriptor when calling TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey., must be smaller than or equal to 306.');
        }

        $this->container['education_organization_association_type_descriptor'] = $education_organization_association_type_descriptor;
    ...
    public function setAssessmentIdentifier($assessment_identifier)
    {
        if (!is_null($assessment_identifier) && (mb_strlen($assessment_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $assessment_identifier when calling TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey., must be smaller than or equal to 60.');
        }
        if (!is_null($assessment_identifier) && (mb_strlen($assessment_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $assessment_identifier when calling TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey., must be bigger than or equal to 1.');
        }
    ...
    public function setNamespace($namespace)
    {
        if (!is_null($namespace) && (mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey., must be smaller than or equal to 255.');
        }
        if (!is_null($namespace) && (mb_strlen($namespace) < 5)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey., must be bigger than or equal to 5.');
        }
    ...
    public function setStudentAssessmentIdentifier($student_assessment_identifier)
    {
        if (!is_null($student_assessment_identifier) && (mb_strlen($student_assessment_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $student_assessment_identifier when calling TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey., must be smaller than or equal to 60.');
        }
        if (!is_null($student_assessment_identifier) && (mb_strlen($student_assessment_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $student_assessment_identifier when calling TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey., must be bigger than or equal to 1.');
        }
    ...
    public function setStudentUniqueId($student_unique_id)
    {
        if (!is_null($student_unique_id) && (mb_strlen($student_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey., must be smaller than or equal to 32.');
        }
        if (!is_null($student_unique_id) && (mb_strlen($student_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentAssessmentEducationOrganizationAssociationKey., must be bigger than or equal to 1.');
        }
