...
/**
 * EdFiStudentAssessmentScoreResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStudentAssessmentScoreResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentAssessmentScoreResult';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['result']) > 35)) {
    ...
    public function setAssessmentReportingMethodDescriptor($assessment_reporting_method_descriptor)
    {
        ...
        if ((mb_strlen($assessment_reporting_method_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $assessment_reporting_method_descriptor when calling EdFiStudentAssessmentScoreResult., must be smaller than or equal to 306.');
        }
     ...
     *
     * @param string $result_datatype_type_descriptor The datatype of the result. The results can be expressed as a number, percentile, range, level, etc.
     *
     * @return self
     */
    public function setResultDatatypeTypeDescriptor($result_datatype_type_descriptor)
    {
        ...
        if ((mb_strlen($result_datatype_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $result_datatype_type_descriptor when calling EdFiStudentAssessmentScoreResult., must be smaller than or equal to 306.');
        }
    ...
    public function setResult($result)
    {
        ...
        if ((mb_strlen($result) > 35)) {
            throw new \InvalidArgumentException('invalid length for $result when calling EdFiStudentAssessmentScoreResult., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($result) < 1)) {
            throw new \InvalidArgumentException('invalid length for $result when calling EdFiStudentAssessmentScoreResult., must be bigger than or equal to 1.');
        }
