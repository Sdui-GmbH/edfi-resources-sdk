...
/**
 * TrackedChangesEdFiAssessmentAdministrationKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiAssessmentAdministrationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_assessmentAdministrationKey';
    ...
    */
    ...
    public function setAdministrationIdentifier($administration_identifier)
    {
        ...
        if ((mb_strlen($administration_identifier) > 255)) {
            throw new \InvalidArgumentException('invalid length for $administration_identifier when calling TrackedChangesEdFiAssessmentAdministrationKey., must be smaller than or equal to 255.');
        }
    ...
    public function setAssessmentIdentifier($assessment_identifier)
    {
        ...
        if ((mb_strlen($assessment_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $assessment_identifier when calling TrackedChangesEdFiAssessmentAdministrationKey., must be smaller than or equal to 60.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiAssessmentAdministrationKey., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($namespace) < 5)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiAssessmentAdministrationKey., must be bigger than or equal to 5.');
        }
