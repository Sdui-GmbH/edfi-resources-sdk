...
/**
 * TrackedChangesEdFiGraduationPlanKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiGraduationPlanKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_graduationPlanKey';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['graduation_plan_type_descriptor']) && (mb_strlen($this->container['graduation_plan_type_descriptor']) > 306)) {
     ...
     *
     * @param string|null $graduation_plan_type_descriptor The type of academic plan the student is following for graduation.
     *
     * @return self
     */
    public function setGraduationPlanTypeDescriptor($graduation_plan_type_descriptor)
    {
        ...
        if ((mb_strlen($graduation_plan_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $graduation_plan_type_descriptor when calling TrackedChangesEdFiGraduationPlanKey., must be smaller than or equal to 306.');
        }
     ...
     *
     * @param int|null $graduation_school_year The school year the student is expected to graduate.
     *
     * @return self
     */
