...
/**
 * EdFiInterventionPrescriptionPopulationServed Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiInterventionPrescriptionPopulationServed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_interventionPrescriptionPopulationServed';
    ...
    */
     ...
     *
     * @param string $population_served_descriptor A subset of students that are the focus of the intervention prescription.
     *
     * @return self
     */
    public function setPopulationServedDescriptor($population_served_descriptor)
    {
        ...
        if ((mb_strlen($population_served_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $population_served_descriptor when calling EdFiInterventionPrescriptionPopulationServed., must be smaller than or equal to 306.');
        }
