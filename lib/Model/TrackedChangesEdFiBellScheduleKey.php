...
/**
 * TrackedChangesEdFiBellScheduleKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiBellScheduleKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_bellScheduleKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['bell_schedule_name']) && (mb_strlen($this->container['bell_schedule_name']) > 60)) {
     ...
     *
     * @param string|null $bell_schedule_name Name or title of the bell schedule.
     *
     * @return self
     */
    public function setBellScheduleName($bell_schedule_name)
    {
        if (!is_null($bell_schedule_name) && (mb_strlen($bell_schedule_name) > 60)) {
        ...
        if (!is_null($bell_schedule_name) && (mb_strlen($bell_schedule_name) < 1)) {
