...
/**
 * TpdmCandidateElectronicMail Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TpdmCandidateElectronicMail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_candidateElectronicMail';
    ...
    */
    ...
    public function setElectronicMailTypeDescriptor($electronic_mail_type_descriptor)
    {
        ...
        if ((mb_strlen($electronic_mail_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $electronic_mail_type_descriptor when calling TpdmCandidateElectronicMail., must be smaller than or equal to 306.');
        }
    ...
    public function setElectronicMailAddress($electronic_mail_address)
    {
        ...
        if ((mb_strlen($electronic_mail_address) > 128)) {
            throw new \InvalidArgumentException('invalid length for $electronic_mail_address when calling TpdmCandidateElectronicMail., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($electronic_mail_address) < 7)) {
            throw new \InvalidArgumentException('invalid length for $electronic_mail_address when calling TpdmCandidateElectronicMail., must be bigger than or equal to 7.');
        }
