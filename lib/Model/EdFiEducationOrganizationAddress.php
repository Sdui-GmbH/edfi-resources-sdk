...
/**
 * EdFiEducationOrganizationAddress Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiEducationOrganizationAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_educationOrganizationAddress';
    ...
    protected static $openAPITypes = [
        ...
        'periods' => '\OpenAPI\Client\Model\EdFiEducationOrganizationAddressPeriod[]'
    ];
    ...
    {
        $this->container['address_type_descriptor'] = $data['address_type_descriptor'] ?? null;
        $this->container['state_abbreviation_descriptor'] = $data['state_abbreviation_descriptor'] ?? null;
        $this->container['city'] = $data['city'] ?? null;
        $this->container['postal_code'] = $data['postal_code'] ?? null;
        $this->container['street_number_name'] = $data['street_number_name'] ?? null;
        $this->container['locale_descriptor'] = $data['locale_descriptor'] ?? null;
        $this->container['apartment_room_suite_number'] = $data['apartment_room_suite_number'] ?? null;
        $this->container['building_site_number'] = $data['building_site_number'] ?? null;
        $this->container['congressional_district'] = $data['congressional_district'] ?? null;
        $this->container['county_fips_code'] = $data['county_fips_code'] ?? null;
        ...
        $this->container['name_of_county'] = $data['name_of_county'] ?? null;
    ...
    public function setAddressTypeDescriptor($address_type_descriptor)
    {
        if ((mb_strlen($address_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $address_type_descriptor when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 306.');
        }
    ...
    public function setStateAbbreviationDescriptor($state_abbreviation_descriptor)
    {
        if ((mb_strlen($state_abbreviation_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $state_abbreviation_descriptor when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 306.');
        }
    ...
    public function setCity($city)
    {
        if ((mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($city) < 2)) {
            throw new \InvalidArgumentException('invalid length for $city when calling EdFiEducationOrganizationAddress., must be bigger than or equal to 2.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        if ((mb_strlen($postal_code) > 17)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 17.');
        }
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling EdFiEducationOrganizationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setStreetNumberName($street_number_name)
    {
        if ((mb_strlen($street_number_name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $street_number_name when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($street_number_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $street_number_name when calling EdFiEducationOrganizationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setLocaleDescriptor($locale_descriptor)
    {
        if (!is_null($locale_descriptor) && (mb_strlen($locale_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $locale_descriptor when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 306.');
        }
    ...
    public function setApartmentRoomSuiteNumber($apartment_room_suite_number)
    {
        if (!is_null($apartment_room_suite_number) && (mb_strlen($apartment_room_suite_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $apartment_room_suite_number when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 50.');
        }
        if (!is_null($apartment_room_suite_number) && (mb_strlen($apartment_room_suite_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $apartment_room_suite_number when calling EdFiEducationOrganizationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setBuildingSiteNumber($building_site_number)
    {
        if (!is_null($building_site_number) && (mb_strlen($building_site_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $building_site_number when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 20.');
        }
        if (!is_null($building_site_number) && (mb_strlen($building_site_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $building_site_number when calling EdFiEducationOrganizationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCongressionalDistrict($congressional_district)
    {
        if (!is_null($congressional_district) && (mb_strlen($congressional_district) > 30)) {
            throw new \InvalidArgumentException('invalid length for $congressional_district when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 30.');
        }
        if (!is_null($congressional_district) && (mb_strlen($congressional_district) < 1)) {
            throw new \InvalidArgumentException('invalid length for $congressional_district when calling EdFiEducationOrganizationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCountyFipsCode($county_fips_code)
    {
        if (!is_null($county_fips_code) && (mb_strlen($county_fips_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $county_fips_code when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 5.');
        }
        if (!is_null($county_fips_code) && (mb_strlen($county_fips_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $county_fips_code when calling EdFiEducationOrganizationAddress., must be bigger than or equal to 3.');
        }
    ...
    public function setLatitude($latitude)
    {
        if (!is_null($latitude) && (mb_strlen($latitude) > 20)) {
            throw new \InvalidArgumentException('invalid length for $latitude when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 20.');
        }
        if (!is_null($latitude) && (mb_strlen($latitude) < 1)) {
            throw new \InvalidArgumentException('invalid length for $latitude when calling EdFiEducationOrganizationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setLongitude($longitude)
    {
        if (!is_null($longitude) && (mb_strlen($longitude) > 20)) {
            throw new \InvalidArgumentException('invalid length for $longitude when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 20.');
        }
        if (!is_null($longitude) && (mb_strlen($longitude) < 1)) {
            throw new \InvalidArgumentException('invalid length for $longitude when calling EdFiEducationOrganizationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setNameOfCounty($name_of_county)
    {
        if (!is_null($name_of_county) && (mb_strlen($name_of_county) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name_of_county when calling EdFiEducationOrganizationAddress., must be smaller than or equal to 30.');
        }
        if (!is_null($name_of_county) && (mb_strlen($name_of_county) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name_of_county when calling EdFiEducationOrganizationAddress., must be bigger than or equal to 1.');
        }
     ...
     * Gets periods
     *
     * @return \OpenAPI\Client\Model\EdFiEducationOrganizationAddressPeriod[]|null
     */
     ...
     * Sets periods
     *
     * @param \OpenAPI\Client\Model\EdFiEducationOrganizationAddressPeriod[]|null $periods An unordered collection of educationOrganizationAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.
     *
     * @return self
     */
