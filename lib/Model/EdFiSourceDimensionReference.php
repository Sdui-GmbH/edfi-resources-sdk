...
/**
 * EdFiSourceDimensionReference Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiSourceDimensionReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_sourceDimensionReference';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 16)) {
            throw new \InvalidArgumentException('invalid length for $code when calling EdFiSourceDimensionReference., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling EdFiSourceDimensionReference., must be bigger than or equal to 1.');
        }
    ...
    public function setFiscalYear($fiscal_year)
    {
        ...
        if (($fiscal_year > 2040)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling EdFiSourceDimensionReference., must be smaller than or equal to 2040.');
        }
        if (($fiscal_year < 2020)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling EdFiSourceDimensionReference., must be bigger than or equal to 2020.');
        }
