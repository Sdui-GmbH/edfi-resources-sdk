 ...
 */
class TpdmSurveyResponseExtension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_surveyResponseExtension';
