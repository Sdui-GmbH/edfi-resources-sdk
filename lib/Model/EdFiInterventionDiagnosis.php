...
/**
 * EdFiInterventionDiagnosis Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiInterventionDiagnosis implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_interventionDiagnosis';
    ...
    */
     ...
     *
     * @param string $diagnosis_descriptor Targeted purpose of the intervention.
     *
     * @return self
     */
    public function setDiagnosisDescriptor($diagnosis_descriptor)
    {
        ...
        if ((mb_strlen($diagnosis_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $diagnosis_descriptor when calling EdFiInterventionDiagnosis., must be smaller than or equal to 306.');
        }
