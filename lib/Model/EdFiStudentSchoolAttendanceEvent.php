    ...
    */
    ...
    public function setAttendanceEventReason($attendance_event_reason)
    {
        ...
        if (!is_null($attendance_event_reason) && (mb_strlen($attendance_event_reason) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attendance_event_reason when calling EdFiStudentSchoolAttendanceEvent., must be bigger than or equal to 1.');
        }
