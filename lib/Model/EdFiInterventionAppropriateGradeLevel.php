...
/**
 * EdFiInterventionAppropriateGradeLevel Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiInterventionAppropriateGradeLevel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_interventionAppropriateGradeLevel';
    ...
    */
     ...
     *
     * @param string $grade_level_descriptor Grade levels for the intervention. If omitted, considered generally applicable.
     *
     * @return self
     */
    public function setGradeLevelDescriptor($grade_level_descriptor)
    {
        ...
        if ((mb_strlen($grade_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grade_level_descriptor when calling EdFiInterventionAppropriateGradeLevel., must be smaller than or equal to 306.');
        }
