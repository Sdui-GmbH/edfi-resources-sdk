 ...
 */
class TpdmPerformanceEvaluation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_performanceEvaluation';
    ...
    protected static $openAPIFormats = [
        ...
        'grade_levels' => null,
        'performance_evaluation_description' => null,
        'rating_levels' => null,
        '_etag' => null,
    ...
    protected static $setters = [
        ...
        'performance_evaluation_description' => 'setPerformanceEvaluationDescription',
    ...
    protected static $getters = [
        ...
        'performance_evaluation_description' => 'getPerformanceEvaluationDescription',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['performance_evaluation_description'] = $data['performance_evaluation_description'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['performance_evaluation_description']) && (mb_strlen($this->container['performance_evaluation_description']) > 255)) {
            $invalidProperties[] = "invalid value for 'performance_evaluation_description', the character length must be smaller than or equal to 255.";
        }
    ...
    public function setEvaluationPeriodDescriptor($evaluation_period_descriptor)
    {
        if ((mb_strlen($evaluation_period_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_period_descriptor when calling TpdmPerformanceEvaluation., must be smaller than or equal to 306.');
        }
    ...
    public function setPerformanceEvaluationTitle($performance_evaluation_title)
    {
        if ((mb_strlen($performance_evaluation_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_title when calling TpdmPerformanceEvaluation., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($performance_evaluation_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_title when calling TpdmPerformanceEvaluation., must be bigger than or equal to 1.');
        }
    ...
    public function setPerformanceEvaluationTypeDescriptor($performance_evaluation_type_descriptor)
    {
        if ((mb_strlen($performance_evaluation_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_type_descriptor when calling TpdmPerformanceEvaluation., must be smaller than or equal to 306.');
        }
    ...
    public function setTermDescriptor($term_descriptor)
    {
        if ((mb_strlen($term_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $term_descriptor when calling TpdmPerformanceEvaluation., must be smaller than or equal to 306.');
        }
     ...
     *
     * @param string|null $academic_subject_descriptor The description of the content or subject area of a performance evaluation.
     *
     * @return self
     */
    public function setAcademicSubjectDescriptor($academic_subject_descriptor)
    {
        if (!is_null($academic_subject_descriptor) && (mb_strlen($academic_subject_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $academic_subject_descriptor when calling TpdmPerformanceEvaluation., must be smaller than or equal to 306.');
        }
    ...
    /**
     * Gets performance_evaluation_description
     *
     * @return string|null
     */
    public function getPerformanceEvaluationDescription()
    {
        return $this->container['performance_evaluation_description'];
    }

    /**
     * Sets performance_evaluation_description
     *
     * @param string|null $performance_evaluation_description The long description of the Performance Evaluation.
     *
     * @return self
     */
    public function setPerformanceEvaluationDescription($performance_evaluation_description)
    {
        if (!is_null($performance_evaluation_description) && (mb_strlen($performance_evaluation_description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_description when calling TpdmPerformanceEvaluation., must be smaller than or equal to 255.');
        }

        $this->container['performance_evaluation_description'] = $performance_evaluation_description;
