...
class TpdmPerformanceEvaluation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'grade_levels' => false,
        'performance_evaluation_description' => true,
        'rating_levels' => false,
        '_etag' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('performance_evaluation_description', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($performance_evaluation_description)) {
            array_push($this->openAPINullablesSetToNull, 'performance_evaluation_description');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('performance_evaluation_description', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
