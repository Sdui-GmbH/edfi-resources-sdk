...
/**
 * EdFiInterventionStudyAppropriateGradeLevel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiInterventionStudyAppropriateGradeLevel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_interventionStudyAppropriateGradeLevel';
    ...
    */
     ...
     *
     * @param string $grade_level_descriptor Grade levels participating in this study.
     *
     * @return self
     */
    public function setGradeLevelDescriptor($grade_level_descriptor)
    {
        ...
        if ((mb_strlen($grade_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grade_level_descriptor when calling EdFiInterventionStudyAppropriateGradeLevel., must be smaller than or equal to 306.');
        }
