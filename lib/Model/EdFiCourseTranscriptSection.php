 ...
 */
class EdFiCourseTranscriptSection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_courseTranscriptSection';
