...
/**
 * TrackedChangesEdFiStudentCompetencyObjectiveKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStudentCompetencyObjectiveKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_studentCompetencyObjectiveKey';
    ...
    */
     ...
     *
     * @param int|null $objective_education_organization_id The identifier assigned to an education organization.
     *
     * @return self
     */
    ...
    public function setObjectiveGradeLevelDescriptor($objective_grade_level_descriptor)
    {
        ...
        if ((mb_strlen($objective_grade_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $objective_grade_level_descriptor when calling TrackedChangesEdFiStudentCompetencyObjectiveKey., must be smaller than or equal to 306.');
        }
    ...
    public function setGradingPeriodDescriptor($grading_period_descriptor)
    {
        ...
        if ((mb_strlen($grading_period_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grading_period_descriptor when calling TrackedChangesEdFiStudentCompetencyObjectiveKey., must be smaller than or equal to 306.');
        }
