...
/**
 * EdFiInterventionStudyStateAbbreviation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiInterventionStudyStateAbbreviation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_interventionStudyStateAbbreviation';
     ...
     *
     * @param string $state_abbreviation_descriptor The abbreviation for the state (within the United States) or outlying area, the school system of which the participants of the study are considered to be a part.
     *
     * @return self
     */
    public function setStateAbbreviationDescriptor($state_abbreviation_descriptor)
    {
        if ((mb_strlen($state_abbreviation_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $state_abbreviation_descriptor when calling EdFiInterventionStudyStateAbbreviation., must be smaller than or equal to 306.');
        }
