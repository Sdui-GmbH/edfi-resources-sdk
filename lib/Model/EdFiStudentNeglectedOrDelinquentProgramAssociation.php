...
class EdFiStudentNeglectedOrDelinquentProgramAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ela_progress_level_descriptor'] = $data['ela_progress_level_descriptor'] ?? null;
        $this->container['end_date'] = $data['end_date'] ?? null;
        $this->container['mathematics_progress_level_descriptor'] = $data['mathematics_progress_level_descriptor'] ?? null;
        $this->container['neglected_or_delinquent_program_descriptor'] = $data['neglected_or_delinquent_program_descriptor'] ?? null;
        $this->container['neglected_or_delinquent_program_services'] = $data['neglected_or_delinquent_program_services'] ?? null;
