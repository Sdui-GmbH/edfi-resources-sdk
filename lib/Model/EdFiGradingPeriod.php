...
/**
 * EdFiGradingPeriod Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiGradingPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_gradingPeriod';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('period_sequence', $data ?? [], null);
    ...
    */
    ...
    public function setGradingPeriodDescriptor($grading_period_descriptor)
    {
        ...
        if ((mb_strlen($grading_period_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grading_period_descriptor when calling EdFiGradingPeriod., must be smaller than or equal to 306.');
        }
    ...
    {
        return $this->container['period_sequence'];
    }

    /**
     * Sets period_sequence
     *
     * @param int|null $period_sequence The sequential order of this period relative to other periods.
     *
     * @return self
     */
    public function setPeriodSequence($period_sequence)
    {
        if (is_null($period_sequence)) {
            array_push($this->openAPINullablesSetToNull, 'period_sequence');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('period_sequence', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['period_sequence'] = $period_sequence;
    ...
    public function setTotalInstructionalDays($total_instructional_days)
    {
        ...
        if (($total_instructional_days < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_instructional_days when calling EdFiGradingPeriod., must be bigger than or equal to 0.');
        }
