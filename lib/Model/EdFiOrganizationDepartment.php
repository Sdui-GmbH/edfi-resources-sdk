...
/**
 * EdFiOrganizationDepartment Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiOrganizationDepartment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_organizationDepartment';
    ...
    protected static $openAPITypes = [
        ...
        'parent_education_organization_reference' => '\OpenAPI\Client\Model\EdFiEducationOrganizationReference',
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'categories' => null,
        'organization_department_id' => 'int64',
        'parent_education_organization_reference' => null,
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'categories' => false,
        'organization_department_id' => false,
        'parent_education_organization_reference' => false,
    ...
    protected static $attributeMap = [
        ...
        'parent_education_organization_reference' => 'parentEducationOrganizationReference',
    ...
    protected static $setters = [
        ...
        'parent_education_organization_reference' => 'setParentEducationOrganizationReference',
    ...
    protected static $getters = [
        ...
        'parent_education_organization_reference' => 'getParentEducationOrganizationReference',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('parent_education_organization_reference', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['organization_department_id'] === null) {
            $invalidProperties[] = "'organization_department_id' can't be null";
        }
    ...
    public function setOrganizationDepartmentId($organization_department_id)
    {
        if (is_null($organization_department_id)) {
            throw new \InvalidArgumentException('non-nullable organization_department_id cannot be null');
        }
    ...
    /**
     * Gets parent_education_organization_reference
     *
     * @return \OpenAPI\Client\Model\EdFiEducationOrganizationReference|null
     */
    public function getParentEducationOrganizationReference()
    {
        return $this->container['parent_education_organization_reference'];
    }

    /**
     * Sets parent_education_organization_reference
     *
     * @param \OpenAPI\Client\Model\EdFiEducationOrganizationReference|null $parent_education_organization_reference parent_education_organization_reference
     *
     * @return self
     */
    public function setParentEducationOrganizationReference($parent_education_organization_reference)
    {
        if (is_null($parent_education_organization_reference)) {
            throw new \InvalidArgumentException('non-nullable parent_education_organization_reference cannot be null');
        }
        $this->container['parent_education_organization_reference'] = $parent_education_organization_reference;
     ...
     *
     * @param string|null $academic_subject_descriptor The intended major subject area of the department.
     *
     * @return self
     */
    public function setAcademicSubjectDescriptor($academic_subject_descriptor)
    {
        ...
        if (!is_null($academic_subject_descriptor) && (mb_strlen($academic_subject_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $academic_subject_descriptor when calling EdFiOrganizationDepartment., must be smaller than or equal to 306.');
        }
    ...
    public function setOperationalStatusDescriptor($operational_status_descriptor)
    {
        ...
        if (!is_null($operational_status_descriptor) && (mb_strlen($operational_status_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $operational_status_descriptor when calling EdFiOrganizationDepartment., must be smaller than or equal to 306.');
        }
    ...
    public function setWebSite($web_site)
    {
        ...
        if (!is_null($web_site) && (mb_strlen($web_site) > 255)) {
            throw new \InvalidArgumentException('invalid length for $web_site when calling EdFiOrganizationDepartment., must be smaller than or equal to 255.');
        }
        if (!is_null($web_site) && (mb_strlen($web_site) < 5)) {
            throw new \InvalidArgumentException('invalid length for $web_site when calling EdFiOrganizationDepartment., must be bigger than or equal to 5.');
        }
