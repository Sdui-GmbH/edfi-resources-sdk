...
class EdFiStudentSectionAttendanceEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'event_duration' => true,
        'section_attendance_duration' => true,
        '_etag' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('section_attendance_duration', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($section_attendance_duration)) {
            array_push($this->openAPINullablesSetToNull, 'section_attendance_duration');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('section_attendance_duration', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
