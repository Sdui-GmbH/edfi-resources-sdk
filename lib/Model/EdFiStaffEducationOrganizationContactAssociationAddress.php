 ...
 */
class EdFiStaffEducationOrganizationContactAssociationAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_staffEducationOrganizationContactAssociationAddress';
    ...
    public function setAddressTypeDescriptor($address_type_descriptor)
    {
        if ((mb_strlen($address_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $address_type_descriptor when calling EdFiStaffEducationOrganizationContactAssociationAddress., must be smaller than or equal to 306.');
        }
    ...
    public function setLocaleDescriptor($locale_descriptor)
    {
        if (!is_null($locale_descriptor) && (mb_strlen($locale_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $locale_descriptor when calling EdFiStaffEducationOrganizationContactAssociationAddress., must be smaller than or equal to 306.');
        }
    ...
    public function setStateAbbreviationDescriptor($state_abbreviation_descriptor)
    {
        if ((mb_strlen($state_abbreviation_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $state_abbreviation_descriptor when calling EdFiStaffEducationOrganizationContactAssociationAddress., must be smaller than or equal to 306.');
        }
    ...
    public function setCity($city)
    {
        if ((mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling EdFiStaffEducationOrganizationContactAssociationAddress., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($city) < 2)) {
            throw new \InvalidArgumentException('invalid length for $city when calling EdFiStaffEducationOrganizationContactAssociationAddress., must be bigger than or equal to 2.');
        }
    ...
    public function setCountyFipsCode($county_fips_code)
    {
        if (!is_null($county_fips_code) && (mb_strlen($county_fips_code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $county_fips_code when calling EdFiStaffEducationOrganizationContactAssociationAddress., must be smaller than or equal to 5.');
        }
        if (!is_null($county_fips_code) && (mb_strlen($county_fips_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $county_fips_code when calling EdFiStaffEducationOrganizationContactAssociationAddress., must be bigger than or equal to 3.');
        }
