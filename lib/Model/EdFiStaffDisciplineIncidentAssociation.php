 ...
 */
class EdFiStaffDisciplineIncidentAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_staffDisciplineIncidentAssociation';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['discipline_incident_participation_codes'] === null) {
            $invalidProperties[] = "'discipline_incident_participation_codes' can't be null";
        }
