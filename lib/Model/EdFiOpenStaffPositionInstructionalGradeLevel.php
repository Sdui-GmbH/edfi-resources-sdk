...
/**
 * EdFiOpenStaffPositionInstructionalGradeLevel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiOpenStaffPositionInstructionalGradeLevel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_openStaffPositionInstructionalGradeLevel';
    ...
    */
     ...
     *
     * @param string $grade_level_descriptor The set of grade levels for which the position's assignment is responsible.
     *
     * @return self
     */
    public function setGradeLevelDescriptor($grade_level_descriptor)
    {
        ...
        if ((mb_strlen($grade_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grade_level_descriptor when calling EdFiOpenStaffPositionInstructionalGradeLevel., must be smaller than or equal to 306.');
        }
