...
/**
 * EdFiEducationContentAppropriateSex Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiEducationContentAppropriateSex implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_educationContentAppropriateSex';
     ...
     * Sets sex_descriptor
     *
     * @param string $sex_descriptor Sexes for which this education content is applicable. If omitted, considered generally applicable.
     *
     * @return self
     */
    public function setSexDescriptor($sex_descriptor)
    {
        if ((mb_strlen($sex_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $sex_descriptor when calling EdFiEducationContentAppropriateSex., must be smaller than or equal to 306.');
        }
