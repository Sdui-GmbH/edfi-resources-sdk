...
class EdFiFeederSchoolAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'begin_date' => false,
        'feeder_school_reference' => false,
        'school_reference' => false,
        'end_date' => true,
        'feeder_relationship_description' => true,
        '_etag' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('feeder_school_reference', $data ?? [], null);
        $this->setIfExists('school_reference', $data ?? [], null);
        $this->setIfExists('end_date', $data ?? [], null);
        $this->setIfExists('feeder_relationship_description', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($feeder_school_reference)) {
            throw new \InvalidArgumentException('non-nullable feeder_school_reference cannot be null');
        }
    ...
    {
        if (is_null($feeder_relationship_description)) {
            array_push($this->openAPINullablesSetToNull, 'feeder_relationship_description');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('feeder_relationship_description', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
