...
/**
 * EdFiStudentEducationOrganizationAssessmentAccommodationReference Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStudentEducationOrganizationAssessmentAccommodationReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentEducationOrganizationAssessmentAccommodationReference';
    ...
    */
    ...
    public function setStudentUniqueId($student_unique_id)
    {
        ...
        if ((mb_strlen($student_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling EdFiStudentEducationOrganizationAssessmentAccommodationReference., must be smaller than or equal to 32.');
        }
