...
/**
 * EdFiStudentDisciplineIncidentBehaviorAssociationReference Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStudentDisciplineIncidentBehaviorAssociationReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentDisciplineIncidentBehaviorAssociationReference';
    ...
    */
    ...
    public function setBehaviorDescriptor($behavior_descriptor)
    {
        ...
        if ((mb_strlen($behavior_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $behavior_descriptor when calling EdFiStudentDisciplineIncidentBehaviorAssociationReference., must be smaller than or equal to 306.');
        }
