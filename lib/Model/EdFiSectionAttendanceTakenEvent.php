 ...
 */
class EdFiSectionAttendanceTakenEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_sectionAttendanceTakenEvent';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('calendar_date_reference', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['calendar_date_reference'] === null) {
            $invalidProperties[] = "'calendar_date_reference' can't be null";
        }
    ...
    {
        return $this->container['calendar_date_reference'];
    }
    ...
    {
        if (is_null($calendar_date_reference)) {
            throw new \InvalidArgumentException('non-nullable calendar_date_reference cannot be null');
        }
        $this->container['calendar_date_reference'] = $calendar_date_reference;
     ...
     * Sets event_date
     *
     * @param \DateTime $event_date The date the section attendance taken event was submitted, which could be a different date than the instructional day.
     *
     * @return self
     */
