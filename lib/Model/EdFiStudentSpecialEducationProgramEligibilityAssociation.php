...
class EdFiStudentSpecialEducationProgramEligibilityAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['consent_to_evaluation_date'] = $data['consent_to_evaluation_date'] ?? null;
        $this->container['eligibility_conference_date'] = $data['eligibility_conference_date'] ?? null;
        $this->container['eligibility_delay_reason_descriptor'] = $data['eligibility_delay_reason_descriptor'] ?? null;
        $this->container['eligibility_determination_date'] = $data['eligibility_determination_date'] ?? null;
        $this->container['eligibility_evaluation_date'] = $data['eligibility_evaluation_date'] ?? null;
        $this->container['eligibility_evaluation_type_descriptor'] = $data['eligibility_evaluation_type_descriptor'] ?? null;
        $this->container['evaluation_complete_indicator'] = $data['evaluation_complete_indicator'] ?? null;
        $this->container['evaluation_delay_days'] = $data['evaluation_delay_days'] ?? null;
        $this->container['evaluation_delay_reason_descriptor'] = $data['evaluation_delay_reason_descriptor'] ?? null;
        $this->container['evaluation_late_reason'] = $data['evaluation_late_reason'] ?? null;
        $this->container['idea_indicator'] = $data['idea_indicator'] ?? null;
        $this->container['idea_part_descriptor'] = $data['idea_part_descriptor'] ?? null;
        $this->container['original_eci_services_date'] = $data['original_eci_services_date'] ?? null;
        $this->container['transition_conference_date'] = $data['transition_conference_date'] ?? null;
        $this->container['transition_notification_date'] = $data['transition_notification_date'] ?? null;
