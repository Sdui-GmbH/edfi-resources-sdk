...
/**
 * TrackedChangesEdFiCrisisEventKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiCrisisEventKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_crisisEventKey';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['crisis_event_name']) && (mb_strlen($this->container['crisis_event_name']) > 100)) {
     ...
     *
     * @param string|null $crisis_event_name The name of the crisis event that occurred. If there is no generally accepted name for this crisis event, the suggested format: Location + Crisis type + Year.
     *
     * @return self
     */
    public function setCrisisEventName($crisis_event_name)
    {
        ...
        if ((mb_strlen($crisis_event_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $crisis_event_name when calling TrackedChangesEdFiCrisisEventKey., must be smaller than or equal to 100.');
        }
