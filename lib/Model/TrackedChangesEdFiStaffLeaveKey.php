...
/**
 * TrackedChangesEdFiStaffLeaveKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStaffLeaveKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_staffLeaveKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['staff_leave_event_category_descriptor']) && (mb_strlen($this->container['staff_leave_event_category_descriptor']) > 306)) {
     ...
     *
     * @param string|null $staff_leave_event_category_descriptor The code describing the type of leave taken.
     *
     * @return self
     */
    public function setStaffLeaveEventCategoryDescriptor($staff_leave_event_category_descriptor)
    {
        if (!is_null($staff_leave_event_category_descriptor) && (mb_strlen($staff_leave_event_category_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $staff_leave_event_category_descriptor when calling TrackedChangesEdFiStaffLeaveKey., must be smaller than or equal to 306.');
        }
     ...
     * Sets begin_date
     *
     * @param \DateTime|null $begin_date The begin date of the staff leave.
     *
     * @return self
     */
    ...
    public function setStaffUniqueId($staff_unique_id)
    {
        if (!is_null($staff_unique_id) && (mb_strlen($staff_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $staff_unique_id when calling TrackedChangesEdFiStaffLeaveKey., must be smaller than or equal to 32.');
        }
        if (!is_null($staff_unique_id) && (mb_strlen($staff_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $staff_unique_id when calling TrackedChangesEdFiStaffLeaveKey., must be bigger than or equal to 1.');
        }
