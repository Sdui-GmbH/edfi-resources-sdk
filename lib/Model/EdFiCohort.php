...
class EdFiCohort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'cohort_identifier' => false,
        'education_organization_reference' => false,
        'academic_subject_descriptor' => true,
        'cohort_description' => true,
        'cohort_scope_descriptor' => true,
        'cohort_type_descriptor' => false,
        'programs' => false,
        '_etag' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cohort_identifier', $data ?? [], null);
        $this->setIfExists('education_organization_reference', $data ?? [], null);
        $this->setIfExists('academic_subject_descriptor', $data ?? [], null);
        $this->setIfExists('cohort_description', $data ?? [], null);
        $this->setIfExists('cohort_scope_descriptor', $data ?? [], null);
        $this->setIfExists('cohort_type_descriptor', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($cohort_identifier)) {
            throw new \InvalidArgumentException('non-nullable cohort_identifier cannot be null');
        }
    ...
    {
        if (is_null($cohort_description)) {
            array_push($this->openAPINullablesSetToNull, 'cohort_description');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cohort_description', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($cohort_scope_descriptor)) {
            array_push($this->openAPINullablesSetToNull, 'cohort_scope_descriptor');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cohort_scope_descriptor', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($cohort_type_descriptor)) {
            throw new \InvalidArgumentException('non-nullable cohort_type_descriptor cannot be null');
        }
