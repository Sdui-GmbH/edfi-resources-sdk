...
/**
 * TrackedChangesEdFiChartOfAccountKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiChartOfAccountKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_chartOfAccountKey';
    ...
    */
     ...
     *
     * @param string|null $account_identifier SEA populated code value for the valid combination of account dimensions under which financials are reported.
     *
     * @return self
     */
    public function setAccountIdentifier($account_identifier)
    {
        ...
        if ((mb_strlen($account_identifier) > 50)) {
            throw new \InvalidArgumentException('invalid length for $account_identifier when calling TrackedChangesEdFiChartOfAccountKey., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($account_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_identifier when calling TrackedChangesEdFiChartOfAccountKey., must be bigger than or equal to 1.');
        }
    ...
    public function setFiscalYear($fiscal_year)
    {
        ...
        if (($fiscal_year > 2040)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling TrackedChangesEdFiChartOfAccountKey., must be smaller than or equal to 2040.');
        }
        if (($fiscal_year < 2020)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling TrackedChangesEdFiChartOfAccountKey., must be bigger than or equal to 2020.');
        }
