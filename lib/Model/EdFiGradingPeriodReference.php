...
/**
 * EdFiGradingPeriodReference Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiGradingPeriodReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_gradingPeriodReference';
    ...
    public function setGradingPeriodDescriptor($grading_period_descriptor)
    {
        if ((mb_strlen($grading_period_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grading_period_descriptor when calling EdFiGradingPeriodReference., must be smaller than or equal to 306.');
        }
