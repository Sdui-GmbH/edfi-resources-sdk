...
class EdFiGradeReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setGradingPeriodName($grading_period_name)
    {
        ...
        if ((mb_strlen($grading_period_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $grading_period_name when calling EdFiGradeReference., must be bigger than or equal to 1.');
        }
    ...
    public function setLocalCourseCode($local_course_code)
    {
        ...
        if ((mb_strlen($local_course_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $local_course_code when calling EdFiGradeReference., must be bigger than or equal to 1.');
        }
    ...
    public function setSectionIdentifier($section_identifier)
    {
        ...
        if ((mb_strlen($section_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $section_identifier when calling EdFiGradeReference., must be bigger than or equal to 1.');
        }
    ...
    public function setSessionName($session_name)
    {
        ...
        if ((mb_strlen($session_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $session_name when calling EdFiGradeReference., must be bigger than or equal to 1.');
        }
    ...
    public function setStudentUniqueId($student_unique_id)
    {
        ...
        if ((mb_strlen($student_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling EdFiGradeReference., must be bigger than or equal to 1.');
        }
