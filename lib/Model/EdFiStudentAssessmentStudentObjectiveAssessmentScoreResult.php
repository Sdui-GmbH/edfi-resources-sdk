...
/**
 * EdFiStudentAssessmentStudentObjectiveAssessmentScoreResult Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStudentAssessmentStudentObjectiveAssessmentScoreResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentAssessmentStudentObjectiveAssessmentScoreResult';
    ...
    */
    ...
    public function setAssessmentReportingMethodDescriptor($assessment_reporting_method_descriptor)
    {
        ...
        if ((mb_strlen($assessment_reporting_method_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $assessment_reporting_method_descriptor when calling EdFiStudentAssessmentStudentObjectiveAssessmentScoreResult., must be smaller than or equal to 306.');
        }
    ...
    public function setResultDatatypeTypeDescriptor($result_datatype_type_descriptor)
    {
        ...
        if ((mb_strlen($result_datatype_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $result_datatype_type_descriptor when calling EdFiStudentAssessmentStudentObjectiveAssessmentScoreResult., must be smaller than or equal to 306.');
        }
