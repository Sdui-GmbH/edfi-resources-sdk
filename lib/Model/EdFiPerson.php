 ...
 */
class EdFiPerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_person';
    ...
    public function setSourceSystemDescriptor($source_system_descriptor)
    {
        if ((mb_strlen($source_system_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $source_system_descriptor when calling EdFiPerson., must be smaller than or equal to 306.');
        }
