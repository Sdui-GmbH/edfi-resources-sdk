 ...
 */
class EdFiStudentTitleIPartAProgramAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentTitleIPartAProgramAssociation';
    ...
    protected static $openAPIFormats = [
        ...
        'title_i_part_a_participant_descriptor' => null,
        'title_i_part_a_program_services' => null,
        '_etag' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'title_i_part_a_participant_descriptor' => false,
        'title_i_part_a_program_services' => false,
        '_etag' => false,
    ...
    protected static $setters = [
        ...
        'title_i_part_a_participant_descriptor' => 'setTitleIPartAParticipantDescriptor',
        'title_i_part_a_program_services' => 'setTitleIPartAProgramServices',
        '_etag' => 'setEtag',
    ...
    protected static $getters = [
        ...
        'title_i_part_a_participant_descriptor' => 'getTitleIPartAParticipantDescriptor',
        'title_i_part_a_program_services' => 'getTitleIPartAProgramServices',
        '_etag' => 'getEtag',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('title_i_part_a_participant_descriptor', $data ?? [], null);
        $this->setIfExists('title_i_part_a_program_services', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['title_i_part_a_participant_descriptor'] === null) {
            $invalidProperties[] = "'title_i_part_a_participant_descriptor' can't be null";
        }
        if ((mb_strlen($this->container['title_i_part_a_participant_descriptor']) > 306)) {
            $invalidProperties[] = "invalid value for 'title_i_part_a_participant_descriptor', the character length must be smaller than or equal to 306.";
        }
    ...
    public function setReasonExitedDescriptor($reason_exited_descriptor)
    {
        ...
        if (!is_null($reason_exited_descriptor) && (mb_strlen($reason_exited_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $reason_exited_descriptor when calling EdFiStudentTitleIPartAProgramAssociation., must be smaller than or equal to 306.');
        }
    ...
    /**
     * Gets title_i_part_a_participant_descriptor
     *
     * @return string
     */
    public function getTitleIPartAParticipantDescriptor()
    {
        return $this->container['title_i_part_a_participant_descriptor'];
    }

    /**
     * Sets title_i_part_a_participant_descriptor
     *
     * @param string $title_i_part_a_participant_descriptor An indication of the type of Title I program, if any, in which the student is participating and by which the student is served.
     *
     * @return self
     */
    public function setTitleIPartAParticipantDescriptor($title_i_part_a_participant_descriptor)
    {
        if (is_null($title_i_part_a_participant_descriptor)) {
            throw new \InvalidArgumentException('non-nullable title_i_part_a_participant_descriptor cannot be null');
        }
        if ((mb_strlen($title_i_part_a_participant_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $title_i_part_a_participant_descriptor when calling EdFiStudentTitleIPartAProgramAssociation., must be smaller than or equal to 306.');
        }

        $this->container['title_i_part_a_participant_descriptor'] = $title_i_part_a_participant_descriptor;
    ...
    {
        return $this->container['title_i_part_a_program_services'];
    }
     ...
     * @return self
     */
    public function setTitleIPartAProgramServices($title_i_part_a_program_services)
    {
        if (is_null($title_i_part_a_program_services)) {
            throw new \InvalidArgumentException('non-nullable title_i_part_a_program_services cannot be null');
        }
        $this->container['title_i_part_a_program_services'] = $title_i_part_a_program_services;
