...
/**
 * TrackedChangesTpdmEvaluationKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesTpdmEvaluationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_tpdm_evaluationKey';
    ...
    public function setEvaluationTitle($evaluation_title)
    {
        if (!is_null($evaluation_title) && (mb_strlen($evaluation_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_title when calling TrackedChangesTpdmEvaluationKey., must be smaller than or equal to 50.');
        }
        if (!is_null($evaluation_title) && (mb_strlen($evaluation_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_title when calling TrackedChangesTpdmEvaluationKey., must be bigger than or equal to 1.');
        }
    ...
    public function setEvaluationPeriodDescriptor($evaluation_period_descriptor)
    {
        if (!is_null($evaluation_period_descriptor) && (mb_strlen($evaluation_period_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $evaluation_period_descriptor when calling TrackedChangesTpdmEvaluationKey., must be smaller than or equal to 306.');
        }
    ...
    public function setPerformanceEvaluationTitle($performance_evaluation_title)
    {
        if (!is_null($performance_evaluation_title) && (mb_strlen($performance_evaluation_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_title when calling TrackedChangesTpdmEvaluationKey., must be smaller than or equal to 50.');
        }
        if (!is_null($performance_evaluation_title) && (mb_strlen($performance_evaluation_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_title when calling TrackedChangesTpdmEvaluationKey., must be bigger than or equal to 1.');
        }
    ...
    public function setPerformanceEvaluationTypeDescriptor($performance_evaluation_type_descriptor)
    {
        if (!is_null($performance_evaluation_type_descriptor) && (mb_strlen($performance_evaluation_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $performance_evaluation_type_descriptor when calling TrackedChangesTpdmEvaluationKey., must be smaller than or equal to 306.');
        }
    ...
    public function setTermDescriptor($term_descriptor)
    {
        if (!is_null($term_descriptor) && (mb_strlen($term_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $term_descriptor when calling TrackedChangesTpdmEvaluationKey., must be smaller than or equal to 306.');
        }
