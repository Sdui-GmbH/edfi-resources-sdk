...
/**
 * TrackedChangesEdFiSurveyResponseKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiSurveyResponseKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_surveyResponseKey';
    ...
    */
    ...
    public function setSurveyResponseIdentifier($survey_response_identifier)
    {
        ...
        if ((mb_strlen($survey_response_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $survey_response_identifier when calling TrackedChangesEdFiSurveyResponseKey., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($survey_response_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $survey_response_identifier when calling TrackedChangesEdFiSurveyResponseKey., must be bigger than or equal to 1.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiSurveyResponseKey., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($namespace) < 5)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiSurveyResponseKey., must be bigger than or equal to 5.');
        }
    ...
    public function setSurveyIdentifier($survey_identifier)
    {
        ...
        if ((mb_strlen($survey_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $survey_identifier when calling TrackedChangesEdFiSurveyResponseKey., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($survey_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $survey_identifier when calling TrackedChangesEdFiSurveyResponseKey., must be bigger than or equal to 1.');
        }
