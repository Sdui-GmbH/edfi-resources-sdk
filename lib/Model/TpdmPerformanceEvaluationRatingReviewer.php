 ...
 */
class TpdmPerformanceEvaluationRatingReviewer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_performanceEvaluationRatingReviewer';
    ...
    protected static $openAPIFormats = [
        'first_name' => null,
        'last_surname' => null,
        'reviewer_person_reference' => null,
        'received_training' => null
    ];
    ...
    protected static array $openAPINullables = [
        'first_name' => false,
        'last_surname' => false,
        'reviewer_person_reference' => false,
    ...
    protected static $setters = [
        ...
        'reviewer_person_reference' => 'setReviewerPersonReference',
        'received_training' => 'setReceivedTraining'
    ];
    ...
    protected static $getters = [
        ...
        'reviewer_person_reference' => 'getReviewerPersonReference',
        'received_training' => 'getReceivedTraining'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('reviewer_person_reference', $data ?? [], null);
        $this->setIfExists('received_training', $data ?? [], null);
    }
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 75)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling TpdmPerformanceEvaluationRatingReviewer., must be smaller than or equal to 75.');
        }
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling TpdmPerformanceEvaluationRatingReviewer., must be bigger than or equal to 1.');
        }
    ...
    public function setLastSurname($last_surname)
    {
        ...
        if ((mb_strlen($last_surname) > 75)) {
            throw new \InvalidArgumentException('invalid length for $last_surname when calling TpdmPerformanceEvaluationRatingReviewer., must be smaller than or equal to 75.');
        }
        if ((mb_strlen($last_surname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_surname when calling TpdmPerformanceEvaluationRatingReviewer., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['reviewer_person_reference'];
    }
     ...
     * @return self
     */
    public function setReviewerPersonReference($reviewer_person_reference)
    {
        if (is_null($reviewer_person_reference)) {
            throw new \InvalidArgumentException('non-nullable reviewer_person_reference cannot be null');
        }
        $this->container['reviewer_person_reference'] = $reviewer_person_reference;
    ...
    {
        return $this->container['received_training'];
    }
     ...
     * @return self
     */
    public function setReceivedTraining($received_training)
    {
        if (is_null($received_training)) {
            throw new \InvalidArgumentException('non-nullable received_training cannot be null');
        }
        $this->container['received_training'] = $received_training;
