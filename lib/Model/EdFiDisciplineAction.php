...
class EdFiDisciplineAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['discipline_action_identifier'] = $data['discipline_action_identifier'] ?? null;
        $this->container['discipline_date'] = $data['discipline_date'] ?? null;
        $this->container['disciplines'] = $data['disciplines'] ?? null;
        $this->container['assignment_school_reference'] = $data['assignment_school_reference'] ?? null;
        $this->container['responsibility_school_reference'] = $data['responsibility_school_reference'] ?? null;
        $this->container['student_reference'] = $data['student_reference'] ?? null;
        $this->container['actual_discipline_action_length'] = $data['actual_discipline_action_length'] ?? null;
        $this->container['discipline_action_length'] = $data['discipline_action_length'] ?? null;
        $this->container['discipline_action_length_difference_reason_descriptor'] = $data['discipline_action_length_difference_reason_descriptor'] ?? null;
        $this->container['iep_placement_meeting_indicator'] = $data['iep_placement_meeting_indicator'] ?? null;
        $this->container['related_to_zero_tolerance_policy'] = $data['related_to_zero_tolerance_policy'] ?? null;
        $this->container['staffs'] = $data['staffs'] ?? null;
        $this->container['student_discipline_incident_behavior_associations'] = $data['student_discipline_incident_behavior_associations'] ?? null;
     ...
     *
     * @param double|null $actual_discipline_action_length Indicates the actual length in school days of a student's disciplinary assignment.
     *
     * @return self
     */
     ...
     *
     * @param double|null $discipline_action_length The length of time in school days for the discipline action (e.g. removal, detention), if applicable.
     *
     * @return self
     */
