...
/**
 * EdFiCredentialGradeLevel Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiCredentialGradeLevel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_credentialGradeLevel';
    ...
    */
     ...
     *
     * @param string $grade_level_descriptor The grade level(s) certified for teaching.
     *
     * @return self
     */
    public function setGradeLevelDescriptor($grade_level_descriptor)
    {
        ...
        if ((mb_strlen($grade_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grade_level_descriptor when calling EdFiCredentialGradeLevel., must be smaller than or equal to 306.');
        }
