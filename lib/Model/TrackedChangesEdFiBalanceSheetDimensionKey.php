...
/**
 * TrackedChangesEdFiBalanceSheetDimensionKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiBalanceSheetDimensionKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_balanceSheetDimensionKey';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code The code representation of the account balance sheet dimension.
     *
     * @return self
     */
     ...
     * Sets fiscal_year
     *
     * @param int|null $fiscal_year The fiscal year for which the account balance sheet dimension is valid.
     *
     * @return self
     */
    public function setFiscalYear($fiscal_year)
    {
        ...
        if (($fiscal_year > 2040)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling TrackedChangesEdFiBalanceSheetDimensionKey., must be smaller than or equal to 2040.');
        }
        if (($fiscal_year < 2020)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling TrackedChangesEdFiBalanceSheetDimensionKey., must be bigger than or equal to 2020.');
        }
