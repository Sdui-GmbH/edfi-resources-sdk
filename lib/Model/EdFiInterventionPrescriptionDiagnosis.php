...
/**
 * EdFiInterventionPrescriptionDiagnosis Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiInterventionPrescriptionDiagnosis implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_interventionPrescriptionDiagnosis';
    ...
    */
     ...
     *
     * @param string $diagnosis_descriptor Targeted purpose of the intervention prescription.
     *
     * @return self
     */
    public function setDiagnosisDescriptor($diagnosis_descriptor)
    {
        ...
        if ((mb_strlen($diagnosis_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $diagnosis_descriptor when calling EdFiInterventionPrescriptionDiagnosis., must be smaller than or equal to 306.');
        }
