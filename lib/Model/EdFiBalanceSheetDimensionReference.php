...
/**
 * EdFiBalanceSheetDimensionReference Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiBalanceSheetDimensionReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_balanceSheetDimensionReference';
    ...
    */
    ...
    public function setFiscalYear($fiscal_year)
    {
        ...
        if (($fiscal_year > 2040)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling EdFiBalanceSheetDimensionReference., must be smaller than or equal to 2040.');
        }
        if (($fiscal_year < 2020)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling EdFiBalanceSheetDimensionReference., must be bigger than or equal to 2020.');
        }
