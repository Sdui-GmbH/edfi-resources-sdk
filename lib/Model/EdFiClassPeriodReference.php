...
/**
 * EdFiClassPeriodReference Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiClassPeriodReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_classPeriodReference';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['class_period_name'] === null) {
            $invalidProperties[] = "'class_period_name' can't be null";
        }
        if ((mb_strlen($this->container['class_period_name']) > 60)) {
    ...
    public function setClassPeriodName($class_period_name)
    {
        ...
        if ((mb_strlen($class_period_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $class_period_name when calling EdFiClassPeriodReference., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($class_period_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $class_period_name when calling EdFiClassPeriodReference., must be bigger than or equal to 1.');
        }
