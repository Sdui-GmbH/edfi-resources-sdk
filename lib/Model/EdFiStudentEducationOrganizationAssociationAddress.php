...
class EdFiStudentEducationOrganizationAssociationAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'periods' => '\OpenAPI\Client\Model\EdFiStudentEducationOrganizationAssociationAddressPeriod[]'
    ];
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling EdFiStudentEducationOrganizationAssociationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setStreetNumberName($street_number_name)
    {
        ...
        if ((mb_strlen($street_number_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $street_number_name when calling EdFiStudentEducationOrganizationAssociationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setApartmentRoomSuiteNumber($apartment_room_suite_number)
    {
        ...
        if (!is_null($apartment_room_suite_number) && (mb_strlen($apartment_room_suite_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $apartment_room_suite_number when calling EdFiStudentEducationOrganizationAssociationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setBuildingSiteNumber($building_site_number)
    {
        ...
        if (!is_null($building_site_number) && (mb_strlen($building_site_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $building_site_number when calling EdFiStudentEducationOrganizationAssociationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCongressionalDistrict($congressional_district)
    {
        ...
        if (!is_null($congressional_district) && (mb_strlen($congressional_district) < 1)) {
            throw new \InvalidArgumentException('invalid length for $congressional_district when calling EdFiStudentEducationOrganizationAssociationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setLatitude($latitude)
    {
        ...
        if (!is_null($latitude) && (mb_strlen($latitude) < 1)) {
            throw new \InvalidArgumentException('invalid length for $latitude when calling EdFiStudentEducationOrganizationAssociationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setLongitude($longitude)
    {
        ...
        if (!is_null($longitude) && (mb_strlen($longitude) < 1)) {
            throw new \InvalidArgumentException('invalid length for $longitude when calling EdFiStudentEducationOrganizationAssociationAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setNameOfCounty($name_of_county)
    {
        ...
        if (!is_null($name_of_county) && (mb_strlen($name_of_county) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name_of_county when calling EdFiStudentEducationOrganizationAssociationAddress., must be bigger than or equal to 1.');
        }
     ...
     * Gets periods
     *
     * @return \OpenAPI\Client\Model\EdFiStudentEducationOrganizationAssociationAddressPeriod[]|null
     */
     ...
     * Sets periods
     *
     * @param \OpenAPI\Client\Model\EdFiStudentEducationOrganizationAssociationAddressPeriod[]|null $periods An unordered collection of studentEducationOrganizationAssociationAddressPeriods. The time periods for which the address is valid. For physical addresses, the periods in which the person lived at that address.
     *
     * @return self
     */
