...
/**
 * TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_staffEducationOrganizationEmploymentAssociationKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['employment_status_descriptor']) && (mb_strlen($this->container['employment_status_descriptor']) > 306)) {
     ...
     *
     * @param string|null $employment_status_descriptor Reflects the type of employment or contract.
     *
     * @return self
     */
    public function setEmploymentStatusDescriptor($employment_status_descriptor)
    {
        if (!is_null($employment_status_descriptor) && (mb_strlen($employment_status_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $employment_status_descriptor when calling TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey., must be smaller than or equal to 306.');
        }
    ...
    public function setStaffUniqueId($staff_unique_id)
    {
        if (!is_null($staff_unique_id) && (mb_strlen($staff_unique_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $staff_unique_id when calling TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey., must be smaller than or equal to 32.');
        }
        if (!is_null($staff_unique_id) && (mb_strlen($staff_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $staff_unique_id when calling TrackedChangesEdFiStaffEducationOrganizationEmploymentAssociationKey., must be bigger than or equal to 1.');
        }
