...
class TpdmPerformanceEvaluationRating implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['actual_date'] = $data['actual_date'] ?? null;
        $this->container['actual_duration'] = $data['actual_duration'] ?? null;
        $this->container['actual_time'] = $data['actual_time'] ?? null;
        $this->container['announced'] = $data['announced'] ?? null;
        $this->container['comments'] = $data['comments'] ?? null;
        $this->container['coteaching_style_observed_descriptor'] = $data['coteaching_style_observed_descriptor'] ?? null;
        $this->container['performance_evaluation_rating_level_descriptor'] = $data['performance_evaluation_rating_level_descriptor'] ?? null;
        $this->container['results'] = $data['results'] ?? null;
        $this->container['reviewers'] = $data['reviewers'] ?? null;
        $this->container['schedule_date'] = $data['schedule_date'] ?? null;
