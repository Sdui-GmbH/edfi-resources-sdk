...
/**
 * EdFiBalanceSheetDimension Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiBalanceSheetDimension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_balanceSheetDimension';
    ...
    protected static $openAPITypes = [
        ...
        'fiscal_year' => 'int',
        'code_name' => 'string',
        'reporting_tags' => '\OpenAPI\Client\Model\EdFiBalanceSheetDimensionReportingTag[]',
        '_etag' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('code_name', $data ?? [], null);
    ...
    */
     ...
     * Sets code
     *
     * @param string $code The code representation of the account balance sheet dimension.
     *
     * @return self
     */
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 16)) {
            throw new \InvalidArgumentException('invalid length for $code when calling EdFiBalanceSheetDimension., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling EdFiBalanceSheetDimension., must be bigger than or equal to 1.');
        }
     ...
     * Sets fiscal_year
     *
     * @param int $fiscal_year The fiscal year for which the account balance sheet dimension is valid.
     *
     * @return self
     */
    public function setFiscalYear($fiscal_year)
    {
        ...
        if (($fiscal_year > 2040)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling EdFiBalanceSheetDimension., must be smaller than or equal to 2040.');
        }
        if (($fiscal_year < 2020)) {
            throw new \InvalidArgumentException('invalid value for $fiscal_year when calling EdFiBalanceSheetDimension., must be bigger than or equal to 2020.');
        }
     ...
     * Sets code_name
     *
     * @param string|null $code_name A description of the account balance sheet dimension.
     *
     * @return self
     */
    public function setCodeName($code_name)
    {
        if (is_null($code_name)) {
            array_push($this->openAPINullablesSetToNull, 'code_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('code_name', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        if (!is_null($code_name) && (mb_strlen($code_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $code_name when calling EdFiBalanceSheetDimension., must be smaller than or equal to 100.');
        }
        if (!is_null($code_name) && (mb_strlen($code_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code_name when calling EdFiBalanceSheetDimension., must be bigger than or equal to 1.');
        }
     ...
     * Gets reporting_tags
     *
     * @return \OpenAPI\Client\Model\EdFiBalanceSheetDimensionReportingTag[]|null
     */
     ...
     * Sets reporting_tags
     *
     * @param \OpenAPI\Client\Model\EdFiBalanceSheetDimensionReportingTag[]|null $reporting_tags An unordered collection of balanceSheetDimensionReportingTags. Optional tag for accountability reporting.
     *
     * @return self
     */
