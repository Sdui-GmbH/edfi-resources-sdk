...
class EdFiEducationContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['content_identifier'] = $data['content_identifier'] ?? null;
        $this->container['learning_standard_reference'] = $data['learning_standard_reference'] ?? null;
        $this->container['additional_authors_indicator'] = $data['additional_authors_indicator'] ?? null;
        ...
        $this->container['content_class_descriptor'] = $data['content_class_descriptor'] ?? null;
        $this->container['cost'] = $data['cost'] ?? null;
        $this->container['cost_rate_descriptor'] = $data['cost_rate_descriptor'] ?? null;
        $this->container['derivative_source_education_contents'] = $data['derivative_source_education_contents'] ?? null;
        $this->container['derivative_source_learning_resource_metadata_uris'] = $data['derivative_source_learning_resource_metadata_uris'] ?? null;
        $this->container['derivative_source_uris'] = $data['derivative_source_uris'] ?? null;
        $this->container['description'] = $data['description'] ?? null;
        $this->container['interactivity_style_descriptor'] = $data['interactivity_style_descriptor'] ?? null;
        ...
        $this->container['time_required'] = $data['time_required'] ?? null;
        $this->container['use_rights_url'] = $data['use_rights_url'] ?? null;
     ...
     * Sets cost
     *
     * @param double|null $cost An amount that has to be paid or spent to buy or obtain the education content.
     *
     * @return self
     */
