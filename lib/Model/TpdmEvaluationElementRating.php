...
class TpdmEvaluationElementRating implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['evaluation_objective_rating_reference'] = $data['evaluation_objective_rating_reference'] ?? null;
        $this->container['area_of_refinement'] = $data['area_of_refinement'] ?? null;
        $this->container['area_of_reinforcement'] = $data['area_of_reinforcement'] ?? null;
