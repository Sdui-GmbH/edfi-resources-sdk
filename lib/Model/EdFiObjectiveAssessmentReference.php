...
/**
 * EdFiObjectiveAssessmentReference Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiObjectiveAssessmentReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_objectiveAssessmentReference';
    ...
    */
    ...
    public function setAssessmentIdentifier($assessment_identifier)
    {
        ...
        if ((mb_strlen($assessment_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $assessment_identifier when calling EdFiObjectiveAssessmentReference., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($assessment_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $assessment_identifier when calling EdFiObjectiveAssessmentReference., must be bigger than or equal to 1.');
        }
    ...
    public function setIdentificationCode($identification_code)
    {
        ...
        if ((mb_strlen($identification_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $identification_code when calling EdFiObjectiveAssessmentReference., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($identification_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identification_code when calling EdFiObjectiveAssessmentReference., must be bigger than or equal to 1.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiObjectiveAssessmentReference., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($namespace) < 5)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling EdFiObjectiveAssessmentReference., must be bigger than or equal to 5.');
        }
