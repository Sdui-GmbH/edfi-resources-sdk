...
class EdFiAssessmentItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['assessment_item_category_descriptor'] = $data['assessment_item_category_descriptor'] ?? null;
        $this->container['assessment_item_uri'] = $data['assessment_item_uri'] ?? null;
        $this->container['expected_time_assessed'] = $data['expected_time_assessed'] ?? null;
        $this->container['item_text'] = $data['item_text'] ?? null;
        ...
        $this->container['possible_responses'] = $data['possible_responses'] ?? null;
