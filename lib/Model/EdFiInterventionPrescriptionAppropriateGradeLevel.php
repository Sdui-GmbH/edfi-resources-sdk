...
/**
 * EdFiInterventionPrescriptionAppropriateGradeLevel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiInterventionPrescriptionAppropriateGradeLevel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_interventionPrescriptionAppropriateGradeLevel';
    ...
    */
     ...
     *
     * @param string $grade_level_descriptor Grade levels for the prescribed intervention. If omitted, considered generally applicable.
     *
     * @return self
     */
    public function setGradeLevelDescriptor($grade_level_descriptor)
    {
        ...
        if ((mb_strlen($grade_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grade_level_descriptor when calling EdFiInterventionPrescriptionAppropriateGradeLevel., must be smaller than or equal to 306.');
        }
