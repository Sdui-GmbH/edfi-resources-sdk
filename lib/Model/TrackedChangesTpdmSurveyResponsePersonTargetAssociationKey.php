...
/**
 * TrackedChangesTpdmSurveyResponsePersonTargetAssociationKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesTpdmSurveyResponsePersonTargetAssociationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_tpdm_surveyResponsePersonTargetAssociationKey';
    ...
    */
    ...
    public function setPersonId($person_id)
    {
        ...
        if ((mb_strlen($person_id) > 32)) {
            throw new \InvalidArgumentException('invalid length for $person_id when calling TrackedChangesTpdmSurveyResponsePersonTargetAssociationKey., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($person_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $person_id when calling TrackedChangesTpdmSurveyResponsePersonTargetAssociationKey., must be bigger than or equal to 1.');
        }
    ...
    public function setSourceSystemDescriptor($source_system_descriptor)
    {
        ...
        if ((mb_strlen($source_system_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $source_system_descriptor when calling TrackedChangesTpdmSurveyResponsePersonTargetAssociationKey., must be smaller than or equal to 306.');
        }
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesTpdmSurveyResponsePersonTargetAssociationKey., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($namespace) < 5)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesTpdmSurveyResponsePersonTargetAssociationKey., must be bigger than or equal to 5.');
        }
    ...
    public function setSurveyIdentifier($survey_identifier)
    {
        ...
        if ((mb_strlen($survey_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $survey_identifier when calling TrackedChangesTpdmSurveyResponsePersonTargetAssociationKey., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($survey_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $survey_identifier when calling TrackedChangesTpdmSurveyResponsePersonTargetAssociationKey., must be bigger than or equal to 1.');
        }
    ...
    public function setSurveyResponseIdentifier($survey_response_identifier)
    {
        ...
        if ((mb_strlen($survey_response_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $survey_response_identifier when calling TrackedChangesTpdmSurveyResponsePersonTargetAssociationKey., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($survey_response_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $survey_response_identifier when calling TrackedChangesTpdmSurveyResponsePersonTargetAssociationKey., must be bigger than or equal to 1.');
        }
