...
class EdFiSection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['course_offering_reference'] = $data['course_offering_reference'] ?? null;
        $this->container['location_reference'] = $data['location_reference'] ?? null;
        $this->container['location_school_reference'] = $data['location_school_reference'] ?? null;
        $this->container['available_credit_conversion'] = $data['available_credit_conversion'] ?? null;
        $this->container['available_credits'] = $data['available_credits'] ?? null;
        $this->container['available_credit_type_descriptor'] = $data['available_credit_type_descriptor'] ?? null;
        $this->container['characteristics'] = $data['characteristics'] ?? null;
        $this->container['class_periods'] = $data['class_periods'] ?? null;
        $this->container['course_level_characteristics'] = $data['course_level_characteristics'] ?? null;
        $this->container['educational_environment_descriptor'] = $data['educational_environment_descriptor'] ?? null;
        $this->container['instruction_language_descriptor'] = $data['instruction_language_descriptor'] ?? null;
        $this->container['medium_of_instruction_descriptor'] = $data['medium_of_instruction_descriptor'] ?? null;
        $this->container['offered_grade_levels'] = $data['offered_grade_levels'] ?? null;
        $this->container['official_attendance_period'] = $data['official_attendance_period'] ?? null;
        ...
        $this->container['section_type_descriptor'] = $data['section_type_descriptor'] ?? null;
        $this->container['sequence_of_course'] = $data['sequence_of_course'] ?? null;
     ...
     *
     * @param double|null $available_credit_conversion Conversion factor that when multiplied by the number of credits is equivalent to Carnegie units.
     *
     * @return self
     */
     ...
     *
     * @param double|null $available_credits The value of credits or units of value awarded for the completion of a course.
     *
     * @return self
     */
