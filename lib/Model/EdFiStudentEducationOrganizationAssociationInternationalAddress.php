...
/**
 * EdFiStudentEducationOrganizationAssociationInternationalAddress Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStudentEducationOrganizationAssociationInternationalAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentEducationOrganizationAssociationInternationalAddress';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['country_descriptor'] = $data['country_descriptor'] ?? null;
    ...
    public function setAddressTypeDescriptor($address_type_descriptor)
    {
        if ((mb_strlen($address_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $address_type_descriptor when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be smaller than or equal to 306.');
        }
    ...
    public function setCountryDescriptor($country_descriptor)
    {
        if ((mb_strlen($country_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $country_descriptor when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be smaller than or equal to 306.');
        }
    ...
    public function setAddressLine1($address_line1)
    {
        if ((mb_strlen($address_line1) > 150)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($address_line1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line1 when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressLine2($address_line2)
    {
        if (!is_null($address_line2) && (mb_strlen($address_line2) > 150)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be smaller than or equal to 150.');
        }
        if (!is_null($address_line2) && (mb_strlen($address_line2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line2 when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressLine3($address_line3)
    {
        if (!is_null($address_line3) && (mb_strlen($address_line3) > 150)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be smaller than or equal to 150.');
        }
        if (!is_null($address_line3) && (mb_strlen($address_line3) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line3 when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setAddressLine4($address_line4)
    {
        if (!is_null($address_line4) && (mb_strlen($address_line4) > 150)) {
            throw new \InvalidArgumentException('invalid length for $address_line4 when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be smaller than or equal to 150.');
        }
        if (!is_null($address_line4) && (mb_strlen($address_line4) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_line4 when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setLatitude($latitude)
    {
        if (!is_null($latitude) && (mb_strlen($latitude) > 20)) {
            throw new \InvalidArgumentException('invalid length for $latitude when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be smaller than or equal to 20.');
        }
        if (!is_null($latitude) && (mb_strlen($latitude) < 1)) {
            throw new \InvalidArgumentException('invalid length for $latitude when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setLongitude($longitude)
    {
        if (!is_null($longitude) && (mb_strlen($longitude) > 20)) {
            throw new \InvalidArgumentException('invalid length for $longitude when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be smaller than or equal to 20.');
        }
        if (!is_null($longitude) && (mb_strlen($longitude) < 1)) {
            throw new \InvalidArgumentException('invalid length for $longitude when calling EdFiStudentEducationOrganizationAssociationInternationalAddress., must be bigger than or equal to 1.');
        }
