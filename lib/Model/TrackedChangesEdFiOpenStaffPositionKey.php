...
/**
 * TrackedChangesEdFiOpenStaffPositionKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiOpenStaffPositionKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_openStaffPositionKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['requisition_number']) && (mb_strlen($this->container['requisition_number']) > 20)) {
     ...
     *
     * @param string|null $requisition_number The number or identifier assigned to an open staff position, typically a requisition number assigned by Human Resources.
     *
     * @return self
     */
    public function setRequisitionNumber($requisition_number)
    {
        if (!is_null($requisition_number) && (mb_strlen($requisition_number) > 20)) {
        ...
        if (!is_null($requisition_number) && (mb_strlen($requisition_number) < 1)) {
