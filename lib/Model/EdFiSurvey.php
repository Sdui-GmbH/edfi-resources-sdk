...
class EdFiSurvey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['session_reference'] = $data['session_reference'] ?? null;
        $this->container['number_administered'] = $data['number_administered'] ?? null;
        $this->container['survey_category_descriptor'] = $data['survey_category_descriptor'] ?? null;
        $this->container['survey_title'] = $data['survey_title'] ?? null;
