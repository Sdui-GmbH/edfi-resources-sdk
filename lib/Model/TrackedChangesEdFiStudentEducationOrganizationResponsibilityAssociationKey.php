...
/**
 * TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_studentEducationOrganizationResponsibilityAssociationKey';
    ...
    protected static array $openAPINullables = [
        'responsibility_descriptor' => false,
        'begin_date' => false,
    ...
    {
        $this->setIfExists('responsibility_descriptor', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['responsibility_descriptor']) && (mb_strlen($this->container['responsibility_descriptor']) > 306)) {
     ...
     *
     * @param string|null $responsibility_descriptor Indications of an education organization's responsibility for a student, such as accountability, attendance, funding, etc.
     *
     * @return self
     */
    public function setResponsibilityDescriptor($responsibility_descriptor)
    {
        if (is_null($responsibility_descriptor)) {
            throw new \InvalidArgumentException('non-nullable responsibility_descriptor cannot be null');
        }
        if ((mb_strlen($responsibility_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $responsibility_descriptor when calling TrackedChangesEdFiStudentEducationOrganizationResponsibilityAssociationKey., must be smaller than or equal to 306.');
        }
