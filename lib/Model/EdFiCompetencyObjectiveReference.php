...
/**
 * EdFiCompetencyObjectiveReference Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiCompetencyObjectiveReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_competencyObjectiveReference';
    ...
    */
    ...
    public function setObjectiveGradeLevelDescriptor($objective_grade_level_descriptor)
    {
        ...
        if ((mb_strlen($objective_grade_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $objective_grade_level_descriptor when calling EdFiCompetencyObjectiveReference., must be smaller than or equal to 306.');
        }
