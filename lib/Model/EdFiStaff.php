...
class EdFiStaff implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['years_of_prior_professional_experience'] = $data['years_of_prior_professional_experience'] ?? null;
        $this->container['years_of_prior_teaching_experience'] = $data['years_of_prior_teaching_experience'] ?? null;
     ...
     *
     * @param double|null $years_of_prior_professional_experience The total number of years that an individual has previously held a similar professional position in one or more education institutions prior to the current school year.
     *
     * @return self
     */
     ...
     *
     * @param double|null $years_of_prior_teaching_experience The total number of years that an individual has previously held a teaching position in one or more education institutions prior to the current school year.
     *
     * @return self
     */
