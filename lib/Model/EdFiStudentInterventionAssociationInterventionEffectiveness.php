...
/**
 * EdFiStudentInterventionAssociationInterventionEffectiveness Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStudentInterventionAssociationInterventionEffectiveness implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentInterventionAssociationInterventionEffectiveness';
    ...
    protected static array $openAPINullables = [
        'diagnosis_descriptor' => false,
        'grade_level_descriptor' => false,
        'population_served_descriptor' => false,
        'intervention_effectiveness_rating_descriptor' => false,
        'improvement_index' => true
    ];
    ...
    {
        $this->setIfExists('diagnosis_descriptor', $data ?? [], null);
        $this->setIfExists('grade_level_descriptor', $data ?? [], null);
        $this->setIfExists('population_served_descriptor', $data ?? [], null);
        $this->setIfExists('intervention_effectiveness_rating_descriptor', $data ?? [], null);
        $this->setIfExists('improvement_index', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($diagnosis_descriptor)) {
            throw new \InvalidArgumentException('non-nullable diagnosis_descriptor cannot be null');
        }
        if ((mb_strlen($diagnosis_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $diagnosis_descriptor when calling EdFiStudentInterventionAssociationInterventionEffectiveness., must be smaller than or equal to 306.');
        }
    ...
    {
        if (is_null($grade_level_descriptor)) {
            throw new \InvalidArgumentException('non-nullable grade_level_descriptor cannot be null');
        }
        if ((mb_strlen($grade_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $grade_level_descriptor when calling EdFiStudentInterventionAssociationInterventionEffectiveness., must be smaller than or equal to 306.');
        }
    ...
    public function setPopulationServedDescriptor($population_served_descriptor)
    {
        if (is_null($population_served_descriptor)) {
            throw new \InvalidArgumentException('non-nullable population_served_descriptor cannot be null');
        }
        if ((mb_strlen($population_served_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $population_served_descriptor when calling EdFiStudentInterventionAssociationInterventionEffectiveness., must be smaller than or equal to 306.');
        }
    ...
    {
        if (is_null($intervention_effectiveness_rating_descriptor)) {
            throw new \InvalidArgumentException('non-nullable intervention_effectiveness_rating_descriptor cannot be null');
        }
        if ((mb_strlen($intervention_effectiveness_rating_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $intervention_effectiveness_rating_descriptor when calling EdFiStudentInterventionAssociationInterventionEffectiveness., must be smaller than or equal to 306.');
        }
    ...
    {
        if (is_null($improvement_index)) {
            array_push($this->openAPINullablesSetToNull, 'improvement_index');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('improvement_index', $nullablesSetToNull);
            if ($index !== FALSE) {
