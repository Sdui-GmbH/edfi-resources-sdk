...
/**
 * TrackedChangesEdFiStudentSchoolAttendanceEventKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStudentSchoolAttendanceEventKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_studentSchoolAttendanceEventKey';
    ...
    */
    ...
    public function setAttendanceEventCategoryDescriptor($attendance_event_category_descriptor)
    {
        ...
        if ((mb_strlen($attendance_event_category_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $attendance_event_category_descriptor when calling TrackedChangesEdFiStudentSchoolAttendanceEventKey., must be smaller than or equal to 306.');
        }
