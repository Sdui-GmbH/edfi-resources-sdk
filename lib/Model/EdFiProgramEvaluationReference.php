...
/**
 * EdFiProgramEvaluationReference Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiProgramEvaluationReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_programEvaluationReference';
    ...
    */
    ...
    public function setProgramEvaluationPeriodDescriptor($program_evaluation_period_descriptor)
    {
        ...
        if ((mb_strlen($program_evaluation_period_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_evaluation_period_descriptor when calling EdFiProgramEvaluationReference., must be smaller than or equal to 306.');
        }
    ...
    public function setProgramEvaluationTitle($program_evaluation_title)
    {
        ...
        if ((mb_strlen($program_evaluation_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $program_evaluation_title when calling EdFiProgramEvaluationReference., must be smaller than or equal to 50.');
        }
    ...
    public function setProgramEvaluationTypeDescriptor($program_evaluation_type_descriptor)
    {
        ...
        if ((mb_strlen($program_evaluation_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_evaluation_type_descriptor when calling EdFiProgramEvaluationReference., must be smaller than or equal to 306.');
        }
    ...
    public function setProgramName($program_name)
    {
        ...
        if ((mb_strlen($program_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $program_name when calling EdFiProgramEvaluationReference., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($program_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $program_name when calling EdFiProgramEvaluationReference., must be bigger than or equal to 1.');
        }
    ...
    public function setProgramTypeDescriptor($program_type_descriptor)
    {
        ...
        if ((mb_strlen($program_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_type_descriptor when calling EdFiProgramEvaluationReference., must be smaller than or equal to 306.');
        }
