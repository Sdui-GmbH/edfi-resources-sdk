...
/**
 * EdFiInterventionStudyAppropriateSex Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiInterventionStudyAppropriateSex implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_interventionStudyAppropriateSex';
     ...
     * Sets sex_descriptor
     *
     * @param string $sex_descriptor Sexes participating in this study. If omitted, considered generally applicable.
     *
     * @return self
     */
    public function setSexDescriptor($sex_descriptor)
    {
        if ((mb_strlen($sex_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $sex_descriptor when calling EdFiInterventionStudyAppropriateSex., must be smaller than or equal to 306.');
        }
