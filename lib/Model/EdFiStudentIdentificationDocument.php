...
/**
 * EdFiStudentIdentificationDocument Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStudentIdentificationDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentIdentificationDocument';
    ...
    */
    ...
    public function setIdentificationDocumentUseDescriptor($identification_document_use_descriptor)
    {
        ...
        if ((mb_strlen($identification_document_use_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $identification_document_use_descriptor when calling EdFiStudentIdentificationDocument., must be smaller than or equal to 306.');
        }
    ...
    public function setPersonalInformationVerificationDescriptor($personal_information_verification_descriptor)
    {
        ...
        if ((mb_strlen($personal_information_verification_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $personal_information_verification_descriptor when calling EdFiStudentIdentificationDocument., must be smaller than or equal to 306.');
        }
    ...
    public function setIssuerCountryDescriptor($issuer_country_descriptor)
    {
        ...
        if (!is_null($issuer_country_descriptor) && (mb_strlen($issuer_country_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $issuer_country_descriptor when calling EdFiStudentIdentificationDocument., must be smaller than or equal to 306.');
        }
    ...
    public function setDocumentTitle($document_title)
    {
        ...
        if (!is_null($document_title) && (mb_strlen($document_title) > 60)) {
            throw new \InvalidArgumentException('invalid length for $document_title when calling EdFiStudentIdentificationDocument., must be smaller than or equal to 60.');
        }
        if (!is_null($document_title) && (mb_strlen($document_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $document_title when calling EdFiStudentIdentificationDocument., must be bigger than or equal to 1.');
        }
    ...
    public function setIssuerDocumentIdentificationCode($issuer_document_identification_code)
    {
        ...
        if (!is_null($issuer_document_identification_code) && (mb_strlen($issuer_document_identification_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $issuer_document_identification_code when calling EdFiStudentIdentificationDocument., must be smaller than or equal to 60.');
        }
        if (!is_null($issuer_document_identification_code) && (mb_strlen($issuer_document_identification_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $issuer_document_identification_code when calling EdFiStudentIdentificationDocument., must be bigger than or equal to 1.');
        }
    ...
    public function setIssuerName($issuer_name)
    {
        ...
        if (!is_null($issuer_name) && (mb_strlen($issuer_name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $issuer_name when calling EdFiStudentIdentificationDocument., must be smaller than or equal to 150.');
        }
        if (!is_null($issuer_name) && (mb_strlen($issuer_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $issuer_name when calling EdFiStudentIdentificationDocument., must be bigger than or equal to 1.');
        }
