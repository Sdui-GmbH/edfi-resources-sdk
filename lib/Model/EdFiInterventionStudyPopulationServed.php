...
/**
 * EdFiInterventionStudyPopulationServed Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiInterventionStudyPopulationServed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_interventionStudyPopulationServed';
    ...
    */
     ...
     *
     * @param string $population_served_descriptor A subset of students that are the focus of the intervention study.
     *
     * @return self
     */
    public function setPopulationServedDescriptor($population_served_descriptor)
    {
        ...
        if ((mb_strlen($population_served_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $population_served_descriptor when calling EdFiInterventionStudyPopulationServed., must be smaller than or equal to 306.');
        }
