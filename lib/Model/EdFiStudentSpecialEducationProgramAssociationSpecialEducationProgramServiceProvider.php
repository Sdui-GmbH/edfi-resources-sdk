...
/**
 * EdFiStudentSpecialEducationProgramAssociationSpecialEducationProgramServiceProvider Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStudentSpecialEducationProgramAssociationSpecialEducationProgramServiceProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentSpecialEducationProgramAssociationSpecialEducationProgramServiceProvider';
    ...
    */
     ...
     *
     * @param bool|null $primary_provider Primary ServiceProvider.
     *
     * @return self
     */
    public function setPrimaryProvider($primary_provider)
    {
        if (is_null($primary_provider)) {
            array_push($this->openAPINullablesSetToNull, 'primary_provider');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('primary_provider', $nullablesSetToNull);
            if ($index !== FALSE) {
