...
/**
 * TrackedChangesEdFiStaffSchoolAssociationKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiStaffSchoolAssociationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_staffSchoolAssociationKey';
    ...
    */
     ...
     *
     * @param string|null $program_assignment_descriptor The name of the program for which the individual is assigned.
     *
     * @return self
     */
    public function setProgramAssignmentDescriptor($program_assignment_descriptor)
    {
        ...
        if ((mb_strlen($program_assignment_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $program_assignment_descriptor when calling TrackedChangesEdFiStaffSchoolAssociationKey., must be smaller than or equal to 306.');
        }
