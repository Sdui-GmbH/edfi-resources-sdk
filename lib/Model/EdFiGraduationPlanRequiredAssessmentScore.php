...
/**
 * EdFiGraduationPlanRequiredAssessmentScore Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiGraduationPlanRequiredAssessmentScore implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_graduationPlanRequiredAssessmentScore';
    ...
    */
    ...
    public function setAssessmentReportingMethodDescriptor($assessment_reporting_method_descriptor)
    {
        ...
        if ((mb_strlen($assessment_reporting_method_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $assessment_reporting_method_descriptor when calling EdFiGraduationPlanRequiredAssessmentScore., must be smaller than or equal to 306.');
        }
    ...
    public function setResultDatatypeTypeDescriptor($result_datatype_type_descriptor)
    {
        ...
        if (!is_null($result_datatype_type_descriptor) && (mb_strlen($result_datatype_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $result_datatype_type_descriptor when calling EdFiGraduationPlanRequiredAssessmentScore., must be smaller than or equal to 306.');
        }
    ...
    public function setMaximumScore($maximum_score)
    {
        ...
        if (!is_null($maximum_score) && (mb_strlen($maximum_score) > 35)) {
            throw new \InvalidArgumentException('invalid length for $maximum_score when calling EdFiGraduationPlanRequiredAssessmentScore., must be smaller than or equal to 35.');
        }
        if (!is_null($maximum_score) && (mb_strlen($maximum_score) < 1)) {
            throw new \InvalidArgumentException('invalid length for $maximum_score when calling EdFiGraduationPlanRequiredAssessmentScore., must be bigger than or equal to 1.');
        }
    ...
    public function setMinimumScore($minimum_score)
    {
        ...
        if (!is_null($minimum_score) && (mb_strlen($minimum_score) > 35)) {
            throw new \InvalidArgumentException('invalid length for $minimum_score when calling EdFiGraduationPlanRequiredAssessmentScore., must be smaller than or equal to 35.');
        }
        if (!is_null($minimum_score) && (mb_strlen($minimum_score) < 1)) {
            throw new \InvalidArgumentException('invalid length for $minimum_score when calling EdFiGraduationPlanRequiredAssessmentScore., must be bigger than or equal to 1.');
        }
