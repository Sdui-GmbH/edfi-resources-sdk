...
/**
 * TrackedChangesEdFiSurveyQuestionResponseKey Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiSurveyQuestionResponseKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_surveyQuestionResponseKey';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['question_code']) && (mb_strlen($this->container['question_code']) > 60)) {
    ...
    public function setNamespace($namespace)
    {
        ...
        if ((mb_strlen($namespace) > 255)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiSurveyQuestionResponseKey., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($namespace) < 5)) {
            throw new \InvalidArgumentException('invalid length for $namespace when calling TrackedChangesEdFiSurveyQuestionResponseKey., must be bigger than or equal to 5.');
        }
     ...
     * Sets question_code
     *
     * @param string|null $question_code The identifying code for the question, unique for the survey.
     *
     * @return self
     */
    public function setQuestionCode($question_code)
    {
        ...
        if ((mb_strlen($question_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $question_code when calling TrackedChangesEdFiSurveyQuestionResponseKey., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($question_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $question_code when calling TrackedChangesEdFiSurveyQuestionResponseKey., must be bigger than or equal to 1.');
        }
    ...
    public function setSurveyIdentifier($survey_identifier)
    {
        ...
        if ((mb_strlen($survey_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $survey_identifier when calling TrackedChangesEdFiSurveyQuestionResponseKey., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($survey_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $survey_identifier when calling TrackedChangesEdFiSurveyQuestionResponseKey., must be bigger than or equal to 1.');
        }
    ...
    public function setSurveyResponseIdentifier($survey_response_identifier)
    {
        ...
        if ((mb_strlen($survey_response_identifier) > 60)) {
            throw new \InvalidArgumentException('invalid length for $survey_response_identifier when calling TrackedChangesEdFiSurveyQuestionResponseKey., must be smaller than or equal to 60.');
        }
        if ((mb_strlen($survey_response_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $survey_response_identifier when calling TrackedChangesEdFiSurveyQuestionResponseKey., must be bigger than or equal to 1.');
        }
