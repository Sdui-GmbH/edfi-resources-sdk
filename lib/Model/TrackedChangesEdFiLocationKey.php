...
/**
 * TrackedChangesEdFiLocationKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TrackedChangesEdFiLocationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'trackedChanges_edFi_locationKey';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['classroom_identification_code']) && (mb_strlen($this->container['classroom_identification_code']) > 60)) {
     ...
     *
     * @param string|null $classroom_identification_code A unique number or alphanumeric code assigned to a room by a school, school system, state, or other agency or entity.
     *
     * @return self
     */
    public function setClassroomIdentificationCode($classroom_identification_code)
    {
        if (!is_null($classroom_identification_code) && (mb_strlen($classroom_identification_code) > 60)) {
        ...
        if (!is_null($classroom_identification_code) && (mb_strlen($classroom_identification_code) < 1)) {
