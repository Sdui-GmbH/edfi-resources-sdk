...
/**
 * TpdmCandidateReference Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TpdmCandidateReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tpdm_candidateReference';
    ...
    */
    ...
    public function setCandidateIdentifier($candidate_identifier)
    {
        ...
        if ((mb_strlen($candidate_identifier) > 32)) {
            throw new \InvalidArgumentException('invalid length for $candidate_identifier when calling TpdmCandidateReference., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($candidate_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $candidate_identifier when calling TpdmCandidateReference., must be bigger than or equal to 1.');
        }
