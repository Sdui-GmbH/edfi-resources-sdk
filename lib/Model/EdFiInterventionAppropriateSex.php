...
/**
 * EdFiInterventionAppropriateSex Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiInterventionAppropriateSex implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_interventionAppropriateSex';
     ...
     * Sets sex_descriptor
     *
     * @param string $sex_descriptor Sexes for the intervention. If omitted, considered generally applicable.
     *
     * @return self
     */
    public function setSexDescriptor($sex_descriptor)
    {
        if ((mb_strlen($sex_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $sex_descriptor when calling EdFiInterventionAppropriateSex., must be smaller than or equal to 306.');
        }
