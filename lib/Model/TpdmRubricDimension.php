...
class TpdmRubricDimension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'criterion_description' => false,
        'dimension_order' => true,
        'rubric_rating_level_descriptor' => true,
        '_etag' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('criterion_description', $data ?? [], null);
        $this->setIfExists('dimension_order', $data ?? [], null);
        $this->setIfExists('rubric_rating_level_descriptor', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($criterion_description)) {
            throw new \InvalidArgumentException('non-nullable criterion_description cannot be null');
        }
    ...
    {
        if (is_null($dimension_order)) {
            array_push($this->openAPINullablesSetToNull, 'dimension_order');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dimension_order', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($rubric_rating_level_descriptor)) {
            array_push($this->openAPINullablesSetToNull, 'rubric_rating_level_descriptor');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('rubric_rating_level_descriptor', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
