...
class EdFiObjectiveAssessment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['parent_objective_assessment_reference'] = $data['parent_objective_assessment_reference'] ?? null;
        $this->container['academic_subject_descriptor'] = $data['academic_subject_descriptor'] ?? null;
        $this->container['assessment_items'] = $data['assessment_items'] ?? null;
        ...
        $this->container['percent_of_assessment'] = $data['percent_of_assessment'] ?? null;
     ...
     *
     * @param double|null $percent_of_assessment The percentage of the assessment that tests this objective.
     *
     * @return self
     */
