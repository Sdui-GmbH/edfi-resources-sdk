...
/**
 * EdFiAssessmentPerformanceLevel Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiAssessmentPerformanceLevel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_assessmentPerformanceLevel';
    ...
    */
    ...
    public function setAssessmentReportingMethodDescriptor($assessment_reporting_method_descriptor)
    {
        ...
        if ((mb_strlen($assessment_reporting_method_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $assessment_reporting_method_descriptor when calling EdFiAssessmentPerformanceLevel., must be smaller than or equal to 306.');
        }
    ...
    public function setPerformanceLevelDescriptor($performance_level_descriptor)
    {
        ...
        if ((mb_strlen($performance_level_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $performance_level_descriptor when calling EdFiAssessmentPerformanceLevel., must be smaller than or equal to 306.');
        }
    ...
    public function setResultDatatypeTypeDescriptor($result_datatype_type_descriptor)
    {
        ...
        if (!is_null($result_datatype_type_descriptor) && (mb_strlen($result_datatype_type_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $result_datatype_type_descriptor when calling EdFiAssessmentPerformanceLevel., must be smaller than or equal to 306.');
        }
    ...
    public function setMaximumScore($maximum_score)
    {
        ...
        if (!is_null($maximum_score) && (mb_strlen($maximum_score) > 35)) {
            throw new \InvalidArgumentException('invalid length for $maximum_score when calling EdFiAssessmentPerformanceLevel., must be smaller than or equal to 35.');
        }
        if (!is_null($maximum_score) && (mb_strlen($maximum_score) < 1)) {
            throw new \InvalidArgumentException('invalid length for $maximum_score when calling EdFiAssessmentPerformanceLevel., must be bigger than or equal to 1.');
        }
    ...
    public function setMinimumScore($minimum_score)
    {
        ...
        if (!is_null($minimum_score) && (mb_strlen($minimum_score) > 35)) {
            throw new \InvalidArgumentException('invalid length for $minimum_score when calling EdFiAssessmentPerformanceLevel., must be smaller than or equal to 35.');
        }
        if (!is_null($minimum_score) && (mb_strlen($minimum_score) < 1)) {
            throw new \InvalidArgumentException('invalid length for $minimum_score when calling EdFiAssessmentPerformanceLevel., must be bigger than or equal to 1.');
        }
    ...
    public function setPerformanceLevelIndicatorName($performance_level_indicator_name)
    {
        ...
        if (!is_null($performance_level_indicator_name) && (mb_strlen($performance_level_indicator_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $performance_level_indicator_name when calling EdFiAssessmentPerformanceLevel., must be smaller than or equal to 60.');
        }
        if (!is_null($performance_level_indicator_name) && (mb_strlen($performance_level_indicator_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $performance_level_indicator_name when calling EdFiAssessmentPerformanceLevel., must be bigger than or equal to 1.');
        }
