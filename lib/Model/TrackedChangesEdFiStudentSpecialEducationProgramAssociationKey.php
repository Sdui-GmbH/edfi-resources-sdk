...
class TrackedChangesEdFiStudentSpecialEducationProgramAssociationKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setProgramName($program_name)
    {
        ...
        if (!is_null($program_name) && (mb_strlen($program_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $program_name when calling TrackedChangesEdFiStudentSpecialEducationProgramAssociationKey., must be bigger than or equal to 1.');
        }
    ...
    public function setStudentUniqueId($student_unique_id)
    {
        ...
        if (!is_null($student_unique_id) && (mb_strlen($student_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $student_unique_id when calling TrackedChangesEdFiStudentSpecialEducationProgramAssociationKey., must be bigger than or equal to 1.');
        }
