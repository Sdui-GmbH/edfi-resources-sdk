...
/**
 * EdFiCrisisEventReference Class Doc Comment
 *
 * @category Class
 * @package  Resources
 * @author   OpenAPI Generator team
 ...
 */
class EdFiCrisisEventReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_crisisEventReference';
    ...
    */
    ...
    public function setCrisisEventName($crisis_event_name)
    {
        ...
        if ((mb_strlen($crisis_event_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $crisis_event_name when calling EdFiCrisisEventReference., must be smaller than or equal to 100.');
        }
