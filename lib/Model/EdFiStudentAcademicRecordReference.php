...
/**
 * EdFiStudentAcademicRecordReference Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStudentAcademicRecordReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentAcademicRecordReference';
    ...
    */
    ...
    public function setTermDescriptor($term_descriptor)
    {
        ...
        if ((mb_strlen($term_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $term_descriptor when calling EdFiStudentAcademicRecordReference., must be smaller than or equal to 306.');
        }
