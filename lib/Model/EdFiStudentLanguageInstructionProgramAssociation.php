...
/**
 * EdFiStudentLanguageInstructionProgramAssociation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EdFiStudentLanguageInstructionProgramAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'edFi_studentLanguageInstructionProgramAssociation';
    ...
    protected static $openAPITypes = [
        ...
        'dosage' => 'int',
        'end_date' => '\DateTime',
        'english_language_proficiency_assessments' => '\OpenAPI\Client\Model\EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment[]',
        'english_learner_participation' => 'bool',
        'language_instruction_program_services' => '\OpenAPI\Client\Model\EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService[]',
    ...
    protected static $openAPIFormats = [
        ...
        'dosage' => 'int32',
        'end_date' => 'date',
        'english_language_proficiency_assessments' => null,
        'english_learner_participation' => null,
        'language_instruction_program_services' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'dosage' => true,
        'end_date' => true,
        'english_language_proficiency_assessments' => false,
        'english_learner_participation' => true,
        'language_instruction_program_services' => false,
    ...
    protected static $setters = [
        ...
        'dosage' => 'setDosage',
        'end_date' => 'setEndDate',
        'english_language_proficiency_assessments' => 'setEnglishLanguageProficiencyAssessments',
        'english_learner_participation' => 'setEnglishLearnerParticipation',
        'language_instruction_program_services' => 'setLanguageInstructionProgramServices',
    ...
    protected static $getters = [
        ...
        'dosage' => 'getDosage',
        'end_date' => 'getEndDate',
        'english_language_proficiency_assessments' => 'getEnglishLanguageProficiencyAssessments',
        'english_learner_participation' => 'getEnglishLearnerParticipation',
        'language_instruction_program_services' => 'getLanguageInstructionProgramServices',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('english_language_proficiency_assessments', $data ?? [], null);
        $this->setIfExists('english_learner_participation', $data ?? [], null);
        $this->setIfExists('language_instruction_program_services', $data ?? [], null);
    ...
    */
     ...
     * Sets dosage
     *
     * @param int|null $dosage The duration of time in minutes for which the student was assigned to participate in the program.
     *
     * @return self
     */
    ...
    /**
     * Gets english_language_proficiency_assessments
     *
     * @return \OpenAPI\Client\Model\EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment[]|null
     */
    public function getEnglishLanguageProficiencyAssessments()
    {
        return $this->container['english_language_proficiency_assessments'];
    }

    /**
     * Sets english_language_proficiency_assessments
     *
     * @param \OpenAPI\Client\Model\EdFiStudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment[]|null $english_language_proficiency_assessments An unordered collection of studentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessments. Results of yearly English language assessment.
     *
     * @return self
     */
    public function setEnglishLanguageProficiencyAssessments($english_language_proficiency_assessments)
    {
        if (is_null($english_language_proficiency_assessments)) {
            throw new \InvalidArgumentException('non-nullable english_language_proficiency_assessments cannot be null');
        }
        $this->container['english_language_proficiency_assessments'] = $english_language_proficiency_assessments;

        return $this;
    }

    /**
     * Gets english_learner_participation
     *
     * @return bool|null
     */
    public function getEnglishLearnerParticipation()
    {
        return $this->container['english_learner_participation'];
    }

    /**
     * Sets english_learner_participation
     *
     * @param bool|null $english_learner_participation An indication that an English learner student is served by an English language instruction educational program supported with Title III of ESEA funds.
     *
     * @return self
     */
    public function setEnglishLearnerParticipation($english_learner_participation)
    {
        if (is_null($english_learner_participation)) {
            array_push($this->openAPINullablesSetToNull, 'english_learner_participation');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('english_learner_participation', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['english_learner_participation'] = $english_learner_participation;

        return $this;
    }

    /**
     * Gets language_instruction_program_services
     *
     * @return \OpenAPI\Client\Model\EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService[]|null
     */
    public function getLanguageInstructionProgramServices()
    {
        return $this->container['language_instruction_program_services'];
    }

    /**
     * Sets language_instruction_program_services
     *
     * @param \OpenAPI\Client\Model\EdFiStudentLanguageInstructionProgramAssociationLanguageInstructionProgramService[]|null $language_instruction_program_services An unordered collection of studentLanguageInstructionProgramAssociationLanguageInstructionProgramServices. Indicates the service(s) being provided to the student by the language instruction program.
     *
     * @return self
     */
    public function setLanguageInstructionProgramServices($language_instruction_program_services)
    {
        if (is_null($language_instruction_program_services)) {
            throw new \InvalidArgumentException('non-nullable language_instruction_program_services cannot be null');
        }
        $this->container['language_instruction_program_services'] = $language_instruction_program_services;
    ...
    public function setReasonExitedDescriptor($reason_exited_descriptor)
    {
        ...
        if (!is_null($reason_exited_descriptor) && (mb_strlen($reason_exited_descriptor) > 306)) {
            throw new \InvalidArgumentException('invalid length for $reason_exited_descriptor when calling EdFiStudentLanguageInstructionProgramAssociation., must be smaller than or equal to 306.');
        }
