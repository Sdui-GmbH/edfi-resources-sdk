    ...
    */
    ...
    public function setAccountIdentifier($account_identifier)
    {
        ...
        if ((mb_strlen($account_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_identifier when calling TrackedChangesEdFiLocalPayrollKey., must be bigger than or equal to 1.');
        }
    ...
    public function setStaffUniqueId($staff_unique_id)
    {
        ...
        if ((mb_strlen($staff_unique_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $staff_unique_id when calling TrackedChangesEdFiLocalPayrollKey., must be bigger than or equal to 1.');
        }
