...
class CommunityOrganizationsApi
{
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deletesCommunityOrganizationsAsync($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false, string $contentType = self::contentTypes['deletesCommunityOrganizations'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deletesCommunityOrganizationsRequest($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false, string $contentType = self::contentTypes['deletesCommunityOrganizations'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyChangesCommunityOrganizationsAsync($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false, string $contentType = self::contentTypes['keyChangesCommunityOrganizations'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function keyChangesCommunityOrganizationsRequest($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false, string $contentType = self::contentTypes['keyChangesCommunityOrganizations'][0])
    {
