...
class StudentSectionAssociationsApi
{
    ...
    public function deletesStudentSectionAssociationsWithHttpInfo($offset = null, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false, string $contentType = self::contentTypes['deletesStudentSectionAssociations'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Resources\Model\TrackedChangesEdFiStudentSectionAssociationDelete[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Resources\Model\TrackedChangesEdFiStudentSectionAssociationDelete[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Resources\Model\TrackedChangesEdFiStudentSectionAssociationDelete[]', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Resources\Model\TrackedChangesEdFiStudentSectionAssociationDelete[]',
    ...
    public function getStudentSectionAssociationsWithHttpInfo($offset = null, $limit = 25, $page_token = null, $page_size = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $begin_date = null, $local_course_code = null, $school_id = null, $school_year = null, $section_identifier = null, $session_name = null, $student_unique_id = null, $dual_credit_education_organization_id = null, $attempt_status_descriptor = null, $dual_credit_institution_descriptor = null, $dual_credit_type_descriptor = null, $repeat_identifier_descriptor = null, $dual_credit_indicator = null, $dual_high_school_credit_indicator = null, $end_date = null, $homeroom_indicator = null, $id = null, $teacher_student_data_link_exclusion = null, $use_snapshot = false, string $contentType = self::contentTypes['getStudentSectionAssociations'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Resources\Model\EdFiStudentSectionAssociation[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Resources\Model\EdFiStudentSectionAssociation[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Resources\Model\EdFiStudentSectionAssociation[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Resources\Model\EdFiStudentSectionAssociation[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function keyChangesStudentSectionAssociationsWithHttpInfo($offset = null, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false, string $contentType = self::contentTypes['keyChangesStudentSectionAssociations'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Resources\Model\TrackedChangesEdFiStudentSectionAssociationKeyChange[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Resources\Model\TrackedChangesEdFiStudentSectionAssociationKeyChange[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Resources\Model\TrackedChangesEdFiStudentSectionAssociationKeyChange[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Resources\Model\TrackedChangesEdFiStudentSectionAssociationKeyChange[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Resources\Model\EdFiStudentSectionAssociation $ed_fi_student_section_association The JSON representation of the \&quot;studentSectionAssociation\&quot; resource to be created or updated. (required)
