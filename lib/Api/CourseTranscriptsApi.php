...
class CourseTranscriptsApi
{
     ...
     * @return void
     */
    public function deleteCourseTranscriptById($id, $if_match = null)
    {
        $this->deleteCourseTranscriptByIdWithHttpInfo($id, $if_match);
    }
     ...
     */
    public function deleteCourseTranscriptByIdWithHttpInfo($id, $if_match = null)
    {
        $request = $this->deleteCourseTranscriptByIdRequest($id, $if_match);
     ...
     */
    public function deleteCourseTranscriptByIdAsync($id, $if_match = null)
    {
        return $this->deleteCourseTranscriptByIdAsyncWithHttpInfo($id, $if_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteCourseTranscriptByIdAsyncWithHttpInfo($id, $if_match = null)
    {
        $returnType = '';
        $request = $this->deleteCourseTranscriptByIdRequest($id, $if_match);
     ...
     */
    public function deleteCourseTranscriptByIdRequest($id, $if_match = null)
    {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptDelete[]
     */
    public function deletesCourseTranscripts($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false)
    {
        list($response) = $this->deletesCourseTranscriptsWithHttpInfo($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptDelete[], HTTP status code, HTTP response headers (array of strings)
     */
    public function deletesCourseTranscriptsWithHttpInfo($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false)
    {
        $request = $this->deletesCourseTranscriptsRequest($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptDelete[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptDelete[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptDelete[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptDelete[]',
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deletesCourseTranscriptsAsync($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false)
    {
        return $this->deletesCourseTranscriptsAsyncWithHttpInfo($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deletesCourseTranscriptsAsyncWithHttpInfo($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false)
    {
        $returnType = '\OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptDelete[]';
        $request = $this->deletesCourseTranscriptsRequest($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deletesCourseTranscriptsRequest($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false)
    {
     ...
     * @param  double $attempted_credit_conversion Conversion factor that when multiplied by the number of credits is equivalent to Carnegie units. (optional)
     * @param  double $attempted_credits The value of credits or units of value awarded for the completion of a course. (optional)
     ...
     * @param  double $earned_credit_conversion Conversion factor that when multiplied by the number of credits is equivalent to Carnegie units. (optional)
     * @param  double $earned_credits The value of credits or units of value awarded for the completion of a course. (optional)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\EdFiCourseTranscript[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getCourseTranscriptsWithHttpInfo($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $course_attempt_result_descriptor = null, $course_code = null, $course_education_organization_id = null, $education_organization_id = null, $school_year = null, $student_unique_id = null, $term_descriptor = null, $external_education_organization_id = null, $responsible_teacher_staff_unique_id = null, $course_repeat_code_descriptor = null, $attempted_credit_type_descriptor = null, $earned_credit_type_descriptor = null, $when_taken_grade_level_descriptor = null, $method_credit_earned_descriptor = null, $alternative_course_title = null, $assigning_organization_identification_code = null, $attempted_credit_conversion = null, $attempted_credits = null, $course_catalog_url = null, $course_title = null, $earned_credit_conversion = null, $earned_credits = null, $external_education_organization_name_of_institution = null, $final_letter_grade_earned = null, $final_numeric_grade_earned = null, $id = null, $use_snapshot = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\EdFiCourseTranscript[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\EdFiCourseTranscript[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\EdFiCourseTranscript[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\EdFiCourseTranscript[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getCourseTranscriptsRequest($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $course_attempt_result_descriptor = null, $course_code = null, $course_education_organization_id = null, $education_organization_id = null, $school_year = null, $student_unique_id = null, $term_descriptor = null, $external_education_organization_id = null, $responsible_teacher_staff_unique_id = null, $course_repeat_code_descriptor = null, $attempted_credit_type_descriptor = null, $earned_credit_type_descriptor = null, $when_taken_grade_level_descriptor = null, $method_credit_earned_descriptor = null, $alternative_course_title = null, $assigning_organization_identification_code = null, $attempted_credit_conversion = null, $attempted_credits = null, $course_catalog_url = null, $course_title = null, $earned_credit_conversion = null, $earned_credits = null, $external_education_organization_name_of_institution = null, $final_letter_grade_earned = null, $final_numeric_grade_earned = null, $id = null, $use_snapshot = false)
    {
        ...
        // query params
        if ($course_attempt_result_descriptor !== null) {
            if('form' === 'form' && is_array($course_attempt_result_descriptor)) {
                foreach($course_attempt_result_descriptor as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['courseAttemptResultDescriptor'] = $course_attempt_result_descriptor;
            }
        }
        // query params
        if ($course_code !== null) {
        ...
        // query params
        if ($course_education_organization_id !== null) {
            if('form' === 'form' && is_array($course_education_organization_id)) {
                foreach($course_education_organization_id as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['courseEducationOrganizationId'] = $course_education_organization_id;
            }
        }
        // query params
        ...
        // query params
        if ($external_education_organization_id !== null) {
            if('form' === 'form' && is_array($external_education_organization_id)) {
                foreach($external_education_organization_id as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['externalEducationOrganizationId'] = $external_education_organization_id;
            }
        }
        // query params
        if ($responsible_teacher_staff_unique_id !== null) {
            if('form' === 'form' && is_array($responsible_teacher_staff_unique_id)) {
                foreach($responsible_teacher_staff_unique_id as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['responsibleTeacherStaffUniqueId'] = $responsible_teacher_staff_unique_id;
            }
        }
        // query params
        if ($course_repeat_code_descriptor !== null) {
            if('form' === 'form' && is_array($course_repeat_code_descriptor)) {
                foreach($course_repeat_code_descriptor as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['courseRepeatCodeDescriptor'] = $course_repeat_code_descriptor;
            }
        }
        // query params
        if ($attempted_credit_type_descriptor !== null) {
            if('form' === 'form' && is_array($attempted_credit_type_descriptor)) {
                foreach($attempted_credit_type_descriptor as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['attemptedCreditTypeDescriptor'] = $attempted_credit_type_descriptor;
            }
        }
        // query params
        if ($earned_credit_type_descriptor !== null) {
            if('form' === 'form' && is_array($earned_credit_type_descriptor)) {
                foreach($earned_credit_type_descriptor as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['earnedCreditTypeDescriptor'] = $earned_credit_type_descriptor;
            }
        }
        // query params
        if ($when_taken_grade_level_descriptor !== null) {
            if('form' === 'form' && is_array($when_taken_grade_level_descriptor)) {
                foreach($when_taken_grade_level_descriptor as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['whenTakenGradeLevelDescriptor'] = $when_taken_grade_level_descriptor;
            }
        }
        // query params
        if ($method_credit_earned_descriptor !== null) {
            if('form' === 'form' && is_array($method_credit_earned_descriptor)) {
                foreach($method_credit_earned_descriptor as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['methodCreditEarnedDescriptor'] = $method_credit_earned_descriptor;
            }
        }
        // query params
        if ($alternative_course_title !== null) {
            if('form' === 'form' && is_array($alternative_course_title)) {
                foreach($alternative_course_title as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['alternativeCourseTitle'] = $alternative_course_title;
            }
        }
        // query params
        if ($assigning_organization_identification_code !== null) {
            if('form' === 'form' && is_array($assigning_organization_identification_code)) {
                foreach($assigning_organization_identification_code as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['assigningOrganizationIdentificationCode'] = $assigning_organization_identification_code;
            }
        }
        // query params
        if ($attempted_credit_conversion !== null) {
            if('form' === 'form' && is_array($attempted_credit_conversion)) {
                foreach($attempted_credit_conversion as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['attemptedCreditConversion'] = $attempted_credit_conversion;
            }
        }
        // query params
        if ($attempted_credits !== null) {
            if('form' === 'form' && is_array($attempted_credits)) {
                foreach($attempted_credits as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['attemptedCredits'] = $attempted_credits;
            }
        }
        // query params
        if ($course_catalog_url !== null) {
            if('form' === 'form' && is_array($course_catalog_url)) {
                foreach($course_catalog_url as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['courseCatalogURL'] = $course_catalog_url;
            }
        }
        // query params
        ...
        // query params
        if ($earned_credit_conversion !== null) {
            if('form' === 'form' && is_array($earned_credit_conversion)) {
                foreach($earned_credit_conversion as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['earnedCreditConversion'] = $earned_credit_conversion;
            }
        }
        // query params
        if ($earned_credits !== null) {
            if('form' === 'form' && is_array($earned_credits)) {
                foreach($earned_credits as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['earnedCredits'] = $earned_credits;
            }
        }
        // query params
        if ($external_education_organization_name_of_institution !== null) {
            if('form' === 'form' && is_array($external_education_organization_name_of_institution)) {
                foreach($external_education_organization_name_of_institution as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['externalEducationOrganizationNameOfInstitution'] = $external_education_organization_name_of_institution;
            }
        }
        // query params
        if ($final_letter_grade_earned !== null) {
            if('form' === 'form' && is_array($final_letter_grade_earned)) {
                foreach($final_letter_grade_earned as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['finalLetterGradeEarned'] = $final_letter_grade_earned;
            }
        }
        // query params
        if ($final_numeric_grade_earned !== null) {
            if('form' === 'form' && is_array($final_numeric_grade_earned)) {
                foreach($final_numeric_grade_earned as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['finalNumericGradeEarned'] = $final_numeric_grade_earned;
            }
        }
        // query params
        if ($id !== null) {
     ...
     * @return \OpenAPI\Client\Model\EdFiCourseTranscript
     */
    public function getCourseTranscriptsById($id, $if_none_match = null, $use_snapshot = false)
    {
        list($response) = $this->getCourseTranscriptsByIdWithHttpInfo($id, $if_none_match, $use_snapshot);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\EdFiCourseTranscript, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCourseTranscriptsByIdWithHttpInfo($id, $if_none_match = null, $use_snapshot = false)
    {
        $request = $this->getCourseTranscriptsByIdRequest($id, $if_none_match, $use_snapshot);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCourseTranscriptsByIdAsync($id, $if_none_match = null, $use_snapshot = false)
    {
        return $this->getCourseTranscriptsByIdAsyncWithHttpInfo($id, $if_none_match, $use_snapshot)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCourseTranscriptsByIdAsyncWithHttpInfo($id, $if_none_match = null, $use_snapshot = false)
    {
        $returnType = '\OpenAPI\Client\Model\EdFiCourseTranscript';
        $request = $this->getCourseTranscriptsByIdRequest($id, $if_none_match, $use_snapshot);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCourseTranscriptsByIdRequest($id, $if_none_match = null, $use_snapshot = false)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptKeyChange[]
     */
    public function keyChangesCourseTranscripts($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false)
    {
        list($response) = $this->keyChangesCourseTranscriptsWithHttpInfo($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptKeyChange[], HTTP status code, HTTP response headers (array of strings)
     */
    public function keyChangesCourseTranscriptsWithHttpInfo($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false)
    {
        $request = $this->keyChangesCourseTranscriptsRequest($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptKeyChange[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptKeyChange[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptKeyChange[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptKeyChange[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyChangesCourseTranscriptsAsync($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false)
    {
        return $this->keyChangesCourseTranscriptsAsyncWithHttpInfo($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyChangesCourseTranscriptsAsyncWithHttpInfo($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false)
    {
        $returnType = '\OpenAPI\Client\Model\TrackedChangesEdFiCourseTranscriptKeyChange[]';
        $request = $this->keyChangesCourseTranscriptsRequest($offset, $limit, $min_change_version, $max_change_version, $total_count, $use_snapshot);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function keyChangesCourseTranscriptsRequest($offset = 0, $limit = 25, $min_change_version = null, $max_change_version = null, $total_count = false, $use_snapshot = false)
    {
        if ($limit !== null && $limit > 500) {
     ...
     *
     * @param  \OpenAPI\Client\Model\EdFiCourseTranscript $ed_fi_course_transcript The JSON representation of the \&quot;courseTranscript\&quot; resource to be created or updated. (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postCourseTranscript($ed_fi_course_transcript)
    {
        $this->postCourseTranscriptWithHttpInfo($ed_fi_course_transcript);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postCourseTranscriptWithHttpInfo($ed_fi_course_transcript)
    {
        $request = $this->postCourseTranscriptRequest($ed_fi_course_transcript);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCourseTranscriptAsync($ed_fi_course_transcript)
    {
        return $this->postCourseTranscriptAsyncWithHttpInfo($ed_fi_course_transcript)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postCourseTranscriptAsyncWithHttpInfo($ed_fi_course_transcript)
    {
        $returnType = '';
        $request = $this->postCourseTranscriptRequest($ed_fi_course_transcript);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postCourseTranscriptRequest($ed_fi_course_transcript)
    {
        ...
        if (isset($ed_fi_course_transcript)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($ed_fi_course_transcript));
            } else {
     ...
     * @return void
     */
    public function putCourseTranscript($id, $ed_fi_course_transcript, $if_match = null)
    {
        $this->putCourseTranscriptWithHttpInfo($id, $ed_fi_course_transcript, $if_match);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function putCourseTranscriptWithHttpInfo($id, $ed_fi_course_transcript, $if_match = null)
    {
        $request = $this->putCourseTranscriptRequest($id, $ed_fi_course_transcript, $if_match);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putCourseTranscriptAsync($id, $ed_fi_course_transcript, $if_match = null)
    {
        return $this->putCourseTranscriptAsyncWithHttpInfo($id, $ed_fi_course_transcript, $if_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putCourseTranscriptAsyncWithHttpInfo($id, $ed_fi_course_transcript, $if_match = null)
    {
        $returnType = '';
        $request = $this->putCourseTranscriptRequest($id, $ed_fi_course_transcript, $if_match);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function putCourseTranscriptRequest($id, $ed_fi_course_transcript, $if_match = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
