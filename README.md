...
*AssessmentAdministrationsApi* | [**getAssessmentAdministrationsById**](docs/Api/AssessmentAdministrationsApi.md#getassessmentadministrationsbyid) | **GET** /ed-fi/assessmentAdministrations/{id} | Retrieves a specific resource using the resource&#39;s identifier (using the \&quot;Get By Id\&quot; pattern).
...
*BalanceSheetDimensionsApi* | [**getBalanceSheetDimensionsPartitions**](docs/Api/BalanceSheetDimensionsApi.md#getbalancesheetdimensionspartitions) | **GET** /ed-fi/balanceSheetDimensions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*CommunityProvidersApi* | [**getCommunityProvidersPartitions**](docs/Api/CommunityProvidersApi.md#getcommunityproviderspartitions) | **GET** /ed-fi/communityProviders/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*EvaluationRubricDimensionsApi* | [**getEvaluationRubricDimensionsPartitions**](docs/Api/EvaluationRubricDimensionsApi.md#getevaluationrubricdimensionspartitions) | **GET** /ed-fi/evaluationRubricDimensions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*GradebookEntriesApi* | [**getGradebookEntriesPartitions**](docs/Api/GradebookEntriesApi.md#getgradebookentriespartitions) | **GET** /ed-fi/gradebookEntries/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*GradesApi* | [**getGradesPartitions**](docs/Api/GradesApi.md#getgradespartitions) | **GET** /ed-fi/grades/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*GradingPeriodsApi* | [**getGradingPeriodsPartitions**](docs/Api/GradingPeriodsApi.md#getgradingperiodspartitions) | **GET** /ed-fi/gradingPeriods/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*GraduationPlansApi* | [**getGraduationPlansPartitions**](docs/Api/GraduationPlansApi.md#getgraduationplanspartitions) | **GET** /ed-fi/graduationPlans/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*InterventionPrescriptionsApi* | [**getInterventionPrescriptionsPartitions**](docs/Api/InterventionPrescriptionsApi.md#getinterventionprescriptionspartitions) | **GET** /ed-fi/interventionPrescriptions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*InterventionStudiesApi* | [**getInterventionStudiesPartitions**](docs/Api/InterventionStudiesApi.md#getinterventionstudiespartitions) | **GET** /ed-fi/interventionStudies/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*InterventionsApi* | [**getInterventionsPartitions**](docs/Api/InterventionsApi.md#getinterventionspartitions) | **GET** /ed-fi/interventions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*LearningStandardsApi* | [**getLearningStandardsPartitions**](docs/Api/LearningStandardsApi.md#getlearningstandardspartitions) | **GET** /ed-fi/learningStandards/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*LocalAccountsApi* | [**getLocalAccountsPartitions**](docs/Api/LocalAccountsApi.md#getlocalaccountspartitions) | **GET** /ed-fi/localAccounts/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*LocalActualsApi* | [**getLocalActualsPartitions**](docs/Api/LocalActualsApi.md#getlocalactualspartitions) | **GET** /ed-fi/localActuals/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*LocalBudgetsApi* | [**getLocalBudgetsPartitions**](docs/Api/LocalBudgetsApi.md#getlocalbudgetspartitions) | **GET** /ed-fi/localBudgets/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*LocalContractedStaffsApi* | [**getLocalContractedStaffsPartitions**](docs/Api/LocalContractedStaffsApi.md#getlocalcontractedstaffspartitions) | **GET** /ed-fi/localContractedStaffs/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*LocalEducationAgenciesApi* | [**getLocalEducationAgenciesPartitions**](docs/Api/LocalEducationAgenciesApi.md#getlocaleducationagenciespartitions) | **GET** /ed-fi/localEducationAgencies/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*LocalEncumbrancesApi* | [**getLocalEncumbrancesPartitions**](docs/Api/LocalEncumbrancesApi.md#getlocalencumbrancespartitions) | **GET** /ed-fi/localEncumbrances/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*LocalPayrollsApi* | [**getLocalPayrollsPartitions**](docs/Api/LocalPayrollsApi.md#getlocalpayrollspartitions) | **GET** /ed-fi/localPayrolls/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*LocationsApi* | [**getLocationsPartitions**](docs/Api/LocationsApi.md#getlocationspartitions) | **GET** /ed-fi/locations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*ObjectDimensionsApi* | [**getObjectDimensionsPartitions**](docs/Api/ObjectDimensionsApi.md#getobjectdimensionspartitions) | **GET** /ed-fi/objectDimensions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*ObjectiveAssessmentsApi* | [**getObjectiveAssessmentsPartitions**](docs/Api/ObjectiveAssessmentsApi.md#getobjectiveassessmentspartitions) | **GET** /ed-fi/objectiveAssessments/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*OpenStaffPositionsApi* | [**getOpenStaffPositionsPartitions**](docs/Api/OpenStaffPositionsApi.md#getopenstaffpositionspartitions) | **GET** /ed-fi/openStaffPositions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*OperationalUnitDimensionsApi* | [**getOperationalUnitDimensionsPartitions**](docs/Api/OperationalUnitDimensionsApi.md#getoperationalunitdimensionspartitions) | **GET** /ed-fi/operationalUnitDimensions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*OrganizationDepartmentsApi* | [**getOrganizationDepartmentsPartitions**](docs/Api/OrganizationDepartmentsApi.md#getorganizationdepartmentspartitions) | **GET** /ed-fi/organizationDepartments/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*PeopleApi* | [**getPeoplePartitions**](docs/Api/PeopleApi.md#getpeoplepartitions) | **GET** /ed-fi/people/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*PerformanceEvaluationRatingsApi* | [**getPerformanceEvaluationRatingsPartitions**](docs/Api/PerformanceEvaluationRatingsApi.md#getperformanceevaluationratingspartitions) | **GET** /tpdm/performanceEvaluationRatings/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*PerformanceEvaluationsApi* | [**getPerformanceEvaluationsPartitions**](docs/Api/PerformanceEvaluationsApi.md#getperformanceevaluationspartitions) | **GET** /tpdm/performanceEvaluations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*PostSecondaryEventsApi* | [**getPostSecondaryEventsPartitions**](docs/Api/PostSecondaryEventsApi.md#getpostsecondaryeventspartitions) | **GET** /ed-fi/postSecondaryEvents/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*PostSecondaryInstitutionsApi* | [**getPostSecondaryInstitutionsPartitions**](docs/Api/PostSecondaryInstitutionsApi.md#getpostsecondaryinstitutionspartitions) | **GET** /ed-fi/postSecondaryInstitutions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*ProgramDimensionsApi* | [**getProgramDimensionsPartitions**](docs/Api/ProgramDimensionsApi.md#getprogramdimensionspartitions) | **GET** /ed-fi/programDimensions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*ProgramEvaluationElementsApi* | [**getProgramEvaluationElementsPartitions**](docs/Api/ProgramEvaluationElementsApi.md#getprogramevaluationelementspartitions) | **GET** /ed-fi/programEvaluationElements/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*ProgramEvaluationObjectivesApi* | [**getProgramEvaluationObjectivesPartitions**](docs/Api/ProgramEvaluationObjectivesApi.md#getprogramevaluationobjectivespartitions) | **GET** /ed-fi/programEvaluationObjectives/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*ProgramEvaluationsApi* | [**getProgramEvaluationsPartitions**](docs/Api/ProgramEvaluationsApi.md#getprogramevaluationspartitions) | **GET** /ed-fi/programEvaluations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*ProgramsApi* | [**getProgramsPartitions**](docs/Api/ProgramsApi.md#getprogramspartitions) | **GET** /ed-fi/programs/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*ProjectDimensionsApi* | [**getProjectDimensionsPartitions**](docs/Api/ProjectDimensionsApi.md#getprojectdimensionspartitions) | **GET** /ed-fi/projectDimensions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*ReportCardsApi* | [**getReportCardsPartitions**](docs/Api/ReportCardsApi.md#getreportcardspartitions) | **GET** /ed-fi/reportCards/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*RestraintEventsApi* | [**getRestraintEventsPartitions**](docs/Api/RestraintEventsApi.md#getrestrainteventspartitions) | **GET** /ed-fi/restraintEvents/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*RubricDimensionsApi* | [**getRubricDimensionsPartitions**](docs/Api/RubricDimensionsApi.md#getrubricdimensionspartitions) | **GET** /tpdm/rubricDimensions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SchoolYearTypesApi* | [**getSchoolYearTypesPartitions**](docs/Api/SchoolYearTypesApi.md#getschoolyeartypespartitions) | **GET** /ed-fi/schoolYearTypes/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SchoolsApi* | [**getSchoolsPartitions**](docs/Api/SchoolsApi.md#getschoolspartitions) | **GET** /ed-fi/schools/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SectionAttendanceTakenEventsApi* | [**getSectionAttendanceTakenEventsPartitions**](docs/Api/SectionAttendanceTakenEventsApi.md#getsectionattendancetakeneventspartitions) | **GET** /ed-fi/sectionAttendanceTakenEvents/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SectionsApi* | [**getSectionsPartitions**](docs/Api/SectionsApi.md#getsectionspartitions) | **GET** /ed-fi/sections/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SessionsApi* | [**getSessionsPartitions**](docs/Api/SessionsApi.md#getsessionspartitions) | **GET** /ed-fi/sessions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SourceDimensionsApi* | [**getSourceDimensionsPartitions**](docs/Api/SourceDimensionsApi.md#getsourcedimensionspartitions) | **GET** /ed-fi/sourceDimensions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StaffAbsenceEventsApi* | [**getStaffAbsenceEventsPartitions**](docs/Api/StaffAbsenceEventsApi.md#getstaffabsenceeventspartitions) | **GET** /ed-fi/staffAbsenceEvents/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StaffCohortAssociationsApi* | [**getStaffCohortAssociationsPartitions**](docs/Api/StaffCohortAssociationsApi.md#getstaffcohortassociationspartitions) | **GET** /ed-fi/staffCohortAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StaffDisciplineIncidentAssociationsApi* | [**getStaffDisciplineIncidentAssociationsPartitions**](docs/Api/StaffDisciplineIncidentAssociationsApi.md#getstaffdisciplineincidentassociationspartitions) | **GET** /ed-fi/staffDisciplineIncidentAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StaffEducationOrganizationAssignmentAssociationsApi* | [**getStaffEducationOrganizationAssignmentAssociationsPartitions**](docs/Api/StaffEducationOrganizationAssignmentAssociationsApi.md#getstaffeducationorganizationassignmentassociationspartitions) | **GET** /ed-fi/staffEducationOrganizationAssignmentAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StaffEducationOrganizationEmploymentAssociationsApi* | [**getStaffEducationOrganizationEmploymentAssociationsPartitions**](docs/Api/StaffEducationOrganizationEmploymentAssociationsApi.md#getstaffeducationorganizationemploymentassociationspartitions) | **GET** /ed-fi/staffEducationOrganizationEmploymentAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StaffLeavesApi* | [**getStaffLeavesPartitions**](docs/Api/StaffLeavesApi.md#getstaffleavespartitions) | **GET** /ed-fi/staffLeaves/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StaffProgramAssociationsApi* | [**getStaffProgramAssociationsPartitions**](docs/Api/StaffProgramAssociationsApi.md#getstaffprogramassociationspartitions) | **GET** /ed-fi/staffProgramAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StaffSchoolAssociationsApi* | [**getStaffSchoolAssociationsPartitions**](docs/Api/StaffSchoolAssociationsApi.md#getstaffschoolassociationspartitions) | **GET** /ed-fi/staffSchoolAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StaffSectionAssociationsApi* | [**getStaffSectionAssociationsPartitions**](docs/Api/StaffSectionAssociationsApi.md#getstaffsectionassociationspartitions) | **GET** /ed-fi/staffSectionAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StaffsApi* | [**getStaffsPartitions**](docs/Api/StaffsApi.md#getstaffspartitions) | **GET** /ed-fi/staffs/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StateEducationAgenciesApi* | [**getStateEducationAgenciesPartitions**](docs/Api/StateEducationAgenciesApi.md#getstateeducationagenciespartitions) | **GET** /ed-fi/stateEducationAgencies/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentAcademicRecordsApi* | [**getStudentAcademicRecordsPartitions**](docs/Api/StudentAcademicRecordsApi.md#getstudentacademicrecordspartitions) | **GET** /ed-fi/studentAcademicRecords/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentAssessmentEducationOrganizationAssociationsApi* | [**getStudentAssessmentEducationOrganizationAssociationsPartitions**](docs/Api/StudentAssessmentEducationOrganizationAssociationsApi.md#getstudentassessmenteducationorganizationassociationspartitions) | **GET** /ed-fi/studentAssessmentEducationOrganizationAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentAssessmentRegistrationBatteryPartAssociationsApi* | [**keyChangesStudentAssessmentRegistrationBatteryPartAssociations**](docs/Api/StudentAssessmentRegistrationBatteryPartAssociationsApi.md#keychangesstudentassessmentregistrationbatterypartassociations) | **GET** /ed-fi/studentAssessmentRegistrationBatteryPartAssociations/keyChanges | Retrieves resources key changes based on change version.
...
*StudentAssessmentRegistrationsApi* | [**deleteStudentAssessmentRegistrationById**](docs/Api/StudentAssessmentRegistrationsApi.md#deletestudentassessmentregistrationbyid) | **DELETE** /ed-fi/studentAssessmentRegistrations/{id} | Deletes an existing resource using the resource identifier.
*StudentAssessmentRegistrationsApi* | [**deletesStudentAssessmentRegistrations**](docs/Api/StudentAssessmentRegistrationsApi.md#deletesstudentassessmentregistrations) | **GET** /ed-fi/studentAssessmentRegistrations/deletes | Retrieves deleted resources based on change version.
*StudentAssessmentRegistrationsApi* | [**getStudentAssessmentRegistrations**](docs/Api/StudentAssessmentRegistrationsApi.md#getstudentassessmentregistrations) | **GET** /ed-fi/studentAssessmentRegistrations | Retrieves specific resources using the resource&#39;s property values (using the \&quot;Get\&quot; pattern).
*StudentAssessmentRegistrationsApi* | [**getStudentAssessmentRegistrationsById**](docs/Api/StudentAssessmentRegistrationsApi.md#getstudentassessmentregistrationsbyid) | **GET** /ed-fi/studentAssessmentRegistrations/{id} | Retrieves a specific resource using the resource&#39;s identifier (using the \&quot;Get By Id\&quot; pattern).
*StudentAssessmentRegistrationsApi* | [**getStudentAssessmentRegistrationsPartitions**](docs/Api/StudentAssessmentRegistrationsApi.md#getstudentassessmentregistrationspartitions) | **GET** /ed-fi/studentAssessmentRegistrations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
*StudentAssessmentRegistrationsApi* | [**keyChangesStudentAssessmentRegistrations**](docs/Api/StudentAssessmentRegistrationsApi.md#keychangesstudentassessmentregistrations) | **GET** /ed-fi/studentAssessmentRegistrations/keyChanges | Retrieves resources key changes based on change version.
*StudentAssessmentRegistrationsApi* | [**postStudentAssessmentRegistration**](docs/Api/StudentAssessmentRegistrationsApi.md#poststudentassessmentregistration) | **POST** /ed-fi/studentAssessmentRegistrations | Creates or updates resources based on the natural key values of the supplied resource.
*StudentAssessmentRegistrationsApi* | [**putStudentAssessmentRegistration**](docs/Api/StudentAssessmentRegistrationsApi.md#putstudentassessmentregistration) | **PUT** /ed-fi/studentAssessmentRegistrations/{id} | Updates a resource based on the resource identifier.
...
*StudentAssessmentsApi* | [**getStudentAssessmentsPartitions**](docs/Api/StudentAssessmentsApi.md#getstudentassessmentspartitions) | **GET** /ed-fi/studentAssessments/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentCTEProgramAssociationsApi* | [**getStudentCTEProgramAssociationsPartitions**](docs/Api/StudentCTEProgramAssociationsApi.md#getstudentcteprogramassociationspartitions) | **GET** /ed-fi/studentCTEProgramAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentCohortAssociationsApi* | [**getStudentCohortAssociationsPartitions**](docs/Api/StudentCohortAssociationsApi.md#getstudentcohortassociationspartitions) | **GET** /ed-fi/studentCohortAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentCompetencyObjectivesApi* | [**getStudentCompetencyObjectivesPartitions**](docs/Api/StudentCompetencyObjectivesApi.md#getstudentcompetencyobjectivespartitions) | **GET** /ed-fi/studentCompetencyObjectives/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentContactAssociationsApi* | [**getStudentContactAssociationsPartitions**](docs/Api/StudentContactAssociationsApi.md#getstudentcontactassociationspartitions) | **GET** /ed-fi/studentContactAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentDisciplineIncidentBehaviorAssociationsApi* | [**getStudentDisciplineIncidentBehaviorAssociationsPartitions**](docs/Api/StudentDisciplineIncidentBehaviorAssociationsApi.md#getstudentdisciplineincidentbehaviorassociationspartitions) | **GET** /ed-fi/studentDisciplineIncidentBehaviorAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentDisciplineIncidentNonOffenderAssociationsApi* | [**getStudentDisciplineIncidentNonOffenderAssociationsPartitions**](docs/Api/StudentDisciplineIncidentNonOffenderAssociationsApi.md#getstudentdisciplineincidentnonoffenderassociationspartitions) | **GET** /ed-fi/studentDisciplineIncidentNonOffenderAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentEducationOrganizationAssessmentAccommodationsApi* | [**deleteStudentEducationOrganizationAssessmentAccommodationById**](docs/Api/StudentEducationOrganizationAssessmentAccommodationsApi.md#deletestudenteducationorganizationassessmentaccommodationbyid) | **DELETE** /ed-fi/studentEducationOrganizationAssessmentAccommodations/{id} | Deletes an existing resource using the resource identifier.
*StudentEducationOrganizationAssessmentAccommodationsApi* | [**deletesStudentEducationOrganizationAssessmentAccommodations**](docs/Api/StudentEducationOrganizationAssessmentAccommodationsApi.md#deletesstudenteducationorganizationassessmentaccommodations) | **GET** /ed-fi/studentEducationOrganizationAssessmentAccommodations/deletes | Retrieves deleted resources based on change version.
*StudentEducationOrganizationAssessmentAccommodationsApi* | [**getStudentEducationOrganizationAssessmentAccommodations**](docs/Api/StudentEducationOrganizationAssessmentAccommodationsApi.md#getstudenteducationorganizationassessmentaccommodations) | **GET** /ed-fi/studentEducationOrganizationAssessmentAccommodations | Retrieves specific resources using the resource&#39;s property values (using the \&quot;Get\&quot; pattern).
*StudentEducationOrganizationAssessmentAccommodationsApi* | [**getStudentEducationOrganizationAssessmentAccommodationsById**](docs/Api/StudentEducationOrganizationAssessmentAccommodationsApi.md#getstudenteducationorganizationassessmentaccommodationsbyid) | **GET** /ed-fi/studentEducationOrganizationAssessmentAccommodations/{id} | Retrieves a specific resource using the resource&#39;s identifier (using the \&quot;Get By Id\&quot; pattern).
*StudentEducationOrganizationAssessmentAccommodationsApi* | [**getStudentEducationOrganizationAssessmentAccommodationsPartitions**](docs/Api/StudentEducationOrganizationAssessmentAccommodationsApi.md#getstudenteducationorganizationassessmentaccommodationspartitions) | **GET** /ed-fi/studentEducationOrganizationAssessmentAccommodations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
*StudentEducationOrganizationAssessmentAccommodationsApi* | [**keyChangesStudentEducationOrganizationAssessmentAccommodations**](docs/Api/StudentEducationOrganizationAssessmentAccommodationsApi.md#keychangesstudenteducationorganizationassessmentaccommodations) | **GET** /ed-fi/studentEducationOrganizationAssessmentAccommodations/keyChanges | Retrieves resources key changes based on change version.
*StudentEducationOrganizationAssessmentAccommodationsApi* | [**postStudentEducationOrganizationAssessmentAccommodation**](docs/Api/StudentEducationOrganizationAssessmentAccommodationsApi.md#poststudenteducationorganizationassessmentaccommodation) | **POST** /ed-fi/studentEducationOrganizationAssessmentAccommodations | Creates or updates resources based on the natural key values of the supplied resource.
*StudentEducationOrganizationAssessmentAccommodationsApi* | [**putStudentEducationOrganizationAssessmentAccommodation**](docs/Api/StudentEducationOrganizationAssessmentAccommodationsApi.md#putstudenteducationorganizationassessmentaccommodation) | **PUT** /ed-fi/studentEducationOrganizationAssessmentAccommodations/{id} | Updates a resource based on the resource identifier.
...
*StudentEducationOrganizationResponsibilityAssociationsApi* | [**getStudentEducationOrganizationResponsibilityAssociationsPartitions**](docs/Api/StudentEducationOrganizationResponsibilityAssociationsApi.md#getstudenteducationorganizationresponsibilityassociationspartitions) | **GET** /ed-fi/studentEducationOrganizationResponsibilityAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentGradebookEntriesApi* | [**getStudentGradebookEntriesPartitions**](docs/Api/StudentGradebookEntriesApi.md#getstudentgradebookentriespartitions) | **GET** /ed-fi/studentGradebookEntries/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentHealthsApi* | [**getStudentHealthsPartitions**](docs/Api/StudentHealthsApi.md#getstudenthealthspartitions) | **GET** /ed-fi/studentHealths/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentInterventionAssociationsApi* | [**getStudentInterventionAssociationsPartitions**](docs/Api/StudentInterventionAssociationsApi.md#getstudentinterventionassociationspartitions) | **GET** /ed-fi/studentInterventionAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentLanguageInstructionProgramAssociationsApi* | [**getStudentLanguageInstructionProgramAssociationsPartitions**](docs/Api/StudentLanguageInstructionProgramAssociationsApi.md#getstudentlanguageinstructionprogramassociationspartitions) | **GET** /ed-fi/studentLanguageInstructionProgramAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentMigrantEducationProgramAssociationsApi* | [**getStudentMigrantEducationProgramAssociationsPartitions**](docs/Api/StudentMigrantEducationProgramAssociationsApi.md#getstudentmigranteducationprogramassociationspartitions) | **GET** /ed-fi/studentMigrantEducationProgramAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentNeglectedOrDelinquentProgramAssociationsApi* | [**getStudentNeglectedOrDelinquentProgramAssociationsPartitions**](docs/Api/StudentNeglectedOrDelinquentProgramAssociationsApi.md#getstudentneglectedordelinquentprogramassociationspartitions) | **GET** /ed-fi/studentNeglectedOrDelinquentProgramAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentProgramAssociationsApi* | [**getStudentProgramAssociationsPartitions**](docs/Api/StudentProgramAssociationsApi.md#getstudentprogramassociationspartitions) | **GET** /ed-fi/studentProgramAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentProgramEvaluationsApi* | [**getStudentProgramEvaluationsPartitions**](docs/Api/StudentProgramEvaluationsApi.md#getstudentprogramevaluationspartitions) | **GET** /ed-fi/studentProgramEvaluations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentSchoolAssociationsApi* | [**getStudentSchoolAssociationsPartitions**](docs/Api/StudentSchoolAssociationsApi.md#getstudentschoolassociationspartitions) | **GET** /ed-fi/studentSchoolAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentSchoolAttendanceEventsApi* | [**getStudentSchoolAttendanceEventsPartitions**](docs/Api/StudentSchoolAttendanceEventsApi.md#getstudentschoolattendanceeventspartitions) | **GET** /ed-fi/studentSchoolAttendanceEvents/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentSection504ProgramAssociationsApi* | [**deleteStudentSection504ProgramAssociationById**](docs/Api/StudentSection504ProgramAssociationsApi.md#deletestudentsection504programassociationbyid) | **DELETE** /ed-fi/studentSection504ProgramAssociations/{id} | Deletes an existing resource using the resource identifier.
*StudentSection504ProgramAssociationsApi* | [**deletesStudentSection504ProgramAssociations**](docs/Api/StudentSection504ProgramAssociationsApi.md#deletesstudentsection504programassociations) | **GET** /ed-fi/studentSection504ProgramAssociations/deletes | Retrieves deleted resources based on change version.
*StudentSection504ProgramAssociationsApi* | [**getStudentSection504ProgramAssociations**](docs/Api/StudentSection504ProgramAssociationsApi.md#getstudentsection504programassociations) | **GET** /ed-fi/studentSection504ProgramAssociations | Retrieves specific resources using the resource&#39;s property values (using the \&quot;Get\&quot; pattern).
*StudentSection504ProgramAssociationsApi* | [**getStudentSection504ProgramAssociationsById**](docs/Api/StudentSection504ProgramAssociationsApi.md#getstudentsection504programassociationsbyid) | **GET** /ed-fi/studentSection504ProgramAssociations/{id} | Retrieves a specific resource using the resource&#39;s identifier (using the \&quot;Get By Id\&quot; pattern).
*StudentSection504ProgramAssociationsApi* | [**getStudentSection504ProgramAssociationsPartitions**](docs/Api/StudentSection504ProgramAssociationsApi.md#getstudentsection504programassociationspartitions) | **GET** /ed-fi/studentSection504ProgramAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
*StudentSection504ProgramAssociationsApi* | [**keyChangesStudentSection504ProgramAssociations**](docs/Api/StudentSection504ProgramAssociationsApi.md#keychangesstudentsection504programassociations) | **GET** /ed-fi/studentSection504ProgramAssociations/keyChanges | Retrieves resources key changes based on change version.
*StudentSection504ProgramAssociationsApi* | [**postStudentSection504ProgramAssociation**](docs/Api/StudentSection504ProgramAssociationsApi.md#poststudentsection504programassociation) | **POST** /ed-fi/studentSection504ProgramAssociations | Creates or updates resources based on the natural key values of the supplied resource.
*StudentSection504ProgramAssociationsApi* | [**putStudentSection504ProgramAssociation**](docs/Api/StudentSection504ProgramAssociationsApi.md#putstudentsection504programassociation) | **PUT** /ed-fi/studentSection504ProgramAssociations/{id} | Updates a resource based on the resource identifier.
...
*StudentSectionAssociationsApi* | [**getStudentSectionAssociationsPartitions**](docs/Api/StudentSectionAssociationsApi.md#getstudentsectionassociationspartitions) | **GET** /ed-fi/studentSectionAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentSectionAttendanceEventsApi* | [**getStudentSectionAttendanceEventsPartitions**](docs/Api/StudentSectionAttendanceEventsApi.md#getstudentsectionattendanceeventspartitions) | **GET** /ed-fi/studentSectionAttendanceEvents/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentSpecialEducationProgramAssociationsApi* | [**getStudentSpecialEducationProgramAssociationsPartitions**](docs/Api/StudentSpecialEducationProgramAssociationsApi.md#getstudentspecialeducationprogramassociationspartitions) | **GET** /ed-fi/studentSpecialEducationProgramAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentTransportationsApi* | [**getStudentTransportationsPartitions**](docs/Api/StudentTransportationsApi.md#getstudenttransportationspartitions) | **GET** /ed-fi/studentTransportations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*StudentsApi* | [**getStudentsPartitions**](docs/Api/StudentsApi.md#getstudentspartitions) | **GET** /ed-fi/students/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SurveyCourseAssociationsApi* | [**getSurveyCourseAssociationsPartitions**](docs/Api/SurveyCourseAssociationsApi.md#getsurveycourseassociationspartitions) | **GET** /ed-fi/surveyCourseAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SurveyProgramAssociationsApi* | [**getSurveyProgramAssociationsPartitions**](docs/Api/SurveyProgramAssociationsApi.md#getsurveyprogramassociationspartitions) | **GET** /ed-fi/surveyProgramAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SurveyQuestionResponsesApi* | [**getSurveyQuestionResponsesPartitions**](docs/Api/SurveyQuestionResponsesApi.md#getsurveyquestionresponsespartitions) | **GET** /ed-fi/surveyQuestionResponses/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SurveyQuestionsApi* | [**getSurveyQuestionsPartitions**](docs/Api/SurveyQuestionsApi.md#getsurveyquestionspartitions) | **GET** /ed-fi/surveyQuestions/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SurveyResponseEducationOrganizationTargetAssociationsApi* | [**getSurveyResponseEducationOrganizationTargetAssociationsPartitions**](docs/Api/SurveyResponseEducationOrganizationTargetAssociationsApi.md#getsurveyresponseeducationorganizationtargetassociationspartitions) | **GET** /ed-fi/surveyResponseEducationOrganizationTargetAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SurveyResponseStaffTargetAssociationsApi* | [**getSurveyResponseStaffTargetAssociationsPartitions**](docs/Api/SurveyResponseStaffTargetAssociationsApi.md#getsurveyresponsestafftargetassociationspartitions) | **GET** /ed-fi/surveyResponseStaffTargetAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SurveyResponsesApi* | [**getSurveyResponsesPartitions**](docs/Api/SurveyResponsesApi.md#getsurveyresponsespartitions) | **GET** /ed-fi/surveyResponses/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SurveySectionAssociationsApi* | [**getSurveySectionAssociationsPartitions**](docs/Api/SurveySectionAssociationsApi.md#getsurveysectionassociationspartitions) | **GET** /ed-fi/surveySectionAssociations/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SurveySectionResponsesApi* | [**getSurveySectionResponsesPartitions**](docs/Api/SurveySectionResponsesApi.md#getsurveysectionresponsespartitions) | **GET** /ed-fi/surveySectionResponses/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SurveySectionsApi* | [**getSurveySectionsPartitions**](docs/Api/SurveySectionsApi.md#getsurveysectionspartitions) | **GET** /ed-fi/surveySections/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
*SurveysApi* | [**getSurveysPartitions**](docs/Api/SurveysApi.md#getsurveyspartitions) | **GET** /ed-fi/surveys/partitions | Retrieves a set of page tokens to be used for efficient client-side parallel processing.
...
- [EdFiAssessmentAdministration](docs/Model/EdFiAssessmentAdministration.md)
- [EdFiAssessmentAdministrationAssessmentBatteryPart](docs/Model/EdFiAssessmentAdministrationAssessmentBatteryPart.md)
- [EdFiAssessmentAdministrationParticipation](docs/Model/EdFiAssessmentAdministrationParticipation.md)
- [EdFiAssessmentAdministrationParticipationAdministrationPointOfContact](docs/Model/EdFiAssessmentAdministrationParticipationAdministrationPointOfContact.md)
- [EdFiAssessmentAdministrationPeriod](docs/Model/EdFiAssessmentAdministrationPeriod.md)
- [EdFiAssessmentAdministrationReference](docs/Model/EdFiAssessmentAdministrationReference.md)
- [EdFiAssessmentAssessedGradeLevel](docs/Model/EdFiAssessmentAssessedGradeLevel.md)
- [EdFiAssessmentBatteryPart](docs/Model/EdFiAssessmentBatteryPart.md)
- [EdFiAssessmentBatteryPartObjectiveAssessment](docs/Model/EdFiAssessmentBatteryPartObjectiveAssessment.md)
- [EdFiAssessmentBatteryPartReference](docs/Model/EdFiAssessmentBatteryPartReference.md)
...
- [EdFiStudentAssessmentRegistration](docs/Model/EdFiStudentAssessmentRegistration.md)
- [EdFiStudentAssessmentRegistrationAssessmentAccommodation](docs/Model/EdFiStudentAssessmentRegistrationAssessmentAccommodation.md)
- [EdFiStudentAssessmentRegistrationAssessmentCustomization](docs/Model/EdFiStudentAssessmentRegistrationAssessmentCustomization.md)
- [EdFiStudentAssessmentRegistrationBatteryPartAssociation](docs/Model/EdFiStudentAssessmentRegistrationBatteryPartAssociation.md)
- [EdFiStudentAssessmentRegistrationBatteryPartAssociationAccommodation](docs/Model/EdFiStudentAssessmentRegistrationBatteryPartAssociationAccommodation.md)
- [EdFiStudentAssessmentRegistrationReference](docs/Model/EdFiStudentAssessmentRegistrationReference.md)
...
- [EdFiStudentDisciplineIncidentBehaviorAssociationWeapon](docs/Model/EdFiStudentDisciplineIncidentBehaviorAssociationWeapon.md)
...
- [EdFiStudentEducationOrganizationAssessmentAccommodation](docs/Model/EdFiStudentEducationOrganizationAssessmentAccommodation.md)
- [EdFiStudentEducationOrganizationAssessmentAccommodationGeneralAccommodation](docs/Model/EdFiStudentEducationOrganizationAssessmentAccommodationGeneralAccommodation.md)
- [EdFiStudentEducationOrganizationAssessmentAccommodationReference](docs/Model/EdFiStudentEducationOrganizationAssessmentAccommodationReference.md)
...
- [EdFiStudentEducationOrganizationAssociationReference](docs/Model/EdFiStudentEducationOrganizationAssociationReference.md)
...
- [EdFiStudentSchoolAssociationReference](docs/Model/EdFiStudentSchoolAssociationReference.md)
...
- [EdFiStudentSection504ProgramAssociation](docs/Model/EdFiStudentSection504ProgramAssociation.md)
...
- [GetAcademicWeeksPartitions200Response](docs/Model/GetAcademicWeeksPartitions200Response.md)
...
- [TrackedChangesEdFiAssessmentAdministrationDelete](docs/Model/TrackedChangesEdFiAssessmentAdministrationDelete.md)
- [TrackedChangesEdFiAssessmentAdministrationKey](docs/Model/TrackedChangesEdFiAssessmentAdministrationKey.md)
- [TrackedChangesEdFiAssessmentAdministrationKeyChange](docs/Model/TrackedChangesEdFiAssessmentAdministrationKeyChange.md)
- [TrackedChangesEdFiAssessmentAdministrationParticipationDelete](docs/Model/TrackedChangesEdFiAssessmentAdministrationParticipationDelete.md)
- [TrackedChangesEdFiAssessmentAdministrationParticipationKey](docs/Model/TrackedChangesEdFiAssessmentAdministrationParticipationKey.md)
- [TrackedChangesEdFiAssessmentAdministrationParticipationKeyChange](docs/Model/TrackedChangesEdFiAssessmentAdministrationParticipationKeyChange.md)
- [TrackedChangesEdFiAssessmentBatteryPartDelete](docs/Model/TrackedChangesEdFiAssessmentBatteryPartDelete.md)
- [TrackedChangesEdFiAssessmentBatteryPartKey](docs/Model/TrackedChangesEdFiAssessmentBatteryPartKey.md)
- [TrackedChangesEdFiAssessmentBatteryPartKeyChange](docs/Model/TrackedChangesEdFiAssessmentBatteryPartKeyChange.md)
...
- [TrackedChangesEdFiStudentAssessmentRegistrationBatteryPartAssociationDelete](docs/Model/TrackedChangesEdFiStudentAssessmentRegistrationBatteryPartAssociationDelete.md)
- [TrackedChangesEdFiStudentAssessmentRegistrationBatteryPartAssociationKey](docs/Model/TrackedChangesEdFiStudentAssessmentRegistrationBatteryPartAssociationKey.md)
- [TrackedChangesEdFiStudentAssessmentRegistrationBatteryPartAssociationKeyChange](docs/Model/TrackedChangesEdFiStudentAssessmentRegistrationBatteryPartAssociationKeyChange.md)
- [TrackedChangesEdFiStudentAssessmentRegistrationDelete](docs/Model/TrackedChangesEdFiStudentAssessmentRegistrationDelete.md)
- [TrackedChangesEdFiStudentAssessmentRegistrationKey](docs/Model/TrackedChangesEdFiStudentAssessmentRegistrationKey.md)
- [TrackedChangesEdFiStudentAssessmentRegistrationKeyChange](docs/Model/TrackedChangesEdFiStudentAssessmentRegistrationKeyChange.md)
...
- [TrackedChangesEdFiStudentEducationOrganizationAssessmentAccommodationDelete](docs/Model/TrackedChangesEdFiStudentEducationOrganizationAssessmentAccommodationDelete.md)
- [TrackedChangesEdFiStudentEducationOrganizationAssessmentAccommodationKey](docs/Model/TrackedChangesEdFiStudentEducationOrganizationAssessmentAccommodationKey.md)
- [TrackedChangesEdFiStudentEducationOrganizationAssessmentAccommodationKeyChange](docs/Model/TrackedChangesEdFiStudentEducationOrganizationAssessmentAccommodationKeyChange.md)
...
- [TrackedChangesEdFiStudentSection504ProgramAssociationDelete](docs/Model/TrackedChangesEdFiStudentSection504ProgramAssociationDelete.md)
- [TrackedChangesEdFiStudentSection504ProgramAssociationKey](docs/Model/TrackedChangesEdFiStudentSection504ProgramAssociationKey.md)
- [TrackedChangesEdFiStudentSection504ProgramAssociationKeyChange](docs/Model/TrackedChangesEdFiStudentSection504ProgramAssociationKeyChange.md)
